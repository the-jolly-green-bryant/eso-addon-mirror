...
function Harvest.AreNotificationsEnabled()
	return true --Settings.savedVars.settings.displayNotifications
end
...
function Harvest.GetWorldBaseTexture()
	return Settings.savedVars.settings.pinLayouts.worldBase.texture
end

function Harvest.SetWorldBaseTexture(value)
	Settings.savedVars.settings.pinLayouts.worldBase.texture = value
