...
Harvest.localizedStrings = {
	...
	exchangedescription2 = "Du kannst die aktuellsten HarvestMap-Daten (Positionen der Ressourcen) herunterladen, indem du das \"HarvestMap-Data\" AddOn installierst. Weitere Informationen findest du in der Add-on-Beschreibung auf ESOUI.",
	...
	worldpinsdepth = "Durch Wände anzeigen",
	worldpinsdepthtooltip = "Wenn aktiviert, werden die 3D Pinne nicht hinter Objeckten versteckt.",
	worldpinsdepthtext = "Deaktivieren von \"Durch Wände anzeigen\" funktioniert nur falls\n1) die Auflösung des Spieles stimmt mit der Auflösung des Bildschirms überein (in den Grafikoptionen des Spieles oder der Grafikkarten Software), und\n2) die SubSampling Qualität steht auf \"Hoch\" in den Grafikoptionen.",
	...
	spawnfilterdescription = [[Falls aktiviert, wird HarvestMap Pinne verstecken, wenn diese noch nicht verfügbar sind. Zum Beispiel, wenn eine andere Person eine Ressource bereits eingesammelt hat, wird kein Pin dort angezeigt, bis die Ressource wieder verfügbar ist.
- Dieser Filter funktioniert nur für Handwerksmaterialien.
- Dieser Filter funkctioniert nicht für Behälter wie Schatztruhen, Schwere Säcke, oder Psijik Portale.
- Dieser Filter funktioniert nicht, sofern ein anderes Addon den Kompass versteckt oder skaliert.
- HarvestMap kann nicht wissen ob eine Resource auf der anderen Seite der Karte respawnt. Nur Resourcen in deiner nähe werden angezeigt.]],
	...
	-- pin type options
	styleoptions = "Icon & Farben Optionen",
	restoredefaultlayout = "Icon & Farbe Preset anwenden",
	selectpreset = "Preset auswählen",
	white = "Weiß",
	worldBaseTexture = "Basis der 3D Pinne",
	pinsize = "Pingröße",
	...
	pintype20 = "Ranzen des Kräuterkenners",
...
Knoten pro KM: <<3>>]],
	...
	SI_BINDING_NAME_TOGGLE_MINIMAPPINS = "(De-)Aktiviere Pinne auf der MiniMap",
...
local interactableName2PinTypeId = {
	...
	["Ranzen des Kräuterkenners"] = Harvest.HERBALIST,
}
