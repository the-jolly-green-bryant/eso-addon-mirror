...
Keyboard-only: it draws pins onto the keyboard world map (ZO_WorldMap and
friends), which don't exist when the keyboard UI isn't loaded (i.e. on
console). ZO_IsConsoleOrGameCoreUI() is true there, so Initialize bails out immediately.
]]--
