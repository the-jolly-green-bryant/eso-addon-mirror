...
Harvest.localizedStrings = {
	...
	seethroughwalls = "Ver a través de paredes",
	seethroughwallstooltip = "Cuando está activado, los marcadores 3D serán visibles a través de paredes y otros objetos.",
