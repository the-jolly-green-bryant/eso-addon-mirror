...
local function RegisterOptions()
	...
	if LibGamepad and type(GamepadInventoryTweaks.RegisterOptions) == "function" then
		GamepadInventoryTweaks.RegisterOptions(optionsContext)
		return
	end

	if type(GamepadInventoryTweaks.CreateSettingsMenu) == "function" then
		GamepadInventoryTweaks.CreateSettingsMenu(optionsContext)
	end
end
