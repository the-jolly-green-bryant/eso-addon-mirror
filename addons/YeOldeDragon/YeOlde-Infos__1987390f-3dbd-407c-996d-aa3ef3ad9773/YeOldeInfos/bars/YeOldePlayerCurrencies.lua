...
local NAMES = {
	[CURT_ALLIANCE_POINTS] = GetString(SI_YEOLDEINFOS_CURRENCY_ALLIANCE_POINTS),
	[CURT_TELVAR_STONES] = GetString(SI_YEOLDEINFOS_CURRENCY_TELVAR_STONES),
	[CURT_WRIT_VOUCHERS] = GetString(SI_YEOLDEINFOS_CURRENCY_WRIT_VOUCHERS),
}
...
local TOOLTIPS = {
	[CURT_ALLIANCE_POINTS] = GetString(SI_YEOLDEINFOS_TT_CURRENCY_ALLIANCE_POINTS),
	[CURT_TELVAR_STONES] = GetString(SI_YEOLDEINFOS_TT_CURRENCY_TELVAR_STONES),
	[CURT_WRIT_VOUCHERS] = GetString(SI_YEOLDEINFOS_TT_CURRENCY_WRIT_VOUCHERS),
}
...
function YeOldePlayerCurrencies:InitializeSettingsMenu(controls)
	...
	local options = {
		type = "submenu",
		name = GetString(SI_YEOLDEINFOS_CURRENCY_HEADER),
		controls = controls,
	}
	return options
end
