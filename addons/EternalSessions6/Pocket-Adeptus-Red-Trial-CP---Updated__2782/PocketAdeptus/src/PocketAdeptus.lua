...
PocketAdeptus.author = "@EternalSessions6 NA"
PocketAdeptus.name = "PocketAdeptus"
PocketAdeptus.version = "1.0"
...
local instances = {aa = "vAA", as = "vAS", cr = "vCR", dsa = "vDSA", hof = "vHoF", hrc = "vHRC", ma = "vMA", mol = "vMoL", so = "vSO", brp = "vBRP", ss = "vSS", ka = "vKA", vh = 
"vVH", gen = "General"}
...
local function getCP(instance)
     ...
     or instance == "brp" or instance == "ss" or instance == "ka" or instance == "vh" or instance == "gen" then -- Checks to see if the input provided to the /cp commands refers to one of the trials.
          ...
          alert("Valid options include: aa, as, cr, dsa, hof, hrc, ma, mol, so, brp, ss, ka, vh, gen") -- Input validation for non-supported input
     end
end
...
local function setCP(instance)
     ...
     if instance == "aa" or instance == "as" or instance == "cr" or instance == "dsa" or instance == "hof"
     or instance == "hrc" or instance == "ma" or instance == "maw" or instance == "mol" or instance == "so"
     or instance == "brp" or instance == "ss" or instance == "ka" or instance == "vh" or instance == "gen" then -- Input Validation
...
function PocketAdeptus.UpdateCP()
     ...
     PocketAdeptus.sv.ka = PocketAdeptus.defaults.ka
     PocketAdeptus.sv.vh = PocketAdeptus.defaults.vh
...
--KA
local kaGet = command:RegisterSubCommand()
genGet:AddAlias("KA")
genGet:SetCallback(function() getCP("ka") end)
genGet:SetDescription("Kynes Aegis")

--VH
local kaGet = command:RegisterSubCommand()
genGet:AddAlias("VH")
genGet:SetCallback(function() getCP("vh") end)
genGet:SetDescription("Vateshran Hollows")
...
--KA
local kaSet = command2:RegisterSubCommand()
genSet:AddAlias("KA")
genSet:SetCallback(function() setCP("ka") end)
genSet:SetDescription("Kynes Aegis")
...
local function OnZoneChanged()
     ...
     if lastZone ~= zone then
          ...
          elseif zone == 684 then -- Maelstrom Arena
               ...
               setCP("ma")
          elseif zone == 1082 then -- Black Rose Prison
               dbg("Auto-Set CP for Blackrose Prison")
               setCP("brp")
          elseif zone == 1121 then -- Sunspire
               dbg("Auto-Set CP for Sunspire")
               setCP("ss")
          elseif zone == 1196 then -- Kynes Aegis
               dbg("Auto-Set CP for Kynes Aegis")
               setCP("ka")
          elseif zone == 1227 then -- Vateshran Hollows
               dbg("Auto-Set CP for Vateshran Hollows")
               setCP("vh")
          else end
          lastZone = zone
          PocketAdeptus.sv["lastZone"] = zone
