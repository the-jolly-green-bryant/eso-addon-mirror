...
function GamepadOptions.BuildPlayerFrameOptionsData()
    return {
        ...
        GamepadOptions.BuildPlayerBarsShowShieldOption(),
...
function GamepadOptions.BuildRadialOptionsData()
    return {
        ...
        GamepadOptions.BuildPresetShieldBarColorOption(GamepadOptions.PLAYER_FRAME_RADIAL_PANEL_ID, 28, "radial"),
...
function GamepadOptions.BuildClassicOptionsData()
    return {
        ...
        GamepadOptions.BuildPresetShieldBarColorOption(GamepadOptions.PLAYER_FRAME_CLASSIC_PANEL_ID, 26, "classic"),
...
function GamepadOptions.BuildPyramidOptionsData()
    return {
        ...
        GamepadOptions.BuildPresetShieldBarColorOption(GamepadOptions.PLAYER_FRAME_PYRAMID_PANEL_ID, 26, "pyramid"),
...
function GamepadOptions.BuildStackOptionsData()
    return {
        ...
        GamepadOptions.BuildPresetShieldBarColorOption(GamepadOptions.PLAYER_FRAME_STACK_PANEL_ID, 27, "stack"),
...
function GamepadOptions.BuildVerticalOptionsData()
    return {
        ...
        GamepadOptions.BuildPresetShieldBarColorOption(GamepadOptions.PLAYER_FRAME_VERTICAL_PANEL_ID, 41, "vertical"),
