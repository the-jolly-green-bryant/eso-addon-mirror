...
function RaffleGold.Cmd(txt)
	if txt == "" then
		CHAT_SYSTEM:AddMessage(RaffleGold.displayName .. ': type "/rg help" for a list of commands.')
		return
	end
	arr = {}
	i = 1
	...
	if arr[1] == "reset" and arr[2] ~= nil then
		m = "|cFF0000ERROR: Reset command not found.\r\nFor the list of commands, type: /rg help reset"
	...
	if arr[1] == "set" then
		...
		CHAT_SYSTEM:AddMessage(RaffleGold.displayName .. " -- \n|cFF0000ERROR: Settings command not found.\r\nFor the list of commands, type: /rg help set")
		return
	end
	if arr[1] == "draw" then
		if arr[2] == "basic" then
		...
		CHAT_SYSTEM:AddMessage(RaffleGold.displayName .. " -- \n|cFF0000ERROR: Drawing command not found.\r\nFor the list of commands, type: /rg help draw")
		return
	end
	...
	if arr[1] == "list" or arr[1] == "display" then
		m = "|cFF0000ERROR: List command not found.\r\nFor the available commands, type: /rg help list"
		if string.find(arr[2], "ent") and arr[3] == "price" then
	...
	CHAT_SYSTEM:AddMessage(RaffleGold.displayName .. " -- \n|cFF0000ERROR: Command not found.\r\nFor the list of commands, type: /rg help")
end
