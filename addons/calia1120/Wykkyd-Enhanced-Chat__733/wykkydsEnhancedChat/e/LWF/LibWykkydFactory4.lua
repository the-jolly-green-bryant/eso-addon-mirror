...
lwf4.__internalize = function()
	...
	LWF4.__internal.DumpCommandsToChat = function() table.foreach(_G,LWF4.__internal.Print); end
	LWF4.__internal.DumpWindowName = function(win,num) if win then LWF4.__internal.Print(Indent(num, win:GetName())); end end
	...
	LWF4.__internal.GetOrDefault = function(default, value) if value == nil then return default else return value end end
	LWF4.__internal.GuildName = function(n) return GetGuildName(GetGuildId(n)) or "<no guild "..tostring(n)..">" end
	...
	LWF4.__internal.Print = function( Text ) CHAT_SYSTEM["containers"][1]["currentBuffer"]:AddMessage( LWF4_DEFAULT_CHAT_COLOR..tostring( Text ).."|r" ) end
	...
	LWF4.__internal.string_trim = function( s ) return s:match'^()%s*$' and '' or s:match'^%s*(.*%S)'; end
	LWF4.__internal.table_count = function( T ) if T == nil then return 0; end; local c = 0;for _ in pairs(T) do c = c + 1 end; return c; end
	LWF4.__internal.table_next = function( T ) if T == nil then return 0; end; if not LWF4 then return end; return LWF4.__internal.table_count( T )+1; end
...
lwf4.__extend = function()
	...
	LWF4.__extension.BufferPause = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.BufferPause( ... ) end
	LWF4.__extension.comma_number = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.comma_number( ... ) end
	LWF4.__extension.Descr = function( self ) return self.DisplayName.." v"..self.Version end
	LWF4.__extension.DumpCommandsToChat = function( self ) if not LWF4 then return end; LWF4.__internal.DumpCommandsToChat() end
	LWF4.__extension.DumpWindowName = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.DumpWindowName( ... ) end
	LWF4.__extension.DumpWindowsToChat = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.DumpWindowsToChat( ... ) end
	LWF4.__extension.EventName = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.EventName(...) end
	LWF4.__extension.FindFrame = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.FindFrame( ... ) end
	LWF4.__extension.FindGameImage = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.FindGameImage( ... ) end
	LWF4.__extension.GetDateTimeString = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.GetDateTimeString( ... ) end
	LWF4.__extension.GetOrDefault = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.GetOrDefault(...) end
	LWF4.__extension.GuildName = function( self,... ) if not LWF4 then return end; LWF4.__internal.GuildName(...) end
	LWF4.__extension.Indent = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.Indent( ... ) end
	LWF4.__extension.InjectAdvancedSettings = function( self, optionsTable, afterOption )
		...
		opts[key].controls[1] = { type = "description", text = "|cF8E6E0This feature-set is granted via the LibWykkydFactory2 library that this addon embeds. It allows you to set 1 character as your system's default settings, or set a character to use that default as their own settings, or to use a specific character's settings.|r" }
	...
	LWF4.__extension.Round = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.Round( ... ) end
	LWF4.__extension.string_endswith = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.string_endswith( ... ) end
	LWF4.__extension.string_split = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.string_split( ... ) end
	LWF4.__extension.string_startswith = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.string_startswith( ... ) end
	LWF4.__extension.string_trim = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.string_trim( ... ) end
	LWF4.__extension.table_count = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.table_count( ... ) end
	LWF4.__extension.table_next = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.table_next( ... ) end
	LWF4.__extension.table_remove = function( self, ... ) if not LWF4 then return end; LWF4.__internal.table_remove( ... ) end
	LWF4.__extension.Tic = function( self, ... ) if not LWF4 then return end; return LWF4.__internal.Tic(...) end
	...
	LWF4.__extension.ToggleSlashCommand = function( self, ... ) if not LWF4 then return end; LWF4.__internal.ToggleSlashCommand(...) end
	LWF4.__extension.ToggleUIFrames = function( self ) if not LWF4 then return end; LWF4.__internal.ToggleUIFrames() end
...
lwf4.__hydrate = function()
	...
	LWF4.data.GameEventTable = {
        ...
        ["EVENT_VETERAN_POINTS_GAIN"] = {
            CODE=EVENT_VETERAN_POINTS_GAIN,
            DESCR="EVENT_VETERAN_POINTS_GAIN",
            PARAMS={
                eventCode={ dataType="integer", name="eventCode", paramNum=1 },
                reason={ dataType="integer", name="reason", paramNum=2 },
                rank={ dataType="integer", name="rank", paramNum=3 },
                previousPoints={ dataType="integer", name="previousPoints", paramNum=4 },
                currentPoints={ dataType="integer", name="currentPoints", paramNum=5 },
            },
        },
        ["EVENT_VETERAN_POINTS_UPDATE"] = {
            ...
            PARAMS={
                eventCode={ dataType="integer", name="eventCode", paramNum=1 },
                unitTag={ dataType="string", name="unitTag", paramNum=2 },
                currentPoints={ dataType="integer", name="currentPoints", paramNum=3 },
