...
lwf4.__extend = function()
	...
	LWF4.__extension.InjectAdvancedSettings = function( self, optionsTable, afterOption )
		...
		opts[key].controls[1] = { type = "description", text = "|cF8E6E0This feature-set is granted via the LibWykkydFactory library that this addon embeds. It allows you to set 1 character as your system's default settings, or set a character to use that default as their own settings, or to use a specific character's settings.|r" }
