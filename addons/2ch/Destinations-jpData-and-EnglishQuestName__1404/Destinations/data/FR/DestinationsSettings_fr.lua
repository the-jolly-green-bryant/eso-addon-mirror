...
do
	...
	Add("DEST_SETTINGS_POI_HEADER",							"Points d'Intérêt (PI)")
	Add("DEST_SETTINGS_POI_HEADER_TT",						"Ce sous-menu couvre les Points d'Intérêt inconnus et connus, incluant la position des marchands de guilde.")
	Add("DEST_SETTINGS_POI_UNKOWN_SUBHEADER",				"Points d'Intérêt inconnus")
	Add("DEST_SETTINGS_POI_KNOWN_SUBHEADER",				"Points d'Intérêt connus")
