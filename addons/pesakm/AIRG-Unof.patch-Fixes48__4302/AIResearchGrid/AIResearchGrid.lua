...
-- AM - 4 new motifs (Coldsnap, Meridian, Anequine, Pellitine)
-- AM - 4 new motifs (Pyandonean, Psijic, Fang Lair and Sapiarch)
...
-- AM - added Tsaesci motif (crown store purchase)
-- AM - added multiple motifs
-- AM - Added Dead-water motif
-- AM - continuing maintenance
...
local CRAFTING_TYPE_MOTIFS = CRAFTING_TYPE_MAX_VALUE + 1

local bHideKnownStyles = false
...
local styles = {
	...
	[60] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2024}, -- Refabricated
	...
	[73] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2319}, -- Welkynar
	[74] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2188}, -- Dremora
	[75] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2285}, -- Pyandonean
	[77] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2317}, -- Huntsman
	[78] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2318}, -- Silver Dawn
	[79] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2360}, -- Dead-water
	[80] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2359}, -- Honor Guard
	[81] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2361}, -- Elder Argonian
	[82] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2503}, -- Coldsnap
	[83] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2504}, -- Meridian
	[84] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2505}, -- Anequina
	[85] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2506}, -- Pellitine
	[86] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2507}, -- Sunspire
	[89] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2629}, -- Stags of Z'en
	[92] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2630}, -- Dragonguard
	[93] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2628}, -- Moongrave Fane
	[94] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2748}, -- New Moon Priest
	[95] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2750}, -- Shield of Senchal
	[97] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2747}, -- Icereach Coven
	[98] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2749}, -- Pyre Watch
	[100] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2757},	-- Blackreach Vanguard
	[101] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2761},	-- Greymoor
	[102] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2762},	-- Sea Giant
	[103] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2763},	-- Ancestral Nord
	[104] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2773},	-- Ancestral High Elf
	[105] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2776},	-- Ancestral Orc
	[106] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2849}, 	-- Thorn Legion
	[107] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2850}, 	-- Hazardous Alchemy
	[108] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2903}, 	-- Ancestral Akaviri	
	...
	[130] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3258}, 	-- Syrabanic Marine
	[131] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3259},	-- Steadfast Society
	[132] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3260},	-- Systres Guardian
	--[133] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = }, 	-- Unused
	--[134] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = }, 	-- Ascendant Knight
	[135] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3422 },	-- Y'ffre's Will
	[136] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3423 },	-- Drowned Mariner
	--[137] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = }, 	-- Knowledge Eater
	[138] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3464 },	-- Firesong
	[139] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3465}, 	-- House Mornard
	[140] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3546}, 	-- Scribes of Mora
	[141] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3547}, 	-- Blessed Inheritor
	[142] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3667}, 	-- Clan Dreamcarver
	[143] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3668}, 	-- Dead Keeper
	[144] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3669}, 	-- Kindred's Concord
	[145] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3921}, 	-- The Recollection
	[146] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3922}, 	-- Blind Path Cultist
	[147] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3923}, 	-- Shardborn
	[148] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3924}, 	-- West Weald Legion
	[149] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3925}, 	-- Lucent Sentinel
	--[150] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = }, 	-- Unused
	[151] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = nil}, 	-- Hircine Bloodhunter
	--[152] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = }, 	-- Skingrad Vedette
	[153] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4159}, 	-- Exile's Revenge
	[154] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4160}, 	-- Militant Monk
	[155] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4240}, 	-- Stirk Fellowship
	[156] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4241}, 	-- Coldharbour Dominator
	[157] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4242}, 	-- Tide-Born
	[158] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = nil}, 	-- Black Soul Gem
	[159] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 4290}, 	-- Voskrona Guardian
}

-- /script local i for i=60,150 do d(i .. " " .. GetItemStyleName(i)) end
...
-- don't get rid of this and replace with for loop from styles list
-- it needs to be in the order shown below. sorting by styleid won't work
local styleOrder = {
	...
	[18] = ITEMSTYLE_AREA_TSAESCI,
	[19] = ITEMSTYLE_AREA_DWEMER,
	[20] = ITEMSTYLE_GLASS,
	[21] = ITEMSTYLE_AREA_XIVKYN,
	[22] = ITEMSTYLE_AREA_ANCIENT_ORC,
	[23] = ITEMSTYLE_AREA_AKAVIRI,
	[24] = ITEMSTYLE_UNDAUNTED,
	[25] = ITEMSTYLE_DEITY_MALACATH,
	[26] = ITEMSTYLE_DEITY_TRINIMAC,
	[27] = ITEMSTYLE_ORG_OUTLAW,
	[28] = ITEMSTYLE_ALLIANCE_EBONHEART,
	[29] = ITEMSTYLE_ALLIANCE_ALDMERI,
	[30] = ITEMSTYLE_ALLIANCE_DAGGERFALL,
	[31] = ITEMSTYLE_ORG_ABAHS_WATCH,
	[32] = ITEMSTYLE_ORG_THIEVES_GUILD,
	[33] = ITEMSTYLE_ORG_ASSASSINS,
	[34] = ITEMSTYLE_ENEMY_DROMOTHRA,
	[35] = ITEMSTYLE_DEITY_AKATOSH,
	[36] = ITEMSTYLE_ORG_DARK_BROTHERHOOD,
	[37] = ITEMSTYLE_ENEMY_MINOTAUR,
	[38] = ITEMSTYLE_RAIDS_CRAGLORN,
	[39] = ITEMSTYLE_ENEMY_DRAUGR,
	[40] = ITEMSTYLE_AREA_YOKUDAN,
	[41] = ITEMSTYLE_HOLIDAY_HOLLOWJACK,
	...
	[77] = 92,      -- Dragonguard
	[78] = 89,      -- Stags of Z'en
	[79] = 93,      -- Moongrave Fane
	[80] = 94,		-- New Moon Priest
	[81] = 95,		-- Shield of Senchal
	[82] = 97,		-- Icereach Coven
	[83] = 98,		-- Pyre Watch
	[84] = 100,		-- Blackreach Vanguard
	[85] = 101,		-- Greymoor
	[86] = 102,		-- Sea Giant
	[87] = 103,		-- Ancestral Nord
	[88] = 104,		-- Ancestral High Elf
	[89] = 105,		-- Ancestral Orc
	[90] = 106, 	-- Thorn Legion
	[91] = 107, 	-- Hazardous Alchemy
	[92] = 108,	-- Ancestral Akaviri	
	...
	[111] = 130,	-- Syrabanic Marine
	[112] = 131, 	-- Steadfast Society
	[113] = 132, 	-- Systres Guardian
	[114] = 135, 	-- Y'ffre's Will
	[115] = 136, 	-- Drowned Mariner
	[116] = 138,	-- House Mornard
	[117] = 139, 	-- Firesong
	[118] = 140,	-- Scribes of Mora
	[119] = 141,	-- Blessed Inheritor
	[120] = 142,	-- Clan Dreamcarver
	[121] = 143,	-- Dead Keeper
	[122] = 144,	-- Kindred's Concord
	[123] = 145,	-- The Recollection
	[124] = 146,	-- Blind Path Cultist
	[125] = 147,	-- Shardborn
	[126] = 148,	-- West Weald Legion
	[127] = 149,	-- Lucent Sentinel
	[128] = 151,	-- Hircine Bloodhunter
	--[] = 152,	-- Skingrad Vedette
	[129] = 153,	-- Exile's Revenge
	[130] = 154,	-- Militant Monk
	[131] = 155,	-- Stirk Fellowship
	[132] = 156,	-- Coldharbour Dominator
	[133] = 157,	-- Tide-Born
	[134] = 158,	-- Black Soul Gem
	[135] = 159,	-- Voskrona Guardian
}
			...
			if not styles[styleId].api or apiVersion >= styles[styleId].api then
				...
				if styles[styleId].stype == AIRG_STYLE_BASIC then
					if not styleData then
						...
						AIRG_UI.StyleButtons[styleId]:SetHidden(bHideKnownStyles)
					end
...
--							tooltipText = zo_strjoin(nil, tooltipText, "\n|cFFFFFF", GetString("SI_ITEMSTYLECHAPTER", indexValue), "|r")
							tooltipText = zo_strjoin(nil, tooltipText, "\n|cFFFFFF", zo_strformat("<<1>>", GetString("SI_ITEMSTYLECHAPTER", indexValue)), "|r")
							knownCount = knownCount + 1
							chapVal = chapVal + (2 ^ (chapterIndex - 1))		-- AM - Achieve links from styles
						else
							tooltipText = zo_strjoin(nil, tooltipText, "\n|c806060", zo_strformat("<<1>>", GetString("SI_ITEMSTYLECHAPTER", indexValue)), "|r")
						end
					end
...
local function PopulateTraitDataForCraft(craftingType)
	...
	db.char[playerName].traits = db.char[playerName].traits or {}
...
--		d("AI Research Grid: Data Update Completed")

	-- EVENT_SKILLS_FULL_UPDATE handle the % time bonus when buying a new skill in realtime
	elseif eventCode == EVENT_SKILLS_FULL_UPDATE and playerActivated then
...
local function DisplayGrid(b_ShowGrid)
	local i, j
	for i = 1, maxColumns do
		AIRG_UI.columnButtons[i]:SetHidden(not b_ShowGrid)
		AIRG_UI.columnButtons[i]:SetEnabled(b_ShowGrid)
		AIRG_UI.columnFooters[i]:SetHidden(not b_ShowGrid)
		for j = 1, 18 do
			if i == 1 then
				AIRG_UI.rowLabels[j]:SetHidden(not b_ShowGrid)
				AIRG_UI.rowLabels[j]:SetMouseEnabled(b_ShowGrid)
			end
			AIRG_UI.gridButtons[i][j]:SetHidden(not b_ShowGrid)
			AIRG_UI.gridButtons[i][j]:SetMouseEnabled(b_ShowGrid)
		end
	end
	AIRG_UI.columnFooterTitle:SetHidden(not b_ShowGrid)

	AIRG_UI.motifSection:SetHidden(b_ShowGrid)
end
...
local function OnCraftSelected(thisCraft)
	...
	if thisCraft == CRAFTING_TYPE_MOTIFS then
		DisplayGrid(false)
		AIRG_UI.WindowSubTitle:SetText(GetString(SI_GAMEPAD_DYEING_EQUIPMENT_ACTION_STYLES))
		return
	else
		DisplayGrid(true)
...
local function InitUI()
	...
	AIRG_UI.btnClothing:SetAnchor(TOPLEFT, AIRG_UI.btnBlacksmithing, BOTTOMLEFT, 0, 12)
	...
	AIRG_UI.btnWoodworking:SetAnchor(TOPLEFT, AIRG_UI.btnClothing, BOTTOMLEFT, 0, 12)
	...
	AIRG_UI.btnJewelryCrafting:SetAnchor(TOPLEFT, AIRG_UI.btnWoodworking, BOTTOMLEFT, 0 , 12)
	...
	-- CREATE BUTTON FOR Motifs tab
	AIRG_UI.btnMotifsPage = WINDOW_MANAGER:CreateControl("$(parent)ButtonMotifs", AIResearchGrid, CT_BUTTON)
	AIRG_UI.btnMotifsPage:SetDimensions(48, 48)
	AIRG_UI.btnMotifsPage:SetAnchor(TOPLEFT, AIRG_UI.btnJewelryCrafting, BOTTOMLEFT, 0 , 12)
	AIRG_UI.btnMotifsPage:SetState(BSTATE_NORMAL)
	AIRG_UI.btnMotifsPage:SetMouseOverBlendMode(0)
	AIRG_UI.btnMotifsPage:SetHidden(false)
	AIRG_UI.btnMotifsPage:SetEnabled(true)
	AIRG_UI.btnMotifsPage:SetClickSound(SOUNDS.DIALOG_ACCEPT)
	AIRG_UI.btnMotifsPage:SetNormalTexture("/esoui/art/icons/quest_book_001.dds")
	AIRG_UI.btnMotifsPage:SetMouseOverTexture("esoui/art/buttons/generic_highlight.dds")
	AIRG_UI.btnMotifsPage:SetHandler("OnClicked", function(self) OnCraftSelected(CRAFTING_TYPE_MOTIFS) end)
	AIRG_UI.btnMotifsPage:SetHandler("OnMouseEnter", function(self) ZO_Tooltips_ShowTextTooltip(self, RIGHT, GetString(SI_GAMEPAD_DYEING_EQUIPMENT_ACTION_STYLES)) end)
	AIRG_UI.btnMotifsPage:SetHandler("OnMouseExit", function (self) ZO_Tooltips_HideTextTooltip() end)
	...
	AIRG_UI.motifSection:SetDimensions(650, 45 * 7)
	AIRG_UI.motifSection:SetAnchor(TOPLEFT, AIRG_UI.btnBlacksmithing, TOPRIGHT, 40, 20)

	AIRG_UI.btnHideKnownStyles = WINDOW_MANAGER:CreateControl("$(parent)ButtonHideKnown", AIRG_UI.motifSection, CT_BUTTON)
	AIRG_UI.btnHideKnownStyles:SetDimensions(32, 32)
	AIRG_UI.btnHideKnownStyles:SetAnchor(BOTTOMLEFT, AIRG_UI.motifSection, BOTTOMLEFT, 5 , -5)
	AIRG_UI.btnHideKnownStyles:SetState(BSTATE_NORMAL)
	AIRG_UI.btnHideKnownStyles:SetMouseOverBlendMode(0)
	AIRG_UI.btnHideKnownStyles:SetHidden(false)
	AIRG_UI.btnHideKnownStyles:SetEnabled(true)
	AIRG_UI.btnHideKnownStyles:SetClickSound(SOUNDS.DIALOG_ACCEPT)
	AIRG_UI.btnHideKnownStyles:SetNormalTexture("/esoui/art/lfg/lfg_tabicon_grouptools_up.dds")
	AIRG_UI.btnHideKnownStyles:SetPressedTexture("/esoui/art/lfg/lfg_tabicon_grouptools_down.dds")
	AIRG_UI.btnHideKnownStyles:SetHandler("OnClicked", function(self) AIRG_ToggleStyles() end)
	AIRG_UI.btnHideKnownStyles:SetHandler("OnMouseEnter", function(self) ZO_Tooltips_ShowTextTooltip(self, TOP, "Hide/Show Known Styles") end)
	AIRG_UI.btnHideKnownStyles:SetHandler("OnMouseExit", function (self) ZO_Tooltips_HideTextTooltip() end)

-- new control for text search get's added here

	local searchCtrl
	searchCtrl = WINDOW_MANAGER:CreateControlFromVirtual("$(parent)SearchBox", AIRG_UI.motifSection, "AIRG_SearchBox")
	searchCtrl:SetAnchor(TOPLEFT, AIRG_UI.btnHideKnownStyles, BOTTOMLEFT, 5 , -5)
	searchCtrl:SetHidden(false)
	AIRG_UI.searchCtrl = AIResearchGridMotifSectionSearchBoxBackdropBox
--	AIRG_UI.searchCtrlBGText = AIResearchGridMotifSectionSearchBoxBackdropBoxText
--	AIRG_UI.searchCtl:SetHandler("OnClicked", function(self) AIRG_ToggleStyles() end)
--	AIRG_UI.searchCtl:SetHandler("OnMouseEnter", function(self) ZO_Tooltips_ShowTextTooltip(self, TOP, "Hide/Show Known Styles") end)
--	AIRG_UI.searchCtl:SetHandler("OnMouseExit", function (self) ZO_Tooltips_HideTextTooltip() end)

	AIRG_UI.StyleButtons = {}

	local styleColumn = 0
	local styleColumnAlign = 0		-- alignment of 2nd line of style icons (first line is static and won't be changed)
	local styleRow = 0
	local styleHeight = 48
	local styleWidth = 43
	local bFirstChapterizedDone = false
	local bFirstCrownDone = false
...
--	for styleId, styleData in pairs(styles) do
		...
		if not styleData.api or apiVersion >= styleData.api then
			...
			elseif styleData.stype == AIRG_STYLE_CROWNSTORE then
				if not bFirstCrownDone then
					bFirstCrownDone = true
					styleRow = styleRow + 1
					styleColumn = 0
				end
			elseif styleData.stype == AIRG_STYLE_CHAPTERIZED then
				if not bFirstChapterizedDone then
					bFirstChapterizedDone = true
					styleRow = styleRow + 1
					styleColumn = 0
				end

				if (styleColumn + 1) * styleWidth > 650 then
					styleRow = styleRow + 1
					styleColumn = 0
				end
			end
			...
			AIRG_UI.StyleButtons[styleId]:SetAnchor(TOPLEFT, AIRG_UI.motifSection, TOPLEFT, styleColumn * styleWidth, styleRow * styleHeight)
			...
			if stoneTexture == "" then
				AIRG_UI.StyleButtons[styleId]:SetHidden(true)
			end

			styleColumn = styleColumn + 1
		end
	end
	AIRG_UI.motifSection:SetHeight((styleRow + 2.5) * styleHeight)
end
...
function AIRG_ToggleStyles()
	local iconId, icon
	local r, g, b, a

	if AIRG_UI.searchCtrl:GetText() ~= "" then
		AIRG_UI.searchCtrl:SetText("")
		--AIRG_UI.searchCtrlBGText:SetHidden(false)
	end
	bHideKnownStyles = not bHideKnownStyles

	if bHideKnownStyles then
		AIRG_UI.btnHideKnownStyles:SetState(BSTATE_PRESSED)
	else
		AIRG_UI.btnHideKnownStyles:SetState(BSTATE_NORMAL)
	end

	for iconId, icon in pairs(AIRG_UI.StyleButtons) do
		if icon:GetTextureFileName() ~= "" then
			if bHideKnownStyles then
				r, g, b, a = icon:GetColor()
				if b == 1 then		-- icon is full RGB, meaning all known
					icon:SetHidden(true)
				end
			else
...
function AIRG_onSearchBoxClear()
	if AIRG_UI.searchCtrl:GetText() > "" then
		AIRG_UI.searchCtrl:SetText("")
	end
	--AIRG_UI.searchCtrlBGText:SetHidden(false)
	bHideKnownStyles = true
	AIRG_ToggleStyles()
end

function AIRG_onSearchBoxText(ctrl)
	--AIRG_UI.searchCtrlBGText:SetHidden(true)
	bHideKnownStyles = false
	AIRG_UI.btnHideKnownStyles:SetState(BSTATE_NORMAL)
	local SrchText = ctrl:GetText()

	if SrchText == nil or SrchText == "" then
		AIRG_onSearchBoxClear()
	end

	local iconId, icon

	for styleId, icon in pairs(AIRG_UI.StyleButtons) do
		if icon:GetTextureFileName() ~= "" then
			if zo_plainstrfind(GetItemStyleName(styleId):lower(), SrchText:lower()) then
				icon:SetHidden(false)
			else
				icon:SetHidden(true)
			end
