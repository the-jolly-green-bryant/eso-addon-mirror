local moduleStrings = {
    REPAIR = "Ремонт, заряджання та дослідження",
    REPAIR_TOOLTIP = "Вмикає автоматичний ремонт екіпіровки, заряджання зброї та дослідження ремісничих трейтів.",
...
local strings = {
    ...
    RESEARCH_TOOLTIP = "Налаштування дослідження ремісничих трейтів.",
    RESEARCH_CHAT_MESSAGES = "Повідомлення про дослідження в чаті",
    RESEARCH_CHAT_MESSAGES_TOOLTIP = "Показує, який предмет і з яким трейтом Universal Assistant автоматично поставив на дослідження.",
    RESEARCH_STARTED = "Поставлено на дослідження %s із трейтом %s.",
    RESEARCH_BLACKSMITHING = "Ковальство",
    RESEARCH_CLOTHING = "Кравецтво",
    RESEARCH_WOODWORKING = "Столярство",
    RESEARCH_JEWELRY = "Ювелірна справа",
    RESEARCH_SELECT_ALL = "Вибрати всі",
    RESEARCH_PRIORITY = "Пріоритет дослідження",
    RESEARCH_PRIORITY_TOOLTIP = "«По черзі» перевіряє пункти згори вниз: спочатку кільце зліва, потім намисто справа. «За найменшим часом дослідження» надає перевагу доступному предмету, трейт якого вивчиться швидше.",
    RESEARCH_PRIORITY_SEQUENCE = "По черзі",
    RESEARCH_PRIORITY_SHORTEST = "За найменшим часом дослідження",
}

local ua = UAssistant
ua.AddLanguageStrings("ua", moduleStrings)
ua.AddLanguageStrings("ua", strings, "REPAIR")
