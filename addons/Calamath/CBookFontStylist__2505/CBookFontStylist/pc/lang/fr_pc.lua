...
SAS(SI_CBFS_UI_SHOW_READER_WND_NAME,	"Prévisualisation", 1)
SAS(SI_CBFS_UI_SHOW_READER_WND_TIPS,	"Affiche en vue réelle les paramètres de police appliqués au support sélectionné.", 1)
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------
SAS(SI_CBFS_UI_PREVIEW_BODY_LOCALE,		"Le cœur déçu mais l'âme plutôt naïve, Louÿs rêva de crapaüter en canoë au delà des îles, près du mälströn où brûlent les novæ.\n\n", 1)
