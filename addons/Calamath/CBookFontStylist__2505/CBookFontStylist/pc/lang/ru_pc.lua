...
SAS(SI_CBFS_UI_SHOW_READER_WND_NAME,	"Preview", 1)
SAS(SI_CBFS_UI_SHOW_READER_WND_TIPS,	"Preview your book font settings", 1)
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------
SAS(SI_CBFS_UI_PREVIEW_BODY_LOCALE,		"Эй, жлоб! Где туз? Прячь юных съёмщиц в шкаф.\n\n", 1)
