	...
	{	type = "submenu", name = GetString(PP_LAM_LIST_STYLE),
		controls = {
			...
			{	type				= 'iconpicker',
				...
				setFunc				= function(str) PP.savedVars.ListStyle.list_skin_backdrop = str PP:ResetStyleList() end,
				maxColumns			= 3,
				visibleRows			= 5,
				iconSize			= 52,
			...
			{	type 				= "slider", name = GetString(PP_LAM_LIST_STYLE_INSETS),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_backdrop_insets = value PP:ResetStyleList() end,
			...
			{	type				= "checkbox", name = GetString(PP_LAM_LIST_STYLE_TILE_LAYING),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_backdrop_tile = value PP:ResetStyleList() end,
			...
			{	type				= 'dropdown',
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_backdrop_tile_size = value PP:ResetStyleList() end,
			...
			{	type				= "colorpicker", name = GetString(PP_LAM_LIST_STYLE_COLOR),
				...
				setFunc				= function(r, g, b, a) PP.savedVars.ListStyle.list_skin_backdrop_col = { r, g, b, a } PP:ResetStyleList() end,
				width				= "half",
			...
			{	type				= "colorpicker", name = GetString(PP_LAM_LIST_STYLE_HIGHLIGHT_COLOR),
				...
				setFunc				= function(r, g, b, a) PP.savedVars.ListStyle.list_skin_backdrop_hl_col = { r, g, b, a } PP:ResetStyleList() end,
				width				= "half",
			...
			{	type				= 'iconpicker',
				...
				setFunc				= function(str) PP.savedVars.ListStyle.list_skin_edge = str PP:ResetStyleList() end,
				maxColumns			= 3,
				visibleRows			= 5,
				iconSize			= 52,
			...
			{	type 				= "slider", name = GetString(PP_LAM_LIST_STYLE_THICKNESS),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_edge_thickness = value PP:ResetStyleList() end,
			...
			{	type				= 'dropdown',
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_edge_file_width = value PP:ResetStyleList() end,
			...
			{	type				= 'dropdown',
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_edge_file_height = value PP:ResetStyleList() end,
			...
			{	type				= "colorpicker", name = GetString(PP_LAM_LIST_STYLE_COLOR),
				...
				setFunc				= function(r, g, b, a) PP.savedVars.ListStyle.list_skin_edge_col = { r, g, b, a } PP:ResetStyleList() end,
				width				= "half",
			...
			{	type				= "colorpicker", name = GetString(PP_LAM_LIST_STYLE_SELECTED_COLOR),
				...
				setFunc				= function(r, g, b, a) PP.savedVars.ListStyle.list_skin_edge_sel_col = { r, g, b, a } PP:ResetStyleList() end,
				width				= "half",
			...
			{	type				= "checkbox", name = GetString(PP_LAM_LIST_STYLE_STRETCH_TEXTURE_EDGE),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_skin_edge_integral_wrapping = value PP:ResetStyleList() end,
			...
			{	type 				= "slider", name = GetString(PP_LAM_LIST_STYLE_FADE_DISTANCE),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_fade_distance = value PP:ResetStyleList() end,
			...
			{	type 				= "slider", name = GetString(PP_LAM_LIST_STYLE_UNIFORM_CONTROL_HEIGHT),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_uniform_control_height = value PP:ResetStyleList() end,
			...
			{	type 				= "slider", name = GetString(PP_LAM_LIST_STYLE_CONTROL_HEIGHT),
				...
				setFunc				= function(value) PP.savedVars.ListStyle.list_control_height = value PP:ResetStyleList() end,
