...
local libssp, oldminor = LibStub:NewLibrary(MAJOR, MINOR)
if not libssp then return end	--the same or newer version of this lib is already loaded into memory
...
-- addons are not allowed to use different rowTypeId's within a list
