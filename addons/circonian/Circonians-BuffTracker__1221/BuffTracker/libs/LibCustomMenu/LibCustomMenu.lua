...
local MAJOR, MINOR = "LibCustomMenu", 2
...
function Submenu:UpdateAnchors()
	...
	for i = 1, #items do
		...
		if i == 1 then
			...
			item:SetAnchor(TOPLEFT, previousItem, BOTTOMLEFT, 0, 0)
			item:SetAnchor(TOPRIGHT, previousItem, BOTTOMRIGHT, 0, 0)
		end
