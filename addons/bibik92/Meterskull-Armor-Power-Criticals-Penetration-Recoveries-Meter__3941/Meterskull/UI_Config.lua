...
local UIModuleConfig = {
    ...
    LAYOUTS = {
        ...
        DUAL_LABELS_STACKED = "dual_labels_stacked" -- 1 value with 2 stacked labels
    },
...
-- Export configuration with addon-specific names to avoid global collisions
_G.MeterskullUILayoutConfig = UIModuleConfig
_G.MeterskullModuleUIConfig = UIModuleConfig.MODULES
