...
local function BuildSettingsData()
    ...
    add(BuildCheckbox(GetString(SI_GPH_SETTING_TOOLTIP_SET_COLLECTION_NAME), GetString(SI_GPH_SETTING_TOOLTIP_SET_COLLECTION_TOOLTIP), "tooltipSetCollectionEnabled"))
