...
local optionsTable = {
    ...
    {
        type = "checkbox",
        name = "Color Overlay: Proc-1 stack",
        tooltip = "Differentiate the significance of Proc-1 stacks to prepare to fire bow proc.",
    ...
    {
        type = "checkbox",
        name = "Color Overlay: OverProc",
        tooltip = "When a proc is active and spectral bow is ready to be fired twice in a row, overlay the indicator with a color.",
        getFunc = function() return getColorOverlay('overproc') end,
        setFunc = function(value) setColorOverlay('overproc', value) end,
        width = "full",
    },
    {
        type = "colorpicker",
        disabled = function() return not getColorOverlay('overproc') end,
        tooltip = "Color used for Color Overlay: Overproc",
        getFunc = function() return getColor('overproc') end,
        setFunc = function(r, g, b, a) setColor('overproc', r, g, b, a) end,
    },
    {
        type = "submenu",
