...
strings.AREA_ANIMATION = "Quest Areas"
...
strings.PIN_TYPE_NAMES = {
	...
	[MAP_PIN_TYPE_DARK_BROTHERHOOD_TARGET] = "Dark Brotherhood Target",
	
	[MAP_PIN_TYPE_QUEST_OFFER] = "Quest Offer",
	[MAP_PIN_TYPE_ASSISTED_QUEST_CONDITION] = "Tracked Quest Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_OPTIONAL_CONDITION] = "Tracked Quest Optional Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_ENDING] = "Tracked Quest Ending",
	[MAP_PIN_TYPE_QUEST_CONDITION] = "Secondary Quest Step",
	[MAP_PIN_TYPE_QUEST_OPTIONAL_CONDITION] = "Secondary Quest Optional Step",
	[MAP_PIN_TYPE_QUEST_ENDING] = "Secondary Quest Ending",
	
	[MAP_PIN_TYPE_QUEST_OFFER_REPEATABLE] = "Quest Offer",
	[MAP_PIN_TYPE_ASSISTED_QUEST_REPEATABLE_CONDITION] = "Tracked Quest Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_REPEATABLE_OPTIONAL_CONDITION] = "Tracked Quest Optional Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_REPEATABLE_ENDING] = "Tracked Quest Ending",
	[MAP_PIN_TYPE_QUEST_REPEATABLE_CONDITION] = "Secondary Quest Step",
	[MAP_PIN_TYPE_QUEST_REPEATABLE_OPTIONAL_CONDITION] = "Secondary Quest Optional Step",
	[MAP_PIN_TYPE_QUEST_REPEATABLE_ENDING] = "Secondary Quest Ending",
	
	[MAP_PIN_TYPE_QUEST_OFFER_ZONE_STORY] = "Quest Offer",
	[MAP_PIN_TYPE_ASSISTED_QUEST_ZONE_STORY_CONDITION] = "Tracked Quest Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_ZONE_STORY_OPTIONAL_CONDITION] = "Tracked Quest Optional Step",
	[MAP_PIN_TYPE_ASSISTED_QUEST_ZONE_STORY_ENDING] = "Tracked Quest Ending",
	[MAP_PIN_TYPE_QUEST_ZONE_STORY_CONDITION] = "Secondary Quest Step",
	[MAP_PIN_TYPE_QUEST_ZONE_STORY_OPTIONAL_CONDITION] = "Secondary Quest Optional Step",
