...
local strings = {
	...
	--SI_LOST_TREASURE_TREASURE_MAPS = "Treasure Maps",						--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_SURVEY_REPORTS = "Survey Reports",					--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_CLUES = "Tribute Clues",								--changed to official translations > less work when a new language will be added to the game

	--SI_LOST_TREASURE_COMPARE_TREASURE = "treasure map",					--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_COMPARE_SURVEY = "survey",							--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_COMPARE_CLUE = "tribute clue",						--changed to official translations > less work when a new language will be added to the game
		
	SI_LOST_TREASURE_MAP_FILTER_CHECKBOX_NAME = "<<C:1>> (<<C:2>>)",

	--SI_LOST_TREASURE_SHOW_ON_MAP = "Show on map",							--changed to official translations > less work when a new language will be added to the game
	...
	--SI_LOST_TREASURE_PIN_ICON = "Icon",									--changed to official translations > less work when a new language will be added to the game
