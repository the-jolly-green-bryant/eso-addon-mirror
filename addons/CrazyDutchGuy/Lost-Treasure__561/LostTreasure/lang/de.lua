...
local strings = {
	--SI_LOST_TREASURE_TREASURE_MAPS = "Schatzkarten",							--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_SURVEY_REPORTS = "Fundberichte",							--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_CLUES = "Ruhm-Hinweise",									--changed to official translations > less work when a new language will be added to the game

	--SI_LOST_TREASURE_COMPARE_TREASURE = "schatzkarte:",						--changed to official translations > less work when a new language will be added to the game
	--SI_LOST_TREASURE_COMPARE_SURVEY = "fundberichte:",						--changed to official translations > less work when a new language will be added to the game

	--SI_LOST_TREASURE_SHOW_ON_MAP = "Auf Karte anzeigen",						--changed to official translations > less work when a new language will be added to the game
	...
	--SI_LOST_TREASURE_PIN_ICON = "Symbol",										--changed to official translations > less work when a new language will be added to the game
