...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "Confirma el diálogo para abrir tu enlace en el navegador.",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "Parte <<1>> de <<2>> enviada. Cuando el navegador se haya abierto, vuelve al juego y agáchate (o abre y cierra un menú) para enviar la siguiente parte. /bsshare stop cancela.",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "Enviando la parte <<1>> de <<2>>...",
    [BATTLESCROLLS_SHARE_DONE] = "Las <<1>> partes se han enviado: el navegador muestra tu enlace.",
    [BATTLESCROLLS_SHARE_FAILED] = "No se pudo preparar el enlace.",
    [BATTLESCROLLS_SHARE_BUSY] = "Ya hay un envío en curso: /bsshare stop lo cancela.",
