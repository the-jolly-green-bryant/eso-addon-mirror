...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_HINT] = "Confirma el aviso del navegador, vuelve al juego y envía la siguiente parte.",
    [BATTLESCROLLS_SHARE_HINT_LEAVE] = "Puedes salir de esta pantalla — el progreso se conserva.",
    ...
    [BATTLESCROLLS_SHARE_DONE_RESEND_HINT] = "Si la página del navegador indica partes faltantes, selecciónalas arriba y reenvíalas.",
    [BATTLESCROLLS_SHARE_DIAG_HEADER] = "Diagnóstico",
}
