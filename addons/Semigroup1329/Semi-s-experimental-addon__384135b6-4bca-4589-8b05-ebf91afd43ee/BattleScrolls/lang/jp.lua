...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "ダイアログを確認するとブラウザで共有ページが開きます。",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "パート<<1>>/<<2>>を送信しました。ブラウザが開いたらゲームに戻り、しゃがむ（またはメニューを開いて閉じる）と次のパートを送信します。/bsshare stopで中止できます。",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "パート<<1>>/<<2>>を送信中...",
    [BATTLESCROLLS_SHARE_DONE] = "全<<1>>パートを送信しました。ブラウザに共有ページが表示されています。",
    [BATTLESCROLLS_SHARE_FAILED] = "共有を準備できませんでした。",
    [BATTLESCROLLS_SHARE_BUSY] = "共有が進行中です。/bsshare stopで中止できます。",
