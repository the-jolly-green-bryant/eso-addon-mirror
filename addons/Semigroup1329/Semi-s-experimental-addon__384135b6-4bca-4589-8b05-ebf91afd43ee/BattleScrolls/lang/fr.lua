...
local shareStrings = {
    ...
    [BATTLESCROLLS_SETTINGS_MEMDIAG_HEADER] = "Diagnostic mémoire",
    [BATTLESCROLLS_MEMDIAG_LUA_HEAP] = "Mémoire Lua (tous les addons)",
    [BATTLESCROLLS_MEMDIAG_RUN_GC] = "Lancer un nettoyage mémoire complet",
    [BATTLESCROLLS_MEMDIAG_MEASURE] = "Mesurer les données enregistrées",
    [BATTLESCROLLS_MEMDIAG_RAW] = "Données enregistrées (modèle brut)",
    [BATTLESCROLLS_MEMDIAG_FILE] = "Fichier sérialisé (approx.)",
    [BATTLESCROLLS_MEMDIAG_SHOWN] = "Estimation de l'historique (affichée)",
    [BATTLESCROLLS_MEMDIAG_ALLOC_STRINGS] = "Allouer 5 Mo de chaînes",
    [BATTLESCROLLS_MEMDIAG_ALLOC_TABLES] = "Allouer 5 Mo de tables",
    [BATTLESCROLLS_MEMDIAG_RELEASE] = "Libérer les données de test",
    [BATTLESCROLLS_MEMDIAG_HELD] = "Données de test retenues",
    [BATTLESCROLLS_MEMDIAG_BUSY] = "En cours…",
    [BATTLESCROLLS_MEMDIAG_VALUE_MB] = "<<1>> Mo",
    [BATTLESCROLLS_MEMDIAG_VALUE_MB_PAIR] = "<<1>> / <<2>> Mo",
    ...
    [BATTLESCROLLS_SHARE_CANCELLED] = "Partage annulé.",
...
local featureStrings = {
    ...
    [BATTLESCROLLS_TAB_RAID_DAMAGE] = "Dégâts du groupe",
    [BATTLESCROLLS_STAT_RAID_DAMAGE] = "Dégâts totaux du groupe",
    [BATTLESCROLLS_STAT_RAID_DPS] = "DPS du groupe",

    [BATTLESCROLLS_GROUP_COL_RES] = "Rés",

    [BATTLESCROLLS_SETTINGS_BAR_COLOR] = "Couleur de votre barre",
    [BATTLESCROLLS_SETTINGS_BAR_COLOR_TEXT] = "La couleur de votre propre barre dans le compteur de groupe « Barres colorées ». Elle est partagée avec les membres du groupe utilisant Battle Scrolls, qui verront donc aussi votre barre dans cette couleur.",
    [BATTLESCROLLS_COLOR_DEFAULT] = "Par défaut",
    [BATTLESCROLLS_COLOR_RED] = "Rouge",
    [BATTLESCROLLS_COLOR_ORANGE] = "Orange",
    [BATTLESCROLLS_COLOR_GOLD] = "Or",
    [BATTLESCROLLS_COLOR_GREEN] = "Vert",
    [BATTLESCROLLS_COLOR_TEAL] = "Sarcelle",
    [BATTLESCROLLS_COLOR_CYAN] = "Cyan",
    [BATTLESCROLLS_COLOR_BLUE] = "Bleu",
    [BATTLESCROLLS_COLOR_PURPLE] = "Violet",
    [BATTLESCROLLS_COLOR_PINK] = "Rose",
    [BATTLESCROLLS_COLOR_WHITE] = "Blanc",
...
SafeAddString(BATTLESCROLLS_MEMLAB_TIMEOUT, "Temps limite", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_HEADER, "Lab %s: MiB G=pool H=Lua; avant/test/libéré", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_SEED_INFO, "%s: n=%d; fichier %s MiB", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_MATCHES, "Résultats API non vides sur tous les passages : %d", 1)
...
SafeAddString(BATTLESCROLLS_MEMLAB_WATCH_STARTED, "Mesure lancée. Effectuez l’activité à mesurer.", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_SEED_CLEARED, "Données de test retirées ; historique inchangé.", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_SAVE_RESTART, "Sauvegardez avec /reloadui, puis redémarrez le jeu.", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_REMOVE_SEED, "Effacez le test et redémarrez avant les tests runtime.", 1)
...
SafeAddString(BATTLESCROLLS_MEMLAB_TABLE_SEED_REQUIRED, "Chargez les données de test tables avant compact.", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_USAGE_TABLES, "/bsmemlab seed tables 4096|8192|16384|32768; compact; census", 1)

SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_HEADER, "Comptage: MiB; L=liste K=hachage estimés", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_CACHE, "Historique: %d inst; cache %.2f (%d absents)", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_HISTORY, "Historique L%.2f K%.2f", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_SETUPS, "Équipements K: soi %.2f groupe %.2f", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_TOTAL, "Total sauvegardé L%.2f K%.2f", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_ARRAYS, "Tableaux %d; capacité arrondie %d", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_CENSUS_STRINGS, "Chaînes %d; %.2f MiB", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_MIRROR_INFO, "Copie T%d S%d L%.2f K%.2f", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_MIRROR_CLEAR, "Effacez le test et redémarrez avant de copier.", 1)
SafeAddString(BATTLESCROLLS_MEMLAB_DISCARD_REQUIRED, "Chargez des données de test avant discard.", 1)
