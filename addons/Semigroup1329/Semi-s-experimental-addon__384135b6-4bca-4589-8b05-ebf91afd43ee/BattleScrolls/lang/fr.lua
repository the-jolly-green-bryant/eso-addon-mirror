...
local featureStrings = {
    ...
    [BATTLESCROLLS_TOOLTIP_GROUP_DAMAGE_SCOPE] = "Tout ce que votre client de jeu a vu : vos dégâts (familiers et compagnons compris) plus ce qu'il a observé de tous les autres à proximité. Le jeu n'indique pas qui a infligé le reste, donc « Autres » forme un seul ensemble.",

    [BATTLESCROLLS_GROUP_COL_RES] = "Rés",

    [BATTLESCROLLS_SETTINGS_BAR_COLOR] = "Couleur de votre barre",
    [BATTLESCROLLS_SETTINGS_BAR_COLOR_TEXT] = "Les membres du groupe utilisant Battle Scrolls avec le style « Barres » voient votre barre dans cette couleur, même si vous utilisez un autre style ou désactivez votre compteur de groupe.",
    ...
    [BATTLESCROLLS_COLOR_SAVE_HINT] = "Votre barre aura cette couleur dans Battle Scrolls pour tous ceux qui utilisent « Barres », quel que soit votre style.",
