...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_HINT] = "Confirmez l'invite du navigateur, revenez en jeu et envoyez la partie suivante.",
    [BATTLESCROLLS_SHARE_HINT_LEAVE] = "Vous pouvez quitter cet écran — la progression est conservée.",
    ...
    [BATTLESCROLLS_SHARE_DONE_RESEND_HINT] = "Si la page du navigateur signale des parties manquantes, sélectionnez-les ci-dessus et renvoyez-les.",
    [BATTLESCROLLS_SHARE_DIAG_HEADER] = "Diagnostic",
}
