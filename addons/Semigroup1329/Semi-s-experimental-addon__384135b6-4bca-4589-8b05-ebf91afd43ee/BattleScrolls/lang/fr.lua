...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "Confirmez la boîte de dialogue pour ouvrir votre partage dans le navigateur.",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "Partie <<1>> sur <<2>> envoyée. Une fois le navigateur ouvert, revenez en jeu et accroupissez-vous (ou ouvrez puis fermez un menu) pour envoyer la partie suivante. /bsshare stop annule.",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "Envoi de la partie <<1>> sur <<2>>...",
    [BATTLESCROLLS_SHARE_DONE] = "Les <<1>> parties ont été envoyées : le navigateur affiche votre partage.",
    [BATTLESCROLLS_SHARE_FAILED] = "Impossible de préparer le partage.",
    [BATTLESCROLLS_SHARE_BUSY] = "Un partage est déjà en cours : /bsshare stop l'annule.",
