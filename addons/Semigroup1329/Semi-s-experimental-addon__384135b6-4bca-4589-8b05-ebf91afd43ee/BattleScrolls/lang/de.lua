...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_HINT] = "Bestätige die Browser-Abfrage, kehre ins Spiel zurück und sende den nächsten Teil.",
    [BATTLESCROLLS_SHARE_HINT_LEAVE] = "Du kannst diesen Bildschirm verlassen — der Fortschritt bleibt erhalten.",
    ...
    [BATTLESCROLLS_SHARE_DONE_RESEND_HINT] = "Meldet die Browserseite fehlende Teile, wähle sie oben aus und sende sie erneut.",
    [BATTLESCROLLS_SHARE_DIAG_HEADER] = "Diagnose",
}
