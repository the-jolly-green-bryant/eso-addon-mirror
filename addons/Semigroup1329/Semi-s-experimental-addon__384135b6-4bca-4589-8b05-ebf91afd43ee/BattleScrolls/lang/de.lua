...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "Bestätigt den Dialog, um eure Freigabe im Browser zu öffnen.",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "Teil <<1>> von <<2>> gesendet. Sobald der Browser offen war, kehrt ins Spiel zurück und schleicht euch (oder öffnet und schließt ein Menü), um den nächsten Teil zu senden. /bsshare stop bricht ab.",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "Teil <<1>> von <<2>> wird gesendet...",
    [BATTLESCROLLS_SHARE_DONE] = "Alle <<1>> Teile gesendet - der Browser zeigt eure Freigabe.",
    [BATTLESCROLLS_SHARE_FAILED] = "Die Freigabe konnte nicht vorbereitet werden.",
    [BATTLESCROLLS_SHARE_BUSY] = "Eine Freigabe läuft bereits - /bsshare stop bricht sie ab.",
