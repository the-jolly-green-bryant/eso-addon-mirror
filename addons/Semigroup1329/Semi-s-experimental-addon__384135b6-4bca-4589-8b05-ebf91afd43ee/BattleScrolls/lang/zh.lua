...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "确认对话框后，分享页面将在浏览器中打开。",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "已发送第<<1>>/<<2>>部分。浏览器打开后请返回游戏，下蹲（或打开并关闭菜单）即可发送下一部分。输入 /bsshare stop 可取消。",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "正在发送第<<1>>/<<2>>部分...",
    [BATTLESCROLLS_SHARE_DONE] = "全部<<1>>个部分已发送，浏览器中显示你的分享。",
    [BATTLESCROLLS_SHARE_FAILED] = "无法准备分享。",
    [BATTLESCROLLS_SHARE_BUSY] = "已有分享正在进行——/bsshare stop 可取消。",
