...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_SINGLE] = "Подтвердите диалог, чтобы открыть ссылку в браузере.",
    [BATTLESCROLLS_SHARE_STEP_WAIT] = "Часть <<1>> из <<2>> отправлена. Когда браузер откроется, вернитесь в игру и присядьте (или откройте и закройте меню), чтобы отправить следующую. /bsshare stop — отмена.",
    [BATTLESCROLLS_SHARE_STEP_FIRING] = "Отправка части <<1>> из <<2>>...",
    [BATTLESCROLLS_SHARE_DONE] = "Все <<1>> частей отправлены — ссылка открыта в браузере.",
    [BATTLESCROLLS_SHARE_FAILED] = "Не удалось подготовить отправку.",
    [BATTLESCROLLS_SHARE_BUSY] = "Отправка уже идёт — /bsshare stop отменит её.",
