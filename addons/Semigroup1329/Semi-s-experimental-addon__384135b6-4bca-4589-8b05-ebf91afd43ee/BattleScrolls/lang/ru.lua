...
local shareStrings = {
    ...
    [BATTLESCROLLS_SHARE_HINT] = "Подтвердите открытие браузера, вернитесь в игру и отправьте следующую часть.",
    [BATTLESCROLLS_SHARE_HINT_LEAVE] = "Можно выйти с этого экрана — прогресс сохранится.",
