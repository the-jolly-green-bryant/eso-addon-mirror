...
ZO_CreateStringId("BATTLESCROLLS_SHARE_SINGLE", "Confirm the dialog to open your share in the browser.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_STEP_WAIT", "Sent part <<1>> of <<2>>. Once the browser has opened, return to the game and crouch (or open and close a menu) to send the next part. /bsshare stop cancels.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_STEP_FIRING", "Sending part <<1>> of <<2>>...")
ZO_CreateStringId("BATTLESCROLLS_SHARE_DONE", "All <<1>> parts sent - the browser shows your share.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_FAILED", "Could not prepare the share.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_BUSY", "A share is already in progress - /bsshare stop cancels it.")
