...
ZO_CreateStringId("BATTLESCROLLS_SHARE_HINT", "Confirm the browser prompt, return to the game, send the next part.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_HINT_LEAVE", "You can leave this screen — progress is kept.")
...
ZO_CreateStringId("BATTLESCROLLS_SHARE_DONE_RESEND_HINT", "If the browser page reports missing parts, select them above and resend.")
ZO_CreateStringId("BATTLESCROLLS_SHARE_DIAG_HEADER", "Diagnostics")
