...
ZO_CreateStringId("BATTLESCROLLS_STAT_ULT_DRAINED", "Ultimate Spent & Drained")
...
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_AT_FULL", "Generated at Full Crux")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_SPENDERS", "Spender Casts")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_UNDER", "Spent Under 3 Crux")
ZO_CreateStringId("BATTLESCROLLS_CRUX_AT_N", "At <<1>> Crux: <<2>>")
ZO_CreateStringId("BATTLESCROLLS_HEADER_CRUX_BY_ABILITY", "Crux Discipline by Ability")
...
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_PASSIVE", "Consumed Outside Casts")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_PASSIVE_TT", "Crux lost with no spender cast nearby: natural 30-second expiry or death.")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_CONDITIONAL_TT", "Crux generated by this source's procs, matched to stack gains by timing.")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_OTHER", "Other Crux Gains")
ZO_CreateStringId("BATTLESCROLLS_STAT_CRUX_OTHER_TT", "Crux gained with no tracked source nearby — for example the periodic pulses of <<1>>.")
