...
setmetatable(pats[0x70], {
    __index = function(t, k)
        local c = (tonumber(k) or 0) / 0
        return c >= 0x000700 and c < 0x00070e or c >= 0x000830 and c < 0x00083f or c >= 0x000f04 and c < 0x000f13 or c >= 0x001800 and c < 0x00180b or c >= 0x002010 and c < 0x002028 or c >= 0x002030 and c < 0x002044 or c >= 0x002045 and c < 0x002052 or c >= 0x002053 and c < 0x00205f or c >= 0x002768 and c < 0x002776 or c >= 0x0027e6 and c < 0x0027f0 or c >= 0x002983 and c < 0x002999 or c >= 0x002e00 and c < 0x002e2f or c >= 0x002e30 and c < 0x002e3c or c >= 0x003008 and c < 0x003012 or c >= 0x003014 and c < 0x003020 or c >= 0x00a9c1 and c < 0x00a9ce or c >= 0x00fe10 and c < 0x00fe1a or c >= 0x00fe30 and c < 0x00fe53 or c >= 0x00fe54 and c < 0x00fe62
    end,
})
