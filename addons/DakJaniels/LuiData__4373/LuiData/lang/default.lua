...
local strings =
{
    ...
    LUIE_STRING_SKILL_UNDERDOG_DAMAGE_TP = "Damage done increased by |cFFFFFF<<1>>|r%.\n\nThis effect is influenced by the number of missing players on your team.",
    LUIE_STRING_SKILL_UNDERDOG_HEALING_TP = "Healing done increased by |cFFFFFF<<1>>|r%.\n\nThis effect is influenced by the number of missing players on your team.",
    LUIE_STRING_SKILL_SOLO_QUEUE_XP_TP = "Increases Experience gained by |cFFFFFF<<1>>|r%.",
    LUIE_STRING_SKILL_SOLO_QUEUE_AP_TP = "Increases Alliance Points gained by |cFFFFFF<<1>>|r%.",
    ...
    LUIE_STRING_SKILL_EARTHSPIKE_MANTLE_TP = "Increase your damage done and gain Major Resolve for |cFFFFFF<<1>>|r <<1[second/seconds]>>.",
    LUIE_STRING_SKILL_EARTHSHIELD_MANTLE_TP = "Increase your damage done and gain Major Resolve for |cFFFFFF<<1>>|r <<1[second/seconds]>>.\n\nA damage shield absorbs damage for |cFFFFFF6|r seconds, scaling off your Max Health.",
    LUIE_STRING_SKILL_SHATTERSPIKE_MANTLE_TP = "Increase your damage done and gain Major Resolve for |cFFFFFF<<1>>|r <<1[second/seconds]>>.\n\nBlast nearby foes with shattered obsidian, dealing Flame Damage over |cFFFFFF20|r seconds.",
