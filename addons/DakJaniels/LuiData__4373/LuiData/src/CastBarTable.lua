...
local castBarTable =
{
    ...
    IsCast =
    {
        ...
        [183123] = true, -- "Exhausting Fatecarver"
        [184291] = true, -- "Exhausting Fatecarver"
        [185805] = true, -- "Fatecarver"
        [185808] = true, -- "Fatecarver"
        [186366] = true, -- "Pragmatic Fatecarver"
        [186369] = true, -- "Pragmatic Fatecarver"
        [186370] = true, -- "Pragmatic Fatecarver"
        [186780] = true, -- "Exhausting Fatecarver"
        [189533] = true, -- "Fatecarver"
        [193331] = true, -- "Fatecarver"
        [193397] = true, -- "Exhausting Fatecarver"
        [193398] = true, -- "Pragmatic Fatecarver"
        [194842] = true, -- "Fatecarver"
        [194843] = true, -- "Fatecarver"
        [194844] = true, -- "Fatecarver Snare"
        [201265] = true, -- "Pragmatic Fatecarver"
        [201273] = true, -- "Pragmatic Fatecarver"
        [237576] = true, -- "Vengeance Fatecarver Dummy"
        [238174] = true, -- "Vengeance Fatecarver"
        [238175] = true, -- "Vengeance Fatecarver"
        [238187] = true, -- "Fatecarver"
        [238188] = true, -- "Fatecarver"
        [178454] = true, -- Remedy Cascade"
        [183537] = true, -- Remedy Cascade"
        [183539] = true, -- Remedy Cascade"
        [186193] = true, -- Cascading Fortune"
        [186200] = true, -- Curative Surge"
        [186201] = true, -- Curative Surge"
        [186203] = true, -- Curative Surge"
        [186254] = true, -- Cascading Fortune"
        [189713] = true, -- Remedy Cascade"
        [189777] = true, -- Cascading Fortune"
        [189778] = true, -- Cascading Fortune"
        [190578] = true, -- Cascading Fortune"
        [192743] = true, -- Remedy Cascade"
        [192744] = true, -- Remedy Cascade"
        [192745] = true, -- Remedy Cascade"
        [192752] = true, -- Cascading Fortune"
        [192784] = true, -- Curative Surge"
        [192785] = true, -- Curative Surge"
        [192786] = true, -- Curative Surge"
        [198309] = true, -- Remedy Cascade"
        [198330] = true, -- Cascading Fortune"
        [198537] = true, -- Curative Surge"
        [237588] = true, -- Vengeance Remedy Cascade"
        [238482] = true, -- Vengeance Remedy Cascade"
        [238483] = true, -- Vengeance Remedy Cascade"
        [238484] = true, -- Vengeance Remedy Cascade"
        [238485] = true, -- Vengeance Remedy Cascade"
        [238486] = true, -- Vengeance Remedy Cascade"
        [238487] = true, -- Vengeance Remedy Cascade"
        [247126] = true, -- Vengeance Remedy Cascade"
        [247127] = true, -- Vengeance Remedy Cascade"
        [247128] = true, -- Vengeance Remedy Cascade"
        [247129] = true, -- Vengeance Remedy Cascade"
        [247130] = true, -- Vengeance Remedy Cascade"
        [247131] = true, -- Vengeance Remedy Cascade"
        [183006] = true, -- "Cephaliarch's Flail"
        [183009] = true, -- "Cephaliarch's Flail"
        [201275] = true, -- "Cephaliarch's Flail"
        [185823] = true, -- "Tentacular Dread"
        [185826] = true, -- "Tentacular Dread"
        [186773] = true, -- "Tentacular Dread"
        [201384] = true, -- "Tentacular Dread"
        [185817] = true, -- "Abyssal Impact"
        [186772] = true, -- "Abyssal Impact"
        [192229] = true, -- "Abyssal Impact"
        [192230] = true, -- "Abyssal Impact"
        [192231] = true, -- "Abyssal Impact"
        [238189] = true, -- "Vengeance Abyssal Impact"
        [238190] = true, -- "Vengeance Abyssal Impact"
