...
-- Known Antiquity dig-spawn reference positions imported from the user-provided ScrySpy 1.44 dataset.
-- Original ScrySpy author: Sharlikran. This file contains spawn-location reference data only.

ESOProgressionCoach = ESOProgressionCoach or {}
ESOProgressionCoach.AntiquityKnownDigSpawns = {
