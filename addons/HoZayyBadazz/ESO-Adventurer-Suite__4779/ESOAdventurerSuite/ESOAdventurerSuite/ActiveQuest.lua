...
function Q:Refresh()
    if EPC.saved and self.GetQuestTrackingSource2513 and self:GetQuestTrackingSource2513() == "MAIN_QUEST" then
        ...
        local currentIndex = self.ResolveMainQuest2514 and self:ResolveMainQuest2514() or nil
        ...
        -- Keep the dedicated Main Quest memory synchronized too, so callers
        -- that read source-specific fields never see the old story quest.
