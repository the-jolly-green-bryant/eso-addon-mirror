...
local strings = {
    ...
    ROOMBA_LITEMODE            = "Active le lite mode",
    ROOMBA_LITEMODE_TOOLTIP    = "L'option activée, Roomba fera du restack automatiquement sur les objets envoyés la banque de Guilde",
