local strings = {
	...
	SI_PET_HEALTH_LAM_EXCLUDED_ZONEIDS  = "Excluded Zone IDs",
	SI_PET_HEALTH_LAM_EXCLUDED_ZONEIDS_TT = "These zone Ids will show the pets (e.g. in the veteran Maelstrom Arena)",
	SI_PET_HEALTH_LAM_RELOADUI_WARNING 	= "Changing This Will Reload The UI"
}
