...
L.CastBar_AlphaTip = 'Set how opaque the cast bar is when not in combat. A setting of 0 makes the bar totally invisible.'
L.CastBar_CAlphaTip = 'Set how opaque the cast bar is when in combat. A setting of 0 makes the bar totally invisible.'
...
-- ------------------------
L.DisplayFrame_Alpha = 'Non-Combat Transparency'
L.DisplayFrame_AlphaTip = 'Set how opaque this aura window is when not in combat. A setting of 0 makes the window totally invisible.'
L.DisplayFrame_CAlpha = 'In-Combat Transparency'
L.DisplayFrame_CAlphaTip = 'Set how opaque this aura window is when in combat. A setting of 0 makes the window totally invisible.'
