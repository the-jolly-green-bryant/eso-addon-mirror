...
VEQ.mylanguage = {
	...
	["lang_veq_settings"] = "Vestige的史诗任务（VEQ）",
	...
	["lang_intelligent_background_tip"] = "当您在移动或处于战斗中时，智能背景会淡出，否则会淡入",
	...
	["lang_timer_title_color"] = "Quest 计时器字体颜色",
	...
	["lang_quests_cyrodiil"] = "显示 Cyrodiil 任务",

	["lang_quests_class"] = "显示班级任务",
	...
	["lang_quests_raid"] = "显示突袭任务",
	["lang_quests_raid_tip"] = "切换突袭任务可见。",
	...
	["lang_quests_hide_immersive_text"] = "隐藏沉浸式文本",
	["lang_quests_hide_immersive_text_tip"] = "隐藏日志沉浸式文本。",
...
----------------------------------- NEW STUFF
	...
	["lang_tmp_VEQMessage_Error"] = "错误 <<1>>: <<2>>",
	...
	["lang_tracker_type_psijic_order"] = "赛伊克秩序",
	...
	["lang_tribute_casual"] = "致敬的随意故事",
	["lang_tribute_competitive"] = "竞技性的致敬故事",
	["lang_lfg"] = "正在寻找队友...",
	["lang_lfo"] = "正在寻找对手...",
...
-- 毒物检查器/通知器	
   ...
   -- 赛伊克时间突破助手
	["lang_psijic_time_breach"] = "赛伊克时间突破#",	
	...
	-- zone todo list
	["lang_todolist"] ="区域待办事项列表",
	
	
	-- remains silent
	["lang_remains_silent"] = "<您心领神会地颔首。>",
	...
	["lang_transmute_opt"] = "花费转化水晶迷你任务",
	["lang_transmute_tip"] = "一个小任务，当你的转化水晶达到你设置的最低限度时消耗你的转化水晶",	
	["lang_transmute_limit"] = "剩余的最小转化水晶上限触发器",
	["lang_transmute_limit_tip"] = "触发迷你任务的剩余转化水晶的最小数量",
	["lang_zoneguide_opt"] = "将下一个区域向导任务设置为迷你任务",
	["lang_zoneguide_tip"] = "区域指南迷你任务自动启用并在区域更改时成为 VEQ 中的迷你任务，如果您在该区域没有活动任务",	
    ["lang_POIcompletion_opt"] = "将未发现的区域兴趣点设置为微型任务",
	["lang_POIcompletion_tip"] = "切换区域时，一个未发现 of 区域兴趣点将成为 VEQ 中的微型任务",
	...
	["lang_goldenPursuit_opt"] = "黄金追逐微型任务",
	["lang_goldenPursuit_tip"] = "将每个黄金追逐添加为微型任务。",
["lang_displayTrackedGoldenPursuitOnly_opt"] = "仅显示已追踪的金币追踪",
	["lang_displayTrackedGoldenPursuitOnly_tip"] = "仅显示当前已追踪的金币追踪活动。",
	["lang_communityEvents_opt"] = "社区活动微型任务",
	["lang_communityEvents_tip"] = "将每个社区活动添加为微型任务。",
