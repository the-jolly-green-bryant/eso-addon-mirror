...
local function _createPALootMenu()
    ...
    PALootOptionsTable:insert({
        type = "header",
        name = PAC.COLOR.YELLOW:Colorize(GetString(SI_PA_MENU_AUTO_LOOT_HEADER))
    })

    PALootOptionsTable:insert({
        type = "checkbox",
        name = PAC.COLOR.LIGHT_BLUE:Colorize(GetString(SI_PA_MENU_AUTO_LOOT_ENABLE)),
        getFunc = PALMenuFunctions.getAutoLootEnabledSetting,
        setFunc = PALMenuFunctions.setAutoLootEnabledSetting,
        disabled = PALProfileManager.isNoProfileSelected,
        default = PALMenuDefaults.AutoLoot.autoLootEnabled,
    })
