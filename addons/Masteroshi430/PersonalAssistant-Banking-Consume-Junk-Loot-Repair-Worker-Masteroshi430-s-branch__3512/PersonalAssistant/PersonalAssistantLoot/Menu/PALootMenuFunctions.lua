...
local PALootMenuFunctions = {
    getAutoLootEnabledSetting = function() return getValue({"AutoLoot", "autoLootEnabled"}) end,
    setAutoLootEnabledSetting = function(value) setValueAndRefreshEvents(value, {"AutoLoot", "autoLootEnabled"}) end,

    getLootEventsEnabledSetting = function() return getValue({"LootEvents", "lootEventsEnabled"}) end,
    setLootEventsEnabledSetting = function(value) SetSetting(SETTING_TYPE_LOOT, LOOT_SETTING_AUTO_LOOT, "0", SETTINGS_SET_OPTION_SAVE_TO_PERSISTED_DATA) setValueAndRefreshEvents(value, {"LootEvents", "lootEventsEnabled"}) end,

    -- ----------------------------------------------------------------------------------
    -- RECIPES SETTINGS
    -- -----------------------------
    isLootRecipesMenuDisabled = function() return isDisabled({"LootEvents", "lootEventsEnabled"}) or isDisabledAll({"LootEvents", "lootEventsEnabled"}, {"LootEvents", "LootRecipes", "unknownRecipeMsg"}, {"LootEvents", "LootStyles", "autoLearnRecipe"}, {"LootEvents", "LootStyles", "autoMarkAsJunkRecipes"}) end,
    ...
    -- -----------------------------
    isLootAutoCombineMenuDisabled = function() return isDisabled({"LootEvents", "lootEventsEnabled"}) end,
