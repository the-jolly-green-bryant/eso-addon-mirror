...
PersonalAssistant.Constants = {
    ADDON = {
        ...
        VERSION_ADDON = 20260417,
        VERSION_DISPLAY = "2026.04.17",
    ...
    ICONS = {
        ...
        OTHERS = {
            ...
            KNOWN = {
                PATH = "/esoui/art/miscellaneous/check_icon_64.dds",
                NORMAL = string.format("|cCACACA%s|r", zo_iconFormatInheritColor("/esoui/art/miscellaneous/check_icon_64.dds", 32, 32)),
                SMALL = string.format("|cCACACA%s|r", zo_iconFormatInheritColor("/esoui/art/miscellaneous/check_icon_64.dds", 24, 24)),
            },
            UNKNOWN = {
                PATH = "/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds",
                NORMAL = string.format("|c66FF66%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds", 32, 32)),
                SMALL = string.format("|c66FF66%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds", 24, 24)),
            },
            OTHERUNKNOWN = {
                 PATH = "/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds",
                 NORMAL = string.format("|ffd966%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds", 32, 32)),
                 SMALL = string.format("|ffd966%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_can_learn.dds", 24, 24)),
             },
            UNCOLLECTED = {
                PATH = "/esoui/art/inventory/gamepad/gp_inventory_icon_locked_set_piece.dds",
                NORMAL = string.format("|c66ECFF%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_locked_set_piece.dds", 32, 32)),
                SMALL = string.format("|c66ECFF%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_icon_locked_set_piece.dds", 24, 24)),
            },
            NOT_RESEARCHED = {
                PATH = "/esoui/art/inventory/gamepad/gp_inventory_trait_not_researched_icon.dds",
                NORMAL = string.format("|c66ECFF%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_trait_not_researched_icon.dds", 32, 32)),
                SMALL = string.format("|c66ECFF%s|r", zo_iconFormatInheritColor("/esoui/art/inventory/gamepad/gp_inventory_trait_not_researched_icon.dds", 24, 24)), 
            },
            COMPANION = {
    ...
    BANKING_AVA = {
        ...
        OTHER = {
            ...
            68347, -- [Sigil of imperial retreat]
        }
    },
    ...
    STACKING = {
        ...
        ONESTACK = 2, -- 2: Deposit to the limit of one stack
    },
