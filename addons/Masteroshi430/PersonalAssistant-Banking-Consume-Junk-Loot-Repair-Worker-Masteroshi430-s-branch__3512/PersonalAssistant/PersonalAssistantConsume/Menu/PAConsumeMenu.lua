...
local PAConsumePotionOptionsTable = setmetatable({}, { __index = table })
...
local function _createPAConsumeMenu()
    ...
    PAConsumeOptionsTable:insert({ 
        type = "checkbox",
        name = PAC.COLOR.LIGHT_BLUE:Colorize(GetString(SI_PA_MENU_CONSUME_POISON_SMALL_STACKS_FIRST)),
		tooltip = GetString(SI_PA_MENU_CONSUME_POISON_SMALL_STACKS_FIRST_T),
        getFunc = PACOMenuFunctions.getAutoConsumePoisonSmallStacksFirstSetting,
        setFunc = PACOMenuFunctions.setAutoConsumePoisonSmallStacksFirstSetting,
        disabled = PACOProfileManager.isNoProfileSelected,
        default = PACOMenuDefaults.poisonSmallStacksFirst,
    })
    ...
    PAConsumeOptionsTable:insert({
        type = "header",
        name = PAC.COLOR.YELLOW:Colorize(GetString(SI_PA_MENU_CONSUME_POTION_HEADER))
    })

    PAConsumeOptionsTable:insert({ 
        type = "checkbox",
        name = PAC.COLOR.LIGHT_BLUE:Colorize(GetString(SI_PA_MENU_CONSUME_POTION_ENABLE)),
		tooltip = GetString(SI_PA_MENU_CONSUME_POTION_ENABLE_T),
        getFunc = PACOMenuFunctions.getAutoConsumePotionSetting,
        setFunc = PACOMenuFunctions.setAutoConsumePotionSetting,
        disabled = PACOProfileManager.isNoProfileSelected,
        default = PACOMenuDefaults.autoConsumePotionEnabled,
    })
    
    PAConsumeOptionsTable:insert({ 
        type = "checkbox",
        name = PAC.COLOR.LIGHT_BLUE:Colorize(GetString(SI_PA_MENU_CONSUME_POTION_SMALL_STACKS_FIRST)),
		tooltip = GetString(SI_PA_MENU_CONSUME_POTION_SMALL_STACKS_FIRST_T),
        getFunc = PACOMenuFunctions.getAutoConsumePotionSmallStacksFirstSetting,
        setFunc = PACOMenuFunctions.setAutoConsumePotionSmallStacksFirstSetting,
        disabled = PACOProfileManager.isNoProfileSelected,
        default = PACOMenuDefaults.potionSmallStacksFirst,
    })
