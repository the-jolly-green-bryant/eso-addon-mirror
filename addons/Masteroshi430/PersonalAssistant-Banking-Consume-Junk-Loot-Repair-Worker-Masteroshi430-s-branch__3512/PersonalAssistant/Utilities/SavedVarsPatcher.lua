...
local function _applyPatch_2026_04_20(savedVarsVersion, _, patchPAB, _, _, _, _)
    if patchPAB and PA.Banking then
        local PASavedVars = PA.SavedVars
        for profileNo = 1, 42 do
            if PASavedVars.Banking[profileNo] then
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_JEWELRYCRAFTING_SKETCH_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_JEWELRYCRAFTING_SKETCH_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_DRINK] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_DRINK] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_FOOD] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_STANDARD_FOOD] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING] = nil
                end
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][29] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][29] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_PRIMARY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_PRIMARY] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_SECONDARY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_SECONDARY] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_TERTIARY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY_SCRIPT_TERTIARY] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][SPECIALIZED_ITEMTYPE_CRAFTED_ABILITY] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][ITEMTYPE_CRAFTED_ABILITY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableItemTypes"][ITEMTYPE_CRAFTED_ABILITY] = nil
                end
                
                if PASavedVars.Banking[profileNo]["Advanced"]["LearnableSpecializedItemTypes"][ITEMTYPE_CRAFTED_ABILITY] ~= nil then
                    PASavedVars.Banking[profileNo]["Advanced"]["LearnableSpecializedItemTypes"][ITEMTYPE_CRAFTED_ABILITY] = nil
                end
