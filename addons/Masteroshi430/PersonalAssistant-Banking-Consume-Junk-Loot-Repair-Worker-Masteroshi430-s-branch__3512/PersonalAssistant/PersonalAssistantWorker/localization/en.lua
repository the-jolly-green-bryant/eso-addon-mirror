...
local PAWStrings = {
	...
	SI_PA_MENU_WORKER_METICULOUS_ENABLE_T = "Prevents Deconstructing/Refining if Meticulous Disassembly isn't maxed",
	...
	SI_PA_CHAT_ALREADY_GOT_ITEM_WITH_TRAIT = "Another %s already has %s researchable trait so we will deconstruct that one",
	...
	SI_PA_CHAT_CRAFTING_QUEST = "Auto deconstruct/refine/research was blocked because you have an ongoing %s quest",
