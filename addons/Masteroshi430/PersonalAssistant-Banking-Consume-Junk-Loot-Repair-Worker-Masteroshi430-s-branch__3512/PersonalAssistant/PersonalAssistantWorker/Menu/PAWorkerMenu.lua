...
local function insertTheseResearchTraitSettings(craftingSkill, Submenu)
  local craftingSkillName = KillTheRubbish(GetString("SI_TRADESKILLTYPE", craftingSkill))
	...
	for i=1, numResearchLines do
		...
		for t=1, numTraits do
			...
			local traitName = KillTheRubbish(GetString("SI_ITEMTRAITTYPE",traitType))
...
local function toggleAllResearchTraitSettings(craftingSkill, value)
  local craftingSkillName = KillTheRubbish(GetString("SI_TRADESKILLTYPE", craftingSkill))
	...
	for i=1, numResearchLines do
      ...
      table.insert(formatedValue, traitName) 
			...
			PAWMenuFunctions.setTraitSetting(value,formatedValue)
...
local function _createPAWBlacksmithingResearchTraitSubMenu()
		    PAWBlacksmithingResearchTraitSubMenu:insert({
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_ON),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_BLACKSMITHING, true) end,
        width = "half",
			})
      
		    PAWBlacksmithingResearchTraitSubMenu:insert({
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_OFF),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_BLACKSMITHING, false) end,
        width = "half",
			})
...
local function _createPAWClothingResearchTraitSubMenu() 
		    PAWClothingResearchTraitSubMenu:insert({
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_ON),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_CLOTHIER, true) end,
        width = "half",
			})
        ...
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_OFF),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_CLOTHIER, false) end,
        width = "half",
			})
...
local function _createPAWWoodworkingResearchTraitSubMenu() 
		    PAWWoodworkingResearchTraitSubMenu:insert({
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_ON),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_WOODWORKING, true) end,
        width = "half",
			})
        ...
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_OFF),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_WOODWORKING, false) end,
        width = "half",
			})
...
local function _createPAWJewelryResearchTraitSubMenu() 
		    PAWJewelryResearchTraitSubMenu:insert({
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_ON),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_JEWELRYCRAFTING, true) end,
        width = "half",
			})
        ...
        type = "button",
        name = GetString(SI_BUFFS_OPTIONS_ALL_ENABLED).." "..GetString(SI_CHECK_BUTTON_OFF),
        func = function() toggleAllResearchTraitSettings(CRAFTING_TYPE_JEWELRYCRAFTING, false) end,
        width = "half",
			})
