local PAIStrings = {
    ...
    -- Character Knowledge --
    SI_PA_MENU_INTEGRATION_CK_CHARACTER = "Als gelernt ansehen wenn gelernt von",
    SI_PA_MENU_INTEGRATION_CK_ENABLE = "Character Knowledge Integration aktivieren",
    SI_PA_MENU_INTEGRATION_CK_ENABLE_T = table.concat({"Character Knowledge benutzen um zu bestimmen ob ein ", GetString("SI_ITEMTYPE", ITEMTYPE_RECIPE), " oder ", GetString("SI_ITEMTYPE", ITEMTYPE_RACIAL_STYLE_MOTIF), " gelernt wurde"}),
    SI_PA_MENU_INTEGRATION_CK_INITIALIZING = "Character Knowledge wird initialisiert ...",
