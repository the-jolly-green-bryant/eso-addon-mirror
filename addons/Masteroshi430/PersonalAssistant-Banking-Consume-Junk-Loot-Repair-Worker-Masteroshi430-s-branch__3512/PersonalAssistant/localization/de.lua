...
local PAStrings = {
    ...
    SI_PA_ITEMTYPE47 = "<<1[Allianz-Kriegs-Reparaturset/Allianz-Kriegs-Reparatursets]>>",
    ...
    SI_PA_ST_MOVE_ONE_STACK_ONLY = "Auf einen Stapel pro Gegenstand begrenzen",
