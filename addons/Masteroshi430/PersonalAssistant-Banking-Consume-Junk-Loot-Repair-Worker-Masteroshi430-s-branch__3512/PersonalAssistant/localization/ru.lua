...
local PAStrings = {
    ...
    SI_PA_ITEMTYPE10 = "<<1[Ингредиент/Ингредиенты]>>", -- ITEMTYPE_INGREDIENT
    ...
    SI_PA_ITEMTYPE22 = "<<1[Отмычка/Отмычки]>>", -- Lockpicks
    ...
    SI_PA_ITEMTYPE47 = "<<1[Ремонтный набор войны альянсов/Ремонтные наборы войны альянсов]>>",
    ...
    SI_PA_REL_TEXT_OPERATOR4 = "более чем",-- not used so far
    ...
    SI_PA_ST_MOVE_ONE_STACK_ONLY = "Ограничить одним стаком на предмет", -- 2: Deposit to the limit of one stack

    -- -----------------------------------------------------------------------------------------------------------------
    -- Icon Positions --
    SI_PA_POSITION_AUTO = "Автоматически",
    SI_PA_POSITION_MANUAL = "Вручную",
