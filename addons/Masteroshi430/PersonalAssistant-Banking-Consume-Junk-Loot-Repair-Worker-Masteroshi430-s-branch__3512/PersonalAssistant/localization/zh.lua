...
local PAStrings = {
    ...
    -- -----------------------------------------------------------------------------------------------------------------
    -- Rules Menu --
    SI_PA_MENU_RULES_HOW_TO_ADD_PAB = "右键点击物品并选择:\n> PA Banking > 添加新规则，创建相关存取规则",
    SI_PA_MENU_RULES_HOW_TO_ADD_PAJ = "右键点击物品并选择:\n> PA Junk > 标记为永久垃圾，创建垃圾规则",
    ...
    SI_PA_CHAT_GENERAL_SELECTED_PROFILE_DELETED = table.concat({"选定的配置文件", PAC.COLOR.WHITE:Colorize("%s"), "被", PAC.COLOR.ORANGE_RED:Colorize("删除")}),
    ...
    SI_PA_ITEMTYPE22 = "<<1[撬锁/撬锁]>>", -- Lockpicks
    ...
    SI_PA_REL_TEXT_OPERATOR4 = "多于",-- not used so far
    ...
    SI_PA_ST_MOVE_ONE_STACK_ONLY = "限制每种物品一个堆叠", -- 2: Deposit to the limit of one stack
