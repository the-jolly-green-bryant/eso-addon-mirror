...
local PAStrings = {
    ...
    SI_PA_CHAT_GENERAL_TELEPORT_NO_PRIMARY_HOUSE = table.concat({"Vous devez d'abord sélectionner une maison en tant que votre ", PAC.COLOR.ORANGE_RED:Colorize("Résidence principale")}),
    SI_PA_CHAT_GENERAL_TELEPORT_ZONE_PREVENTED = table.concat({"Votre emplacement actuel ne ", PAC.COLOR.ORANGE_RED:Colorize("permet pas"), " le voyage rapide vers votre maison"}),
    ...
    SI_PA_NS_BAG_SUBSCRIBER_BANK = "Banque ESO Plus",
    ...
    SI_PA_ITEMTYPE47 = "<<1[Nécessaire de réparation d'AvA/Nécessaires de réparation d'AvA]>>",
    ...
    SI_PA_MENU_BANKING_ADVANCED_ORNATE_ITEMS = "Objets Ornés",
    ...
    SI_PA_ST_MOVE_ONE_STACK_ONLY = "Limiter à une pile par objet",
    ...
    SI_BINDING_NAME_PA_TRAVEL_TO_HOUSE = "Voyager vers la Résidence principale",
