...
local PAJStrings = {
    ...
    SI_PA_MENU_JUNK_AUTO_LAUNDER_REPAIR_KITS = "¿Blanqueo automático de equipos de reparación?",
    ...
    SI_PA_CHAT_JUNK_AUTO_LAUNDERED = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Blanqueado"), " %d x %s (Precio pagado: %s)"}),
