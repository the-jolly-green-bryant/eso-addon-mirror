-- Translated by: Cisneros / Modded/Completed
...
local PAJStrings = {
    ...
    SI_PA_MENU_JUNK_ACTION_STOLEN_PLACEHOLDER = "Marquer automatiquement les objets volés de type [%s]",
    ...
    -- Auto-Sell --
    SI_PA_MENU_JUNK_AUTO_SELL_JUNK_HEADER = "Vendre automatiquement les rebuts",
	
	-- Auto-Launder --
    SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER = "Blanchiment automatique",
	SI_PA_MENU_JUNK_AUTO_LAUNDER = "Blanchiment automatique chez les receleurs ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_LOCKPICKS = "Blanchir automatiquement les crochets ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_INGREDIENTS = "Blanchir automatiquement les ingrédients de cuisine ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_MATERIALS = "Blanchir automatiquement les matériaux et matières premières ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_CRAFTING_BOOSTERS = "Blanchir automatiquement les améliorants d'artisanat ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_ENCHANTING_RUNES = "Blanchir automatiquement les runes d'enchantement ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_GLYPHS = "Blanchir automatiquement les glyphes ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_FURNISHING = "Blanchir automatiquement les meubles ?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_SOULGEMS = "Blanchir automatiquement les pierres d'âme ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURES = "Blanchir automatiquement les trésors ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURE_MAPS = "Blanchir automatiquement les cartes au trésor ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_RECIPES = "Blanchir automatiquement les recettes et plans de mobilier ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_MOTIFS = "Blanchir automatiquement les motifs ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_EDICTS = "Blanchir automatiquement les décrets ?",
	SI_PA_MENU_JUNK_AUTO_LAUNDER_CONTAINERS = "Blanchir automatiquement les conteneurs ?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_REPAIR_KITS = "Blanchir automatiquement les kits de réparation ?",

    -- Auto-Destroy --
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_HEADER = "Détruire automatiquement les rebuts", 
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK = "Activer la destruction automatique des rebuts",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_T = "Lorsque vous ramassez un objet qui devrait être marqué comme rebut, s'il a une valeur de vente (Marchand) et que sa qualité est inférieure ou égale à celle sélectionnée, il sera détruit. Cette action est irréversible !",
    ...
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_JUNK_HEADER = "Rebuts",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_MAX_VALUE_THRESHOLD = "SI la valeur de vente chez le marchand est inférieure ou égale à :",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_MAX_VALUE_THRESHOLD_T = "Détruit automatiquement l'objet uniquement si sa valeur de vente chez le marchand est inférieure ou égale à la valeur sélectionnée. Cette action est irréversible !",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_MAX_QUALITY_THRESHOLD = "ET la qualité de l'objet est inférieure ou égale à :",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_MAX_QUALITY_THRESHOLD_T = "Détruit automatiquement l'objet uniquement si sa qualité est inférieure ou égale à la qualité sélectionnée. Cette action est irréversible !",
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_EXCLUSION_DISCLAIMER = "Exception : tout objet 'inconnu' (recettes, motifs, pages de style, traits...) ne sera jamais détruit automatiquement, même s'il remplit les critères de valeur et de qualité.",

    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_JUNK_HEADER = "Rebuts volés",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK = "Activer la destruction automatique des rebuts volés",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_T = "Lorsque vous volez un objet qui devrait être marqué comme rebut, s'il a une valeur de revente (Receleur) et que sa qualité est inférieure ou égale à celle sélectionnée, il sera détruit. Cette action est irréversible !",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_VALUE_THRESHOLD = "SI la valeur de recel est inférieure ou égale à :",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_VALUE_THRESHOLD_T = "Détruit automatiquement l'objet volé uniquement si sa valeur de recel est inférieure ou égale à la valeur sélectionnée. Cette action est irréversible !",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_QUALITY_THRESHOLD = "ET la qualité de l'objet volé est inférieure ou égale à :",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_QUALITY_THRESHOLD_T = "Détruit automatiquement l'objet volé uniquement si sa qualité est inférieure ou égale à la qualité sélectionnée. Cette action est irréversible !",
    ...
    SI_PA_MENU_JUNK_KEYBINDINGS_MARK_UNMARK_PERM_JUNK_ENABLE = "Activer le raccourci \"Mettre aux / Sortir des rebuts perm.\"",
    SI_PA_MENU_JUNK_KEYBINDINGS_MARK_UNMARK_PERM_JUNK_SHOW = "Afficher le raccourci \"Mettre aux / Sortir des rebuts perm.\"",
    ...
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE = table.concat({"Marquer les %s [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "]"}), 
    SI_PA_MENU_JUNK_AUTOMARK_INTRICATE_T = table.concat({"Marquer automatiquement comme rebuts les %s avec le trait [", GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE), "] (inspiration accrue) ?"}), 
    ...
    SI_PA_CHAT_JUNK_MARKED_AS_JUNK_INTRICATE = table.concat({"%s mis aux rebuts (", PAC.COLOR.ORANGE:Colorize(GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE)), ")"}),
    ...
    SI_PA_CHAT_JUNK_DESTROYED_CRITERIA_MATCH = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Détruit"), " %d x %s (Valeur de vente : %s)"}),
    SI_PA_CHAT_JUNK_AUTO_LAUNDERED = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Blanchi"), " %d x %s (Coût : %s)"}),
    ...
    SI_PA_CHAT_JUNK_DESTROY_STOLEN_ON = table.concat({"La destruction automatique des rebuts volés a été changée en ", PAC.COLOR.RED:Colorize("OUI")}),
    SI_PA_CHAT_JUNK_DESTROY_STOLEN_OFF = table.concat({"La destruction automatique des rebuts volés a été changée en ", PAC.COLOR.GREEN:Colorize("NON")}),
    ...
    SI_BINDING_NAME_PA_JUNK_PERMANENT_TOGGLE_ITEM = "Mettre aux / Sortir des rebuts permanents",
    SI_BINDING_NAME_PA_JUNK_DESTROY_ITEM = "Détruire l'objet", 

    -- Actual keybindings --
    SI_PA_ITEM_ACTION_MARK_AS_PERM_JUNK = "Mettre aux rebuts perm.",
    SI_PA_ITEM_ACTION_UNMARK_AS_PERM_JUNK = "Sortir des rebuts perm.",
