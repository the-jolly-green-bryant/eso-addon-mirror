-- Translated by: Silent_Gamer / Completed & Fixed
...
local PAJStrings = {
    ...
    -- Auto-Sell --
    SI_PA_MENU_JUNK_AUTO_SELL_JUNK_HEADER = "Автоматическая продажа хлама",

    -- Auto-Launder (Automatikus tisztára mosás) --
    SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER = "Автоматическое отмывание", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER = "Автоматически отмывать краденое у скупщика?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_LOCKPICKS = "Отмывать отмычки?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_INGREDIENTS = "Отмывать ингредиенты для снабжения?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_MATERIALS = "Отмывать ремесленные материалы?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_CRAFTING_BOOSTERS = "Отмывать улучшители ремесла?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_ENCHANTING_RUNES = "Отмывать рунные камни?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_GLYPHS = "Отмывать глифы?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_FURNISHING = "Отмывать предметы обстановки?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_SOULGEMS = "Отмывать камни душ?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURES = "Отмывать сокровища?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURE_MAPS = "Отмывать карты сокровищ?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_RECIPES = "Отмывать рецепты и чертежи?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_MOTIFS = "Отмывать мотивы?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_EDICTS = "Отмывать помилования?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_CONTAINERS = "Отмывать контейнеры?", 
    SI_PA_MENU_JUNK_AUTO_LAUNDER_REPAIR_KITS = "Отмывать ремкомплекты?",
    ...
    SI_PA_CHAT_JUNK_MARKED_AS_JUNK_INTRICATE = table.concat({"Отправили %s в хлам (", PAC.COLOR.ORANGE:Colorize(GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE)), ")"}),
    ...
    SI_PA_CHAT_JUNK_AUTO_LAUNDERED = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Отмыто"), " %d x %s (Оплачено пошлины: %s)"}),
    ...
    SI_PA_TREASURE_ITEM_TAG_DESC_SCRIVENER = "Письменные принадлежности",
    ...
    -- OTHERS: Not yet used
    SI_PA_TREASURE_ITEM_TAG_DESC_INSTRUMENTS = "Музыкальные инструменты", 
