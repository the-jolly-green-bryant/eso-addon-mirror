...
local PAJStrings = {
    ...
    -- Auto-Launder (Added & Translated) --
    SI_PA_MENU_JUNK_AUTO_LAUNDER_HEADER = "Automatisches Schmuggeln",
    SI_PA_MENU_JUNK_AUTO_LAUNDER = "Automatisch bei Hehlern schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_LOCKPICKS = "Dietriche automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_INGREDIENTS = "Versorger-Zutaten automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_MATERIALS = "Materialien & Rohmaterialien automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_CRAFTING_BOOSTERS = "Handwerks-Härter/Harze/Gerbstoffe automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_ENCHANTING_RUNES = "Runensteine automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_GLYPHS = "Glyphen automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_FURNISHING = "Einrichtungsgegenstände automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_SOULGEMS = "Seelensteine automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURES = "Beutegegenstände automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_TREASURE_MAPS = "Schatzkarten automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_RECIPES = "Rezepte & Einrichtungspläne automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_MOTIFS = "Stile & Stilbücher automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_EDICTS = "Erlasse automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_CONTAINERS = "Behälter automatisch schmuggeln?",
    SI_PA_MENU_JUNK_AUTO_LAUNDER_REPAIR_KITS = "Reparaturkits automatisch schmuggeln?",
    ...
    SI_PA_MENU_JUNK_AUTO_DESTROY_JUNK_JUNK_HEADER = "Trödel",
    ...
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_JUNK_HEADER = "Gestohlener Trödel",
    ...
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_VALUE_THRESHOLD = "WENN Hehler-Verkaufspreis genau auf oder unter [...] liegt",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_VALUE_THRESHOLD_T = "Nur gestohlene Gegenstände deren Verkaufswert auf oder unter dem eingegeben Schwellenwert liegen werden automatisch zerstört. Wenn ein Gegenstand einmal zerstört ist, kann dies nicht mehr rückgängig gemacht werden!",
    SI_PA_MENU_JUNK_AUTO_DESTROY_STOLEN_JUNK_MAX_QUALITY_THRESHOLD = "UND die Qualität von gestohlenen Gegenständen genau auf oder unter [...] liegt",
    ...
    SI_PA_CHAT_JUNK_MARKED_AS_JUNK_INTRICATE = table.concat({"%s als Trödel markiert (", PAC.COLOR.ORANGE:Colorize(GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_ARMOR_INTRICATE)), ")"}),
    ...
    SI_PA_CHAT_JUNK_AUTO_LAUNDERED = table.concat({PAC.COLOR.ORANGE_RED:Colorize("Geschmuggelt"), " %d x %s (Bezahlter Preis: %s)"}),
