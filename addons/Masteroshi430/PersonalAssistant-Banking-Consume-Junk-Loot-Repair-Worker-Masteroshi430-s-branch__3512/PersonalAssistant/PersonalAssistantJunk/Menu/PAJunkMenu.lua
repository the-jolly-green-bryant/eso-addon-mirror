...
local function _createPAJAutoLaunderSubMenu() 
	...
	PAJAutoLaunderSubMenu:insert({
        type = "checkbox",
        name = GetString(SI_PA_MENU_JUNK_AUTO_LAUNDER_REPAIR_KITS),
        getFunc = PAJMenuFunctions.getAutoLaunderRepairKitsSetting,
        setFunc = PAJMenuFunctions.setAutoLaunderRepairKitsSetting,
        disabled = PAJMenuFunctions.isAutoLaunderRepairKitsDisabled,
        default = PAJMenuDefaults.AutoLaunder.autoLaunderRepairKits,
    })
