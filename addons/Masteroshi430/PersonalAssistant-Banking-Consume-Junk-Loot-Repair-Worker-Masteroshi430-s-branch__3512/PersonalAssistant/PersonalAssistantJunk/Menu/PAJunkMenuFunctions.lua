...
local PAJunkMenuFunctions = {
	...
	{"AutoLaunder", "autoLaunderMotifs"}, {"AutoLaunder", "autoLaunderEdicts"}, {"AutoLaunder", "autoLaunderContainers"}, {"AutoLaunder", "autoLaunderRepairKits"}) end,
    ...
    isAutoLaunderRepairKitsDisabled = function() return isDisabled({"autoLaunderEnabled"}) end,
    getAutoLaunderRepairKitsSetting = function() return getValue({"AutoLaunder", "autoLaunderRepairKits"}) end,
    setAutoLaunderRepairKitsSetting = function(value) setValueAndRefreshEvents(value, {"AutoLaunder", "autoLaunderRepairKits"}) end,
