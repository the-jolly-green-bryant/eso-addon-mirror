...
local strings = {
  ...
  QUESTMAP_MENU_TOGGLE_CLICK_OPTION_MSG = "Toggle option Right Click Options",
  QUESTMAP_MENU_TOGGLE_CLICK_OPTION_TT = "Enable or disable Right Click Options when you click a quest pin.",
  QUESTMAP_MENU_TOGGLE_CLICK_OPTION_WARN = "UI Reload Required!",
  ...
  QUESTMAP_TRIAL_PIN_COLOR = "Trial Quest Pin Color",
  QUESTMAP_TRIAL_PIN_COLOR_DESC = "Change Trial Quest Pin Color",

  QUESTMAP_TRIAL_TOOLTIP_COLOR = "Trial Quest Tooltip Color",
  QUESTMAP_TRIAL_TOOLTIP_COLOR_DESC = "Change Trial Quest Tooltip Color",
