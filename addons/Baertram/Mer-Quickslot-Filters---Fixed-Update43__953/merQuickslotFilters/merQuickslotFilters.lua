...
local function onAddOnLoaded(event, addOnName)
    ...
    local zorgShouldAddItemToList = quickslotKeyboard.ShouldAddItemToList
    local seenItems = {}

    local function preUpdateList(self)
        ZO_ClearTable(seenItems)
    end
    ZO_PreHook(quickslotKeyboard, "UpdateList", preUpdateList)
    ...
    local function quickslotDeferredInit()
        quickslotKeyboard.ShouldAddItemToList = qsShouldAddItemToList

        -- The All filter on the Quickslots tab is pretty useless, hide it.
        for _, data in ipairs(quickslotKeyboard.quickslotFilters) do
        ...
        qsInsertItemTypeFilter(quickslotKeyboard, nil, {ITEMTYPE_TROPHY},
        ...
        qsInsertItemTypeFilter(quickslotKeyboard, nil, {ITEMTYPE_SIEGE},
            "esoui/art/inventory/inventory_tabicon_siege_up.dds",
            "esoui/art/inventory/inventory_tabicon_siege_down.dds",
            "esoui/art/inventory/inventory_tabicon_siege_over.dds")

        qsInsertItemTypeFilter(quickslotKeyboard, nil, {ITEMTYPE_AVA_REPAIR},
            "esoui/art/treeicons/achievements_indexicon_alliancewar_up.dds",
            "esoui/art/treeicons/achievements_indexicon_alliancewar_down.dds",
            "esoui/art/treeicons/achievements_indexicon_alliancewar_over.dds")

        qsInsertItemTypeFilter(quickslotKeyboard,
    ...
    SecurePostHook(quickslotKeyboard, "OnDeferredInitialize", quickslotDeferredInit)
end
