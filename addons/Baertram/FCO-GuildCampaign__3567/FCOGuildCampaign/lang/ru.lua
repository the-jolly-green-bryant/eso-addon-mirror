...
local stringsRU = {
    ...
    --FCOGC_SHOW_COMPANION_MENU   = "Показать \'" .. GetString(SI_INTERACT_OPTION_COMPANION_MENU) .. "\'",
    FCOGC_TOGGLE_COMPANION      = companionKeybindBaseStr .." (последний)",
...
for companionDefId, companionCollectibleId in pairs(companionInfo) do
    ...
    if companionCollectibleId ~= nil then
        ...
        stringsRU["FCOGC_TOGGLE_COMPANION_" .. tostring(companionDefId)]     = companionKeybindBaseStr .. ": \'" .. companionNameClean .. "\'"
    end
end
