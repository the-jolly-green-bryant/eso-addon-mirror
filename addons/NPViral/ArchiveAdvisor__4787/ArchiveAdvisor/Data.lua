...
ADDON.Data.EVALUATOR = {
    ...
    [192667] = { base = 70, flagPenalties = { HA_SPECIALIST = 60 }, why = "Light Attack" }, -- Swift Gale
    ...
    [193984] = { base = 62, why = "Bleed DoT" }, -- Exsanguinate
    ...
    [200015] = { base = 12, requiresFamily = "WORLD", familyBonus = { family = "WORLD", perSlot = 10, max = 30 }, why = "Skill Damage" }, -- Archival Worldliness
    ...
    [200075] = { base = 32, flagPenalties = { HA_SPECIALIST = 22 }, why = "Light Attack" }, -- Frenzied Zeal
    ...
    [200306] = { base = 65, flagBonuses = { HA_SPECIALIST = 20 }, why = "Sustain" }, -- Bountiful Resources
    ...
    [200412] = { base = 76, why = "Ultimate + Mangle" }, -- Tomefoolery
    [200421] = { base = 28, flagBonuses = { MARTIAL = 25 }, why = "Avatar Damage" }, -- Ferocious Strikes
    ...
    [200728] = { base = 28, flagBonuses = { DOT = 10, MAGICAL = 8 }, why = "Magic DoT" }, -- Thumping Thaumaturgy
    ...
    [201435] = { base = 28, why = "Ultimate Cost" }, -- Boundless Potential
    ...
    [222413] = { base = 42, why = "Ultimate Damage" }, -- Adaptive Conqueror
