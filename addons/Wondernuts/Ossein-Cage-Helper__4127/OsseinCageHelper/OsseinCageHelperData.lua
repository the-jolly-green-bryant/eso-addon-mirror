...
OCH.data    = {
  ...
  jynorahName = string.lower(GetString(OCH_Jynorah)),
  shaperOfFleshName = string.lower(GetString(OCH_ShaperOfFlesh)),
  kazpianName = string.lower(GetString(OCH_Kazpian)),
