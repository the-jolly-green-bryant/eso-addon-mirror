...
local strings =
{
    ...
    LUIE_STRING_SKILL_INVISIBLE_TP = "Vous êtes dissimulé aux regards ennemis, tant que vous restez non détecté. En furtivité, votre prochaine attaque de dégâts directs infligera un coup critique et obtiendra des effets bonus selon le type d'attaque, tant que la cible ne vous fait pas face.\n\n- Les attaques de mêlée étourdissent le premier ennemi touché pendant |cFFFFFF2|r secondes et infligent un maximum de dégâts critiques contre les monstres.\n- Les attaques à distance gagnent |cFFFFFF50|r% de dégâts critiques contre les monstres.",
    ...
    LUIE_STRING_Skill_Gallop_TP = "Augmente la vitesse de déplacement de la monture de |cFFFFFF15|r%.",
