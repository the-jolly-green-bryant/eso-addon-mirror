...
local strings =
{
    ...
    LUIE_STRING_SKILL_INVISIBLE_TP = "Вы скрыты от вражеского взгляда, пока остаетесь незамеченным. В режиме скрытности ваша следующая атака прямым уроном нанесет критический удар и получит бонусные эффекты в зависимости от типа атаки, если цель не обращена к вам лицом.\n\n- Атаки ближнего боя оглушают первого пораженного врага на |cFFFFFF2|r секунды и наносят максимальный критический урон монстрам.\n- Атаки дальнего боя получают |cFFFFFF50|r% критического урона против монстров.",
    ...
    LUIE_STRING_Skill_Gallop_TP = "Повышает скорость передвижения верхом на |cFFFFFF15|r%.",
