...
local debugAuras =
{
    ...
    [185913] = true, -- Minor Resolve (Runic Defense bundle)
    [186490] = true, -- Minor Resolve (Runeguard of Freedom bundle)
    [183424] = true, -- Minor Resolve (Runeguard of Still Waters bundle)
    [61694] = true,  -- Major Resolve
    [183650] = true, -- Major Resolve (Fatewoven Armor bundle)
    [185909] = true, -- Major Resolve (Cruxweaver Armor bundle)
    ...
    [183049] = true, -- Major Brutality (Herald of the Tome)
    [203342] = true, -- Major Prophecy (Herald of the Tome)
    ...
    [194597] = true, -- Minor Protection (Runic Defense bundle)
    [186493] = true, -- Minor Protection (Runeguard of Freedom bundle)
    [194647] = true, -- Minor Protection (Runeguard of Still Waters bundle)
    [61722] = true,  -- Major Protection
    [61715] = true,  -- Minor Evasion
    [184933] = true, -- Minor Evasion (Apocrypha bundle)
    ...
    [183649] = true, -- Minor Breach (Fatewoven Armor bundle)
    [61743] = true,  -- Major Breach
    [191763] = true, -- Major Breach (Fate Omen's Inspiration eldritch morph bundle)
    [79717] = true,  -- Minor Vulnerability
    [185920] = true, -- Minor Vulnerability (Eldritch Horror bundle)
    [185923] = true, -- Minor Vulnerability (Uncanny Adoration bundle)
    [106754] = true, -- Major Vulnerability
    [61723] = true,  -- Minor Maim
    [183166] = true, -- Minor Maim (Apocrypha bundle)
    [183431] = true, -- Minor Maim (Runic Sunder bundle)
    ...
    [265932] = true, -- Major Brutality (Target Iron Atronach, Trial bundle)
    [265933] = true, -- Major Sorcery (Target Iron Atronach, Trial bundle)
    [265984] = true, -- Major Savagery (Target Iron Atronach, Trial bundle)
    [265985] = true, -- Major Prophecy (Target Iron Atronach, Trial bundle)
    ...
    [181606] = true, -- Elemental Catalyst (proc bundle)
    [151032] = true, -- Behemoth's Resilience (Encratis's Behemoth)
    [151033] = true, -- Behemoth's Aura (Encratis's Behemoth)
    [151034] = true, -- Behemoth's Vulnerability (Encratis's Behemoth)
    [220790] = true, -- Sliver (Slivers of the Null Arca)
    [220863] = true, -- Sliver Assault (Slivers of the Null Arca)
    [220864] = true, -- Slivers of the Null Arca (crystal proc)
    [215727] = true, -- Sunderer (set proc)
    [215726] = true, -- Overcharged (Sunderer set bundle)
    [243742] = true, -- Traumatic Burns (Incinerate)
    [257754] = true, -- Incinerate (Inferno rework bundle)
    [183049] = true, -- Major Brutality (Herald of the Tome)
    [203342] = true, -- Major Prophecy (Herald of the Tome)
    [184220] = true, -- Crux (Arcanist)
    [192742] = true, -- Runemend SlotPassive
    [196434] = true, -- Evolving Runemend SlotPassive
    [196435] = true, -- Audacious Runemend SlotPassive
    [183261] = true, -- Runemend (combat heal)
    [183489] = true, -- Runemend (combat heal)
    [186247] = true, -- Runemend (combat heal)
    [186250] = true, -- Evolving Runemend (combat heal)
    [186252] = true, -- Evolving Runemend (combat heal)
    [186191] = true, -- Audacious Runemend (combat heal)
    [186265] = true, -- Audacious Runemend (combat heal)
    [186267] = true, -- Audacious Runemend (combat heal)
    [186189] = true, -- Evolving Runemend (cast)
    [189565] = true, -- Evolving Runemend (player buff)
    [183537] = true, -- Remedy Cascade (channel)
    [178454] = true, -- Remedy Cascade (cost variant)
    [189713] = true, -- Remedy Cascade (slotted combat bundle)
    [183539] = true, -- Remedy Cascade (HoT tick)
    [186193] = true, -- Cascading Fortune (channel)
    [198330] = true, -- Cascading Fortune (cost variant)
    [189777] = true, -- Cascading Fortune (slotted combat bundle)
    [186254] = true, -- Cascading Fortune (HoT tick)
    [186200] = true, -- Curative Surge (channel)
    [198537] = true, -- Curative Surge (cost stam)
    [186201] = true, -- Curative Surge (slotted combat bundle)
    [186203] = true, -- Curative Surge (HoT tick)
    [183555] = true, -- Arcanist's Domain (ground)
    [187386] = true, -- Domain (player buff in ground)
    [186229] = true, -- Zenas' Empowering Disc (ground)
    [187387] = true, -- Zenas' Empowering Disc (player buff in ground)
    [186234] = true, -- Reconstructive Domain (ground)
    [186242] = true, -- Reconstructive Domain (player buff in ground)
    [186243] = true, -- Reconstructive Domain (HoT tick)
    [186235] = true, -- Minor Courage (Reconstructive Domain bundle)
    [186236] = true, -- Minor Endurance (Reconstructive Domain bundle)
    [186239] = true, -- Minor Fortitude (Reconstructive Domain bundle)
    [186240] = true, -- Minor Intellect (Reconstructive Domain bundle)
    [186230] = true, -- Minor Courage (Zenas' Empowering Disc bundle)
    [186231] = true, -- Minor Endurance (Zenas' Empowering Disc bundle)
    [186232] = true, -- Minor Fortitude (Zenas' Empowering Disc bundle)
    [186233] = true, -- Minor Intellect (Zenas' Empowering Disc bundle)
    [183579] = true, -- Minor Courage (Arcanist's Domain bundle)
    [183580] = true, -- Minor Endurance (Arcanist's Domain bundle)
    [185750] = true, -- Minor Fortitude (Arcanist's Domain bundle)
    [185751] = true, -- Minor Intellect (Arcanist's Domain bundle)
    [183447] = true, -- Chakram Shields (cast)
    [178456] = true, -- Chakram Shields (cost variant)
    [183449] = true, -- Chakram Shields (player buff)
    [198564] = true, -- Chakram of Destiny (cast)
    [186207] = true, -- Chakram of Destiny (combat bundle)
    [186208] = true, -- Chakram of Destiny (player shield, alternate morph track)
    [194237] = true, -- Chakram of Destiny (player shield buff)
    [186209] = true, -- Tidal Chakram (cast / slotted mag)
    [186210] = true, -- Tidal Chakram (player shield buff)
    [198567] = true, -- Tidal Chakram (cost stam)
    [178455] = true, -- Vitalizing Glyphic (cast)
    [183709] = true, -- Vitalizing Glyphic (ground)
    [183711] = true, -- Vitalizing Glyphic (ground spawn)
    [183712] = true, -- Vitalizing Glyphic (glyph pet buff)
    [184078] = true, -- Vitalizing Glyphic Init Health (pet spawn)
    [184079] = true, -- Vitalizing Glyphic (pet combat)
    [184330] = true, -- Vitalizing Glyphic (player refresh tick)
    [185757] = true, -- Vitalizing Glyphic (HoT tick)
    [201395] = true, -- Player Glyphic Battle Spirit (pet)
    [201394] = true, -- Glyphic of the Tides (cast)
    [193794] = true, -- Glyphic of the Tides (ground)
    [193796] = true, -- Glyphic of the Tides (ground spawn)
    [193797] = true, -- Glyphic of the Tides (glyph pet buff)
    [194191] = true, -- Glyphic of the Tides Init Health (pet spawn)
    [193798] = true, -- Glyphic of the Tides (pet combat)
    [193799] = true, -- Glyphic of the Tides (player refresh tick)
    [193800] = true, -- Glyphic of the Tides (HoT tick)
    [193769] = true, -- Resonating Glyphic (cast)
    [193558] = true, -- Resonating Glyphic (ground)
    [193560] = true, -- Resonating Glyphic (ground spawn)
    [193559] = true, -- Resonating Glyphic (glyph pet buff)
    [193561] = true, -- Resonating Glyphic Init Health (pet spawn)
    [194205] = true, -- Resonating Glyphic (pet combat)
    [194207] = true, -- Resonating Glyphic (player refresh tick)
    [194208] = true, -- Resonating Glyphic (HoT tick)
    [183542] = true, -- Apocryphal Gate (cast)
    [178457] = true, -- Apocryphal Gate (cost variant)
    [195167] = true, -- Apocryphal Gate (entry portal ground)
    [183543] = true, -- Apocryphal Gate (player portal anchor)
    [183546] = true, -- Apocryphal Gate (exit portal ground)
    [183544] = true, -- Apocryphal Gate (travel combat tick)
    [183547] = true, -- Apocryphal Gate (travel combat tick)
    [186220] = true, -- Passage Between Worlds (cast)
    [190394] = true, -- Passage Between Worlds (cost variant)
    [195204] = true, -- Passage Between Worlds (entry portal ground)
    [186224] = true, -- Passage Between Worlds (player portal anchor)
    [186226] = true, -- Passage Between Worlds (exit portal ground)
    [186221] = true, -- Passage Between Worlds (travel combat tick)
    [186223] = true, -- Passage Between Worlds (travel combat tick)
    [186211] = true, -- Fleet-Footed Gate (cast)
    [197856] = true, -- Fleet-Footed Gate (cost variant)
    [195190] = true, -- Fleet-Footed Gate (entry portal ground)
    [186215] = true, -- Fleet-Footed Gate (player portal anchor)
    [186217] = true, -- Fleet-Footed Gate (exit portal ground)
    [186212] = true, -- Fleet-Footed Gate (travel combat tick)
    [186214] = true, -- Fleet-Footed Gate (travel combat tick)
    [187939] = true, -- Major Expedition (Fleet-Footed Gate player buff)
    [187940] = true, -- Minor Courage (Fleet-Footed Gate sprint bundle)
    [187941] = true, -- Minor Endurance (Fleet-Footed Gate sprint bundle)
    [187942] = true, -- Minor Fortitude (Fleet-Footed Gate sprint bundle)
    [187943] = true, -- Minor Intellect (Fleet-Footed Gate sprint bundle)
    ...
    [185808] = true, -- Fatecarver (damage tick)
    [189533] = true, -- Fatecarver (channel bundle)
    [183123] = true, -- Exhausting Fatecarver (area)
    [184291] = true, -- Exhausting Fatecarver
    [186369] = true, -- Pragmatic Fatecarver
    [186370] = true, -- Pragmatic Fatecarver (area)
    [186780] = true, -- Exhausting Fatecarver
    [194842] = true, -- Fatecarver
    [194843] = true, -- Fatecarver (area)
    [194844] = true, -- Fatecarver Snare
    [178441] = true, -- Fatecarver Dummy
    [201265] = true, -- Pragmatic Fatecarver
    [201273] = true, -- Pragmatic Fatecarver
    [188658] = true, -- Runeblades
    [190569] = true, -- Runeblades
    [190570] = true, -- Runeblades
    [185817] = true, -- Abyssal Impact (magicka)
    [185818] = true, -- Abyssal Ink
    [186772] = true, -- Abyssal Impact (combat)
    [192229] = true, -- Abyssal Impact
    [192230] = true, -- Abyssal Impact
    [192231] = true, -- Abyssal Impact
    [183006] = true, -- Cephaliarch's Flail
    [183008] = true, -- Abyssal Ink (Cephaliarch's Flail target)
    [183009] = true, -- Cephaliarch's Flail (status bundle)
    [201275] = true, -- Cephaliarch's Flail (heal tick)
    [185823] = true, -- Tentacular Dread
    [185826] = true, -- Tentacular Dread (combat)
    [186773] = true, -- Tentacular Dread (combat)
    [201384] = true, -- Tentacular Dread (combat)
    [186430] = true, -- Writhing Runeblades (player)
    [188787] = true, -- Writhing Runeblades (blade hit)
    [185804] = true, -- Writhing Runeblades (blade hit)
    [188186] = true, -- Writhing Runeblades (blade hit)
    [203350] = true, -- Escalating Runeblades (player)
    [188780] = true, -- Escalating Runeblades (blade hit)
    [182978] = true, -- Escalating Runeblades (blade hit)
    [193751] = true, -- Escalating Runeblades (blade hit)
    [182979] = true, -- Escalating Runeblades (blade hit)
    [185842] = true, -- Inspired Scholarship (player buff)
    [185843] = true, -- Inspired Scholarship (damage tick)
    [183165] = true, -- Runic Jolt (cast)
    [199696] = true, -- Runic Jolt (slotted combat bundle)

    -- Runic Embrace
    [186531] = true, -- Runic Embrace (cast)
    [188112] = true, -- Runic Embrace (heal tick)
    [186532] = true, -- Minor Maim (Runic Embrace bundle)
    [187757] = true, -- Minor Lifesteal (Runic Embrace bundle)

    -- Runic Sunder
    [183430] = true, -- Runic Sunder (cast)
    [187742] = true, -- Runic Sunder (target debuff)
    [187741] = true, -- Runic Sunder (player/group buff)

    -- Soldier of Apocrypha (defensive runes)
    [185894] = true, -- Runespite Ward (player buff)
    [185901] = true, -- Spiteward of the Lucid Mind (cast morph)
    [185903] = true, -- Spiteward of the Lucid Mind (cast)
    [187543] = true, -- Spiteward of the Lucid Mind (Crux heal)
    [188512] = true, -- Spiteward of the Lucid Mind (power restore)
    [190583] = true, -- Hideous Clarity (power restore)
    [190584] = true, -- Hideous Clarity (power restore)
    [183241] = true, -- Impervious Runeward (cast)
    [184362] = true, -- Impervious Runeward (player/group buff)
    [183244] = true, -- Impervious Runeward (combat bundle)
    [196128] = true, -- Impervious Runeward (Crux heal)
    [197967] = true, -- Impervious Runeward (short combat tick)
    [185895] = true, -- Runespite Ward (combat bundle)
    [192297] = true, -- Runespite Ward (Crux heal)
    [185897] = true, -- Runespite Ward (retaliate hit on attacker)
    [183648] = true, -- Fatewoven Armor
    [186477] = true, -- Unbreakable Fate (player buff)
    [186480] = true, -- Unbreakable Fate (cost variant)
    [186478] = true, -- Major Resolve (Unbreakable Fate bundle)
    [185908] = true, -- Cruxweaver Armor
    [183676] = true, -- Gibbering Shield (cast / player buff)
    [192380] = true, -- Gibbering Shelter (player buff)
    [192382] = true, -- Gibbering Shelter (cost variant)
    [192383] = true, -- Gibbering Shelter (cost variant)
    [185912] = true, -- Runic Defense (cast)
    [194637] = true, -- Runic Defense (player buff)
    [186489] = true, -- Runeguard of Freedom (cast)
    [186492] = true, -- Runeguard of Freedom (player/group buff)
    [183401] = true, -- Runeguard of Still Waters (cast)
    [194646] = true, -- Runeguard of Still Waters (player/group buff)
    [186832] = true, -- Runeguard of Still Waters (IMMUNE bundle)
    [185922] = true, -- Rune of Uncanny Adoration (IMMUNE bundle)
    [185918] = true, -- Rune of Eldritch Horror (target)
    [185919] = true, -- Rune of Eldritch Horror (IMMUNE bundle)
    [183267] = true, -- Rune of the Colorless Pool (target)
    [183270] = true, -- Rune of the Colorless Pool (cost variant)
    [183271] = true, -- Minor Vulnerability (Colorless Pool bundle)
    [184986] = true, -- Minor Brittle (Colorless Pool bundle)
    [185921] = true, -- Rune of Uncanny Adoration (cast morph)
    [187514] = true, -- Rune of Displacement (ground)
    [185839] = true, -- Rune of Displacement (cast mag)
    [201293] = true, -- Rune of Displacement (cast stam)
    [185841] = true, -- Rune of Displacement (target debuff)
    [185840] = true, -- Rune of Displacement (damage tick)
    [191084] = true, -- Rune of Displacement (damage tick)
    [186452] = true, -- Tome-Bearer's Inspiration (player buff)
    [186453] = true, -- Tome-Bearer's Inspiration (damage tick)
    [191761] = true, -- Fate Omen's Inspiration (eldritch morph)
    [191765] = true, -- Fate Omen's Inspiration (berserk morph)
    [191762] = true, -- Apocrypha Waves (combat bundle)
    [192937] = true, -- Shields of Erudition (cast)
    [192939] = true, -- Shields of Erudition (player ally shield)
    [192941] = true, -- Shields of Erudition (companion ally shield)
    [153467] = true, -- Mending Incantation (companion cast)
    [153684] = true, -- Mending Incantation (companion heal buff)
    [153066] = true, -- Rejuvenation (slotted cast / player HoT)
    [154755] = true, -- Rejuvenation HoT on companion
    [153685] = true, -- Mystic Fortress (slotted / player shield ~6s)
    [153483] = true, -- CPN MI Area Effect 1 (companion ground)
    [153498] = true, -- CPN MI Area Effect 1 (companion ground)
    [153499] = true, -- CPN MI Area Effect 1 (companion ground)

    -- Companion UF ability track (slotted + combat track ids)
    -- Bastian Hallix class (skillLineId 174–176)
    [157016] = true, -- Unleashed Rage (slotted ult)
    [157023] = true, -- Unleashed Rage ground segment (combat log)
    [157024] = true, -- Unleashed Rage ground segment (combat log)
    [157025] = true, -- Unleashed Rage ground segment (combat log)
    [157026] = true, -- Unleashed Rage ground segment (combat log)
    [155186] = true, -- Crag Smash (slotted)
    [153687] = true, -- Fiery Flail (slotted)
    [154579] = true, -- Fiery Flail Off Balance on reticleover (combat log)
    [154923] = true, -- Scorching Strike (slotted)
    [154924] = true, -- Scorching Strike DOT on reticleover (combat log)
    [155268] = true, -- Drake's Blood (slotted)
    [155271] = true, -- Drake's Blood mitigation on companion (combat log)
    [153812] = true, -- Crushing Claws (slotted)
    [153813] = true, -- Crushing Claws root on reticleover (combat log)
    [153839] = true, -- Blazing Grasp (slotted)
    [154925] = true, -- Kindle (slotted)
    [153851] = true, -- Basalt Barrier (slotted)
    [155355] = true, -- Searing Weapons (slotted)
    -- Mirri Elendis class (skillLineId 177–179)
    [157259] = true, -- Impeccable Shot (slotted ult)
    [157260] = true, -- Impeccable Shot channel (combat log)
    [156182] = true, -- Shadow Slash (slotted)
    [156183] = true, -- Shadow Slash Off Balance on reticleover (combat log)
    [153853] = true, -- Warp Strike (slotted)
    [153855] = true, -- Slayer's Blade (slotted)
    [157197] = true, -- Ghostly Evasion (slotted)
    [157198] = true, -- Ghostly Evasion companion buff bundle (combat log)
    [153856] = true, -- Masque of Torment (slotted)
    [153857] = true, -- Masque of Torment fear bundle on reticleover (combat log)
    [157201] = true, -- Twilight Mantle (slotted)
    [157202] = true, -- Twilight Mantle invisibility on companion (combat log)
    [157203] = true, -- Twilight Mantle CC bundle (combat log)
    [154790] = true, -- Life Absorption (slotted)
    [157287] = true, -- Blood Transfusion (slotted)
    [157207] = true, -- Life Siphon (slotted)
    -- Sharp-as-Night class (skillLineId 241–243)
    [186488] = true, -- Gore (slotted ult)
    [187903] = true, -- Gore toss damage on reticleover (combat log)
    [188098] = true, -- Gore 3s stun on reticleover (combat log)
    [186056] = true, -- Swoop (slotted)
    [186486] = true, -- Char (slotted)
    [186485] = true, -- Infest (slotted)
    [186482] = true, -- Swoop Off Balance on reticleover (combat log)
    [186526] = true, -- Infest fetcherfly DOT on reticleover (combat log)
    [186754] = true, -- Infest Minor Vulnerability bundle (combat log)
    [196046] = true, -- Infest companion fetcherfly aura (combat log)
    [187043] = true, -- Char shalk ground (combat log)
    [187040] = true, -- Char shalk damage bundle (combat log)
    [186598] = true, -- Fungal Forage (slotted)
    [187039] = true, -- Fungal Forage cast bundle on player (combat log)
    [186602] = true, -- Perennial Bloom (slotted)
    [187110] = true, -- Perennial Bloom ground (combat log)
    [196047] = true, -- Perennial Bloom companion aura (combat log)
    [187111] = true, -- Perennial Bloom heal tick (combat log)
    [186601] = true, -- Petals of the Hunter (slotted)
    [187657] = true, -- Petals of the Hunter LA heal bundle (combat log)
    [186603] = true, -- Sleetmail (slotted)
    [201198] = true, -- Sleetmail companion aura (combat log)
    [187481] = true, -- Sleetmail ally bundle on player (combat log)
    [186604] = true, -- Cold Snap (slotted / ground)
    [187362] = true, -- Cold Snap immobilize on reticleover (combat log)
    [187165] = true, -- Cold Snap frost DOT tick (combat log)
    [196048] = true, -- Cold Snap companion combat bundle (combat log)
    [186605] = true, -- Snow Squall (slotted)
    [187125] = true, -- Snow Squall HOT on companion (combat log)
    -- Isobel Veloise class (skillLineId 200–202)
    [163763] = true, -- Baneslayer (slotted ult)
    [163773] = true, -- Baneslayer finisher burst (combat log)
    [168864] = true, -- Baneslayer Trigger particle debuff on reticleover (combat log)
    [163458] = true, -- Penetrating Strikes (slotted)
    [163496] = true, -- Penetrating Strikes ally LA boon on player (combat log)
    [163491] = true, -- Penetrating Strikes channel damage (combat log)
    [163452] = true, -- Sun Brand (slotted)
    [163455] = true, -- Sun Brand flame DOT on reticleover (combat log)
    [163564] = true, -- Divine Destruction (slotted)
    [163442] = true, -- Solar Ward (slotted)
    [163583] = true, -- Solar Ward shield on companion (combat log)
    [163590] = true, -- Gallant Blitz (slotted)
    [163593] = true, -- Gallant Blitz Off Balance on reticleover (combat log)
    [163594] = true, -- Gallant Blitz charge damage (combat log)
    [163725] = true, -- Spear of Light (slotted)
    [163726] = true, -- Spear of Light knockdown on reticleover (combat log)
    [163614] = true, -- Blessed Sacrament (slotted)
    [163657] = true, -- Blessed Sacrament HOT on player (combat log)
    [163660] = true, -- Holy Ground (slotted / ground)
    [196043] = true, -- Holy Ground companion aura (combat log)
    [163662] = true, -- Holy Ground snare on reticleover (combat log)
    [163661] = true, -- Holy Ground heal tick (combat log)
    [163684] = true, -- Beam of Reproach (slotted)
    [163688] = true, -- Beam of Reproach damage (combat log)
    [163689] = true, -- Beam of Reproach HOT tick (combat log)
    [169252] = true, -- Beam of Reproach heal burst (combat log)
    [196044] = true, -- Beam of Reproach companion aura (combat log)
    -- Ember class (skillLineId 196–198)
    [164191] = true, -- Raging Storm (slotted ult)
    [164235] = true, -- Raging Storm DOT on reticleover (combat log)
    [164289] = true, -- Crystal Blast (slotted)
    [166085] = true, -- Shocking Burst (slotted / ground)
    [196045] = true, -- Shocking Burst Elemental Barricade on companion (combat log)
    [166087] = true, -- Shocking Burst nexus damage (combat log)
    [166089] = true, -- Shocking Burst initial hit (combat log)
    [164291] = true, -- Thunderous Strike (slotted)
    [165871] = true, -- Entomb (slotted)
    [169248] = true, -- Entomb self HOT on companion (combat log)
    [165906] = true, -- Entomb ice ground segment (combat log)
    [165907] = true, -- Entomb ice ground segment (combat log)
    [165908] = true, -- Entomb ice ground segment (combat log)
    [165860] = true, -- Hurricane Visage (slotted)
    [165861] = true, -- Hurricane Visage shock tick (combat log)
    [165865] = true, -- Trickster's Trap (slotted)
    [174718] = true, -- Trickster's Trap stun on reticleover (combat log)
    [166018] = true, -- Quick Fix (slotted)
    [166069] = true, -- Shared Wards (slotted)
    [169289] = true, -- Shared Wards CPN HOT on player/companion (combat log)
    [166068] = true, -- Second Wind (slotted)
    -- Tanlorin class (skillLineId 264–266); 153839 / 154925 whitelisted under Bastian
    [153842] = true, -- Blazing Grasp pull/stun bundle (combat log)
    [215042] = true, -- Extinguishing Breath (slotted)
    [215043] = true, -- Extinguishing Breath heal bundle (combat log)
    [230732] = true, -- Extinguishing Breath exhale damage (combat log)
    [230733] = true, -- Extinguishing Breath self aura on companion (combat log)
    [215048] = true, -- Igneous Armor (slotted)
    [215051] = true, -- Igneous Armor ally buff on player (combat log)
    [215052] = true, -- Igneous Armor damage shield on companion (combat log)
    [215215] = true, -- Ruinous Outburst (slotted ult)
    [214865] = true, -- Internal Conflict (slotted)
    [214866] = true, -- Internal Conflict soul DOT on reticleover (combat log)
    [214948] = true, -- Explosive Fortitude (slotted)
    [214949] = true, -- Explosive Fortitude retaliatory hit (combat log)
    [215608] = true, -- Explosive Fortitude damage bundle (combat log)
    [215001] = true, -- Shattered Spirit (slotted)
    [215036] = true, -- Shattered Spirit end burst (combat log)
    [214703] = true, -- Volcanic Arms (slotted)
    [215504] = true, -- Volcanic Arms Major Sorcery bundle (combat log)
    [215505] = true, -- Volcanic Arms Major Brutality bundle (combat log)
    [214708] = true, -- Haze of Cinders (slotted)
    [215381] = true, -- Haze of Cinders ground ash (combat log)
    [215382] = true, -- Haze of Cinders heal tick (combat log)
    [215383] = true, -- Haze of Cinders snare on enemies (combat log)
    [215229] = true, -- Ruinous Outburst wind-up on companion (combat log)
    [215216] = true, -- Ruinous Outburst damage bundle (combat log)
    [215228] = true, -- Ruinous Outburst follow-up hit (combat log)
    [221505] = true, -- Ruinous Outburst stun/knockback bundle (combat log)
    [193130] = true, -- Scathing Rune (slotted)
    [191939] = true, -- Abor's Augmented Ward (slotted)
    [194266] = true, -- Fear of the Unknown (slotted)
    [193132] = true, -- Scathing Rune debuff on reticleover (combat log)
    [196187] = true, -- Minor Maim from Scathing Rune (combat log)
    [191943] = true, -- Abor's Augmented Ward combat bundle on companion
    [194267] = true, -- Fear of the Unknown debuff on reticleover
    [196367] = true, -- Fear of the Unknown combat bundle (combat log)
    [192574] = true, -- Triptych Physic (slotted)
    [192575] = true, -- Triptych Physic heal tick (combat log)
    [192576] = true, -- Triptych Physic heal tick (combat log)
    [193127] = true, -- Zone of Recuperation stand-in buff (combat log)
    [192937] = true, -- Shields of Erudition (slotted)
    [193126] = true, -- Zone of Recuperation (slotted)
    [195103] = true, -- Vigorous Tentacular Eruption (slotted ult)
    [195169] = true, -- Vigorous Tentacular Eruption damage (combat log)
    [195242] = true, -- Vigorous Major Vulnerability (combat log)
    [195176] = true, -- Vigorous gate debuff/stun on target (combat log)
    [195175] = true, -- Vigorous gate stun bundle (combat log)
    [191273] = true, -- The Triune Word (slotted)
    [191278] = true, -- The Triune Word hit bundle (combat log)
    [191279] = true, -- The Triune Word hit bundle (combat log)
    [191293] = true, -- Tendrils of the Colorless Sea (slotted)
    [191299] = true, -- Tendrils Minor Vulnerability (combat log)
    [191300] = true, -- Tendrils damage bundle (combat log)
    [191765] = true, -- Fate Omen's Inspiration (slotted)
    -- Zerith-var class (skillLineId 260–262)
    [213158] = true, -- Sepulchral Chill (slotted)
    [213166] = true, -- Dark Moon Totem (slotted)
    ...
    [155328] = true, -- On Guard (1H+Shield companion)
    [213160] = true, -- Penance of Lorkhaj (slotted)
    [213162] = true, -- Azurah's Embrace (slotted)
    [222209] = true, -- Atoning Spirit (slotted / HOT on player)
    [213157] = true, -- Varmiina's Visage (slotted)
    [216057] = true, -- Strands of the Lattice (slotted)
    [213169] = true, -- Blade of the Crossing (slotted)
    [213678] = true, -- Blade of the Crossing Crescent Slash (combat log)
    [214324] = true, -- Blade Minor Magickasteal on target (combat log)
    [221598] = true, -- Strands siphon on target
    [216103] = true, -- Strands corpse ground burst
    [213342] = true, -- Penance Minor Defile on companion
    [213633] = true, -- Azurah's Embrace heal bundle (combat log)
    [213634] = true, -- Azurah's Embrace on player
    [232079] = true, -- Sepulchral Chill self buff
    [213284] = true, -- Sepulchral Chill ground
    [232078] = true, -- Dark Moon Totem self buff
    [220229] = true, -- Dark Moon Totem ground
    [213460] = true, -- Dark Moon Totem fear (reticleover)
    [213458] = true, -- Dark Moon Totem Minor Protection (companion aura)
    [213176] = true, -- Crescent Scythe stacks
    [156219] = true, -- Bashing Bulwark block stacks
    [157235] = true, -- Provoke target debuff
    [153686] = true, -- Sniping Silver (slotted)
    [154918] = true, -- Sniping Silver channel aura on companion
    [152793] = true, -- Piercing Arrow (slotted)
    [152863] = true, -- Viper's Bite (slotted cast)
    [152864] = true, -- Viper's Bite poison on reticleover
    [152701] = true, -- Trick Shot (slotted cast)
    [154723] = true, -- Trick Shot root on reticleover
    [154926] = true, -- Ritual of Salvation (slotted)
    [154927] = true, -- Ritual of Salvation on companion
    [157747] = true, -- Biting Trap (slotted)
    [157759] = true, -- Biting Trap companion aura
    [157760] = true, -- Biting Trap root on reticleover
    [155403] = true, -- Starfall (slotted)
    [155408] = true, -- Reverse Entropy (slotted / HOT on player)
    [155411] = true, -- Parallel (slotted)
    [155515] = true, -- Crimson Font (slotted)
    [196038] = true, -- Crimson Font companion fountain aura
    [155693] = true, -- Skeletal Aegis (slotted)
    [155714] = true, -- Bone Aegis on player (synergy)
    [157240] = true, -- Savage Instinct (Undaunted slotted)
    [157242] = true, -- Savage Instinct debuff on reticleover
    [157829] = true, -- Savage Instinct taunt combat/buff id on target
    [157831] = true, -- Savage Implosion synergy debuff on reticleover
    [152433] = true, -- Staggering Swing (slotted)
    [152445] = true, -- Staggering Swing stun on reticleover
    [152446] = true, -- Staggering Swing combat bundle on target
    [152696] = true, -- Razor Cape (slotted / self buff ~8s on companion)
    [152697] = true, -- Razor Cape tick DMG on target (combat)
    [152700] = true, -- Razor Cape hit proc on companion (combat ~1s, not unit aura)
    [152629] = true, -- Swift Assault (slotted channel)
    [152693] = true, -- Spinning Steel (slotted)
    ...
    [156596] = true, -- Vanish (slotted)
    [156597] = true, -- Vanish buff on companion
    [156598] = true, -- Vanish combat bundle on companion
    [156340] = true, -- Haste (slotted)
    [156599] = true, -- Bulwark (Heavy Armor companion)
    [157728] = true, -- Flow (Light Armor passive)
    [157729] = true, -- Flexibility (Medium Armor passive)
    [157730] = true, -- Firmness (Heavy Armor passive)
    [157133] = true, -- Flame Blast (slotted)
    [157131] = true, -- Destructive Blast (base)
    [157136] = true, -- Shock Blast (splash / alt bound id)
    [157137] = true, -- Shock Blast (primary cast)
    [157140] = true, -- Elemental Barricade (base)
    [157230] = true, -- Arcane Nova (base)
    [157233] = true, -- Shock Nova (slotted)
    [157224] = true, -- Storm Barricade (alt bound / wall tick DMG)
    [157226] = true, -- Storm Barricade (slotted cast / primary ground)
    [196042] = true, -- Elemental Barricade on companion (storm)
    [157225] = true, -- Storm Barricade ground segment
    [157227] = true, -- Storm Barricade ground segment
    [157228] = true, -- Storm Barricade ground segment
    [157229] = true, -- Storm Barricade ground segment
    [157132] = true, -- Flame Blast stun on reticleover
    [157134] = true, -- Flame Blast combat bundle
    [157145] = true, -- Fire Barricade (slotted / ground)
    [196039] = true, -- Elemental Barricade on companion
    [157141] = true, -- Fire Barricade ground segment
    [157143] = true, -- Fire Barricade ground segment
    [157144] = true, -- Fire Barricade ground segment
    [157142] = true, -- Fire Barricade wall tick DMG (not ground)
    [157231] = true, -- Fire Nova (slotted); reticleover debuff 18084
    [157135] = true, -- Frost Blast (slotted)
    [159179] = true, -- Frost Blast debuff on reticleover
    [157212] = true, -- Frost Barricade (slotted / ground)
    [196041] = true, -- Elemental Barricade on companion (frost)
    [157210] = true, -- Frost Barricade ground segment
    [157211] = true, -- Frost Barricade ground segment
    [157213] = true, -- Frost Barricade ground segment
    [157232] = true, -- Frost Nova (slotted)
    [163033] = true, -- Hexos' Ward (gear proc)
    [183047] = true, -- Recuperative Treatise (player buff)
    [185825] = true, -- Abyssal Ink (Recuperative Treatise target)
    [183048] = true, -- Recuperative Treatise (damage tick)
    [184103] = true, -- Recuperative Treatise (power restore)
    [184104] = true, -- Recuperative Treatise (power restore)
    [185407] = true, -- Recuperative Treatise (damage tick)
    [187850] = true, -- Fulminating Rune (target debuff)
    [182988] = true, -- Fulminating Rune (cast mag)
    [201296] = true, -- Fulminating Rune (cast stam)
    [182989] = true, -- Fulminating Rune (damage tick)
    [184258] = true, -- Fulminating Rune (combat bundle)
    [184844] = true, -- Fated Fortune
    [184847] = true, -- Fated Fortune (rank swap)
    [194875] = true, -- Fated Fortune (timed stack)
    [184857] = true, -- Harnessed Quintessence
    [184858] = true, -- Harnessed Quintessence (rank swap)
    [184860] = true, -- Harnessed Quintessence (timed stack)
    [184870] = true, -- Psychic Lesion
    [184873] = true, -- Psychic Lesion (rank swap)
    [184885] = true, -- Splintered Secrets
    [184887] = true, -- Splintered Secrets (rank swap)
    [184918] = true, -- Aegis of the Unseen
    [184923] = true, -- Aegis of the Unseen (rank swap)
    [184930] = true, -- Circumvented Fate
    [184932] = true, -- Circumvented Fate (rank swap)
    [185033] = true, -- Wellspring of the Abyss
    [185036] = true, -- Wellspring of the Abyss (rank swap)
    [185050] = true, -- Implacable Outcome
    [185051] = true, -- Implacable Outcome (rank swap)
    [185058] = true, -- Implacable Outcome (rank swap)
    [185070] = true, -- Implacable Outcome (rank swap)
    [185836] = true, -- The Imperfect Ring
    [201286] = true, -- The Imperfect Ring (cost mag)
    [185838] = true, -- The Imperfect Ring (target DoT)
    [191077] = true, -- The Imperfect Ring (combat bundle)
    [189791] = true, -- The Unblinking Eye (ground)
    [189792] = true, -- The Unblinking Eye (player aura)
    [189793] = true, -- The Unblinking Eye (damage tick)
    [189838] = true, -- The Tide King's Gaze (ground)
    [191367] = true, -- The Tide King's Gaze (player aura)
    [189839] = true, -- The Tide King's Gaze (damage tick)
    [189837] = true, -- The Tide King's Gaze (combat bundle)
    [189867] = true, -- The Languid Eye (ground)
    [189868] = true, -- The Languid Eye (player aura)
    [189869] = true, -- The Languid Eye (damage tick)
    ...
    [259217] = true, -- The Storm Voice (bundle)
    ...
    [263208] = true, -- Wildfire Embers (target DoT)
    [263309] = true, -- Wildfire Embers (alt target id)

    -- Class Mastery passives (class_mastery.txt / CLASS_MASTERY_SKILL_MAP.csv)
    [238232] = true, -- DK Inexorable Descent (skill sheet)
    [263197] = true, -- DK Inexorable Descent (player buff aura)
    [29465] = true,  -- Landslide (player stack window with Inexorable Descent)
    [240268] = true, -- DK Booming Voice (Class Mastery skill sheet)
    [263200] = true, -- DK Booming Voice (proc carrier on leap / Storm Voice rank 2)
    [270020] = true, -- DK Booming Voice (recovery buff after proc delay)
    [259224] = true, -- DK Wildfire Embers
    [263220] = true, -- DK Resolute Defense
    [263247] = true, -- DK Lead from the Front
    [263316] = true, -- Arc Abyssal Emergence
    [263398] = true, -- Arc Fate Realigned
    ...
    [263554] = true, -- Nec Veil's Forfeit
    [263519] = true, -- Warden Tundra's Maw
    [263520] = true, -- Warden Wild Adaptation
    [263521] = true, -- Warden Glacial Obstinance
    [263522] = true, -- Warden Green-Keeper's Hide
    [263523] = true, -- Warden Bountiful Harvest
    [263585] = true, -- Temp Bastion of Light
    [263586] = true, -- Temp Devout Guardian
    [263587] = true, -- Temp Bright Harbinger
    [263588] = true, -- Temp Judgment's Brand
    [263589] = true, -- Temp Steadfast Candescence
    [263603] = true, -- NB Nocturnal Inspiration
    [263604] = true, -- NB An Eye for Exploitation
    [263605] = true, -- NB Above and Beyond
    [263606] = true, -- NB Cutthroat's Focus
    [263607] = true, -- NB Share the Spoils
    [263870] = true, -- Sorc Conservation of Energy
    [263871] = true, -- Sorc Font of Power
    [263872] = true, -- Sorc Static Reverberation
    [263873] = true, -- Sorc Calculated Defense
    [263874] = true, -- Sorc Sphere of Influence
    ...
    [257750] = true, -- Inferno (player active pulse)
    [258548] = true, -- Minor Fortitude (Inferno bundle)

    [76433] = true,  -- Major Prophecy (Cauterize)
    [32881] = true,  -- Cauterize (Cauterize)
    [76429] = true,  -- Cauterize (Cauterize)
    [257752] = true, -- Inferno (Cauterize wave pulse)
    [258618] = true, -- Minor Heroism (Cauterize bundle)
    [258619] = true, -- Minor Fortitude (Cauterize bundle)

    [76420] = true,  -- Major Prophecy (Flames of Oblivion)
    [76426] = true,  -- Major Savagery (Flames of Oblivion)
    [32853] = true,  -- Incinerate
    [243742] = true, -- Traumatic Burns (Incinerate)
    [257754] = true, -- Incinerate (Inferno rework bundle)
    [258586] = true, -- Fire Keeper (Incinerate activation pulse)
    [258585] = true, -- Minor Fortitude (Incinerate bundle)
    ...
    [48752] = true,  -- Take Flight draconic fury player buff (~15s; EFFECT_CHANGED track)
    ...
    [29126] = true,  -- Hearthfire (Minor Heroism inside-ground bundle)

    [20779] = true,  -- Fire Keeper (ground entity / slotted)
    [21435] = true,  -- Fire Keeper (slotted ground buff)
    ...
    [32711] = true,  -- Hearth and Home (ally HOT inside ground)
    [32712] = true,  -- Hearth and Home (enemy debuff inside ground)
    ...
    [219680] = true, -- Highland Sentinel
    [219681] = true, -- Sentinel's Eye (combat refresh tick)
    ...
    [138072] = true, -- Major Savagery (Roar - All Morphs; while-slotted, re-applied on form swap)
    [168425] = true, -- Major Prophecy (Roar - All Morphs; while-slotted, re-applied on form swap; display 61689)
