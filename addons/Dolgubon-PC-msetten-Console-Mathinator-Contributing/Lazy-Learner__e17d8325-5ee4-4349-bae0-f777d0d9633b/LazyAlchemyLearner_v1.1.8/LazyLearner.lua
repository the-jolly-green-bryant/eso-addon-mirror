...
local function genericSlashCommand(args)
    ...
    elseif searchResult[1] == 'both'  then 
        ...
        Utils.sendChatMessage("/lazylearn enchant --> " .. LazyLearner.L("LL_COMMANDS_ENCHANT_BASEGAME"))
        Utils.sendChatMessage("/lazylearn enchant withdlc --> " .. LazyLearner.L("LL_COMMANDS_ENCHANT_WITHDLC"))
        Utils.sendChatMessage("/lazylearn enchant withkuta --> " .. LazyLearner.L("LL_COMMANDS_ENCHANT_WITHKUTA"))
        Utils.sendChatMessage("/lazylearn enchant all --> " .. LazyLearner.L("LL_COMMANDS_ENCHANT_ALL"))
        Utils.sendChatMessage("/lazylearn both --> " .. LazyLearner.L("LL_COMMANDS_BOTH"))
        Utils.sendChatMessage("/lazylearn both all --> " .. LazyLearner.L("LL_COMMANDS_BOTH_ALL"))
