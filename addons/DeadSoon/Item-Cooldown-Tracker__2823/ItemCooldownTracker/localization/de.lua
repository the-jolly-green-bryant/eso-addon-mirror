...
ICDT.loc.settings.itemDescriptionDetailed =
		"PVP: |cd5b526Intakte Transmutationsgeode|r\nDu erhälst diese Transmutationsgeode von der PvP-Mail-Belohnung 'Gerechter Lohn'. Einmal am Tag hast du einen sicheren Drop. Bis zum nächsten täglichen Server-Reset, ist deine Chance, eine Transmutationsgeode aus der Belohnung zu erhalten, geringer.\n\n" ..
		...
		"Dragonhold: |cd5b526Schilde von Senchal Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Guybert Flaubert' oder 'Bruccius Baenius' in Senchal abschließt.\n\n" ..
		"Dragonhold: |cd5b526Drachengarde Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests der Questgeber 'Dirge Truptor' oder 'Chizbari die Hauerin' auf der Gezeiteninsel abschließt.\n\n" ..
		...
		"Greymoor: |cd5b526Schwarzweite-Vorhut Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Tinzen' oder 'Hidaver' im Westlichen Himmelsrand abschließt.\n\n" ..
		"Greymoor: |cd5b526Graumoor Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gramsturm) vom Questgeber 'Jylta' im Westlichen Himmelsrand abschließt.\n\n" ..
		"Markarth: |cd5b526Waffenkammer von Arkthzand Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die täglichen Quests (Gewölbe oder Weltenboss) der Questgeber 'Bralthahan' oder 'Gwenyfe' im Reik abschließt.\n\n" ..
		"Markarth: |cd5b526Nachttiefen Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gramsturm) vom Questgeber 'Nelldena' im Reik abschließt.\n\n" ..
		"Markarth: |cd5b526Unbezähmbare Hüter Stilseiten|r\nWenn du die Voraussetzungen erfüllt hast (Haupt-Quest Markarth), kannst du tägliche Quest vom Questgeber 'Ardanir' im Reik abschließen. Mit der Quest-Belohnung hast du die Chance, eine Stilseite zu erhalten.\n\n" ..
		"Blackwood: |cd5b526Schwarzflossen-Legion Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gewölbe) vom Questgeber 'Deetum-Jas' in Dunkelforst abschließt.\n\n" ..
		"Blackwood: |cd5b526Elfenbeinbrigade Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Britta Silanus' in Dunkelforst abschließt.\n\n" ..
		"Deadlands: |cd5b526Haus Hexos Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Gewölbe) vom Questgeber 'Luna Beriel' in Ferngrab abschließt.\n\n" ..
		"Deadlands: |cd5b526Ferngrabwächter Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Vaveli Indavel' in Ferngrab abschließt.\n\n" ..
		"Deadlands: |cd5b526Auserwählten des Annihilarchen Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, beim Öffnen der Belohnungstruhe nach dem Erlegen des Endbosses in einem Portal ('Das Atoll der Selbstaufopferung') in den Totenländern.\n\n" ..
		"High Isle: |cd5b526Liga der Standhaften Stilseiten|r\nDu hast die Chance, eine Stilseite zu erhalten, wenn du die tägliche Quest (Weltenboss) vom Questgeber 'Parisse Plouff' in Hochinsel abschließt.\n\n" ..
