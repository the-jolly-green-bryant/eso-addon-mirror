...
ExecuteNow.version = "0.3.7"
ExecuteNow.author = "mooNylo Patch: PlaceHolder"
...
-- This is if you care about character class
...
-- runs off percentage you define
function GetExecuteThreshold()
...
function ExecuteNow.CreateSettingsWindow()
  local panelData = {
	...
	author = "mooNylo - Patched by: PlaceHolder",
  ...
  local optionsData = {
    ...
    [5] = {
	  ...
	  tooltip = "What maximum hitpoints should a target have for this to function? (Set high to ignore trash mobs.)",
	  min = 0,
	  max = 50000000,
	  step = 100000,
	  default = 100000,
	  ...
	  tooltip = "What percentage health should a target have left for Execute! to display?",
	  min = 0,
	  max = 100,
	  step = 5,
	  default = 25,
	...
	[7] = {
	  type = "button",
	  name = function() return "Confirm" end,
