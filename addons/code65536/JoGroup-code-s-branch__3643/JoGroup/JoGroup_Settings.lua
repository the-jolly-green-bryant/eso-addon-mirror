...
do
	...
	function Jo.Int32ToRGBA( rgba )
		return i2c(rgba, 24), i2c(rgba, 16), i2c(rgba, 8), i2c(rgba, 0)
	end

	function Jo.RGBAToInt32( r, g, b, a )
		return c2i(r, 24) + c2i(g, 16) + c2i(b, 8) + c2i(a, 0)
	end

	function Jo.GetColorRGBA( color )
		if type(color) == "number" then
			return Jo.Int32ToRGBA(color)
	...
	function Jo.GetColorInt32( color )
		if type(color) == "number" then
			return color
		elseif type(color) == "table" then
			return Jo.RGBAToInt32(unpack(color))
		else
			return 0
		end
	end

	function Jo.GetColorInt24( color )
		return BitRShift(Jo.GetColorInt32(color), 8)
	end
end
...
function Jo.CreateSettingsWindow()
	local panelData = {
		...
		name = Jo.name,
		displayName = Jo.name,
		author = "JoyceKimberly and contributors (@Deandra, @lwndow, and @code65536)",
		version = Jo.version,
	...
	local optionsData = {
		...
		},
		{
			type = "colorpicker",
			name = "Shield colour",
			default = function() return Jo.GetColorRGBA(Jo.defaults.colours.shield) end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.shield) end,
			setFunc = function(...)
				Jo.savedVars.colours.shield = Jo.RGBAToInt32(...)
				Jo.CustomizeUnits()
			end,
		},
		{
			type = "colorpicker",
			name = "Trauma colour",
			default = function() return Jo.GetColorRGBA(Jo.defaults.colours.trauma) end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.trauma) end,
			setFunc = function(...)
				Jo.savedVars.colours.trauma = Jo.RGBAToInt32(...)
				Jo.CustomizeUnits()
			end,
		},
		{
			...
			default = function() return Jo.GetColorRGBA(Jo.defaults.colours.warHorn) end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.warHorn) end,
			setFunc = function(...)
				Jo.savedVars.colours.warHorn = Jo.RGBAToInt32(...)
				Jo.CustomizeUnits()
			end,
		},
		{
			...
			default = function() return Jo.GetColorRGBA(Jo.defaults.colours.crShade) end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.crShade) end,
			setFunc = function(...)
				Jo.savedVars.colours.crShade = Jo.RGBAToInt32(...)
				Jo.CustomizeUnits()
			end,
		},
		{
		...
		},
		{
			...
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.customTankColour) end,
			setFunc = function(...)
				Jo.savedVars.colours.customTankColour = Jo.RGBAToInt32(...)
				Jo.UpdateUnits()
			end,
		},
		{
			...
			disabled = function() return not Jo.savedVars.colours.customColour end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.customHealerColour) end,
			setFunc = function(...)
				Jo.savedVars.colours.customHealerColour = Jo.RGBAToInt32(...)
				Jo.UpdateUnits()
			end,
		},
		{
			...
			disabled = function() return not Jo.savedVars.colours.customColour end,
			getFunc = function() return Jo.GetColorRGBA(Jo.savedVars.colours.customDpsColour) end,
			setFunc = function(...)
				Jo.savedVars.colours.customDpsColour = Jo.RGBAToInt32(...)
				Jo.UpdateUnits()
			end,
		},
		{
