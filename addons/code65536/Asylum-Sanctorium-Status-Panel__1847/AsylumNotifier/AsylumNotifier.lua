...
function AsylumNotifier.IdentifyUnit( unitId, unitName )
	if (AsylumNotifier.unitIdLlothis == 0 and string.find(string.lower(unitName), "llothis")) then
		AsylumNotifier.unitIdLlothis = unitId;
		AsylumNotifier.InitializeUnit(unitId, LocalizeString("<<1>>", unitName), 1);
	elseif (AsylumNotifier.unitIdFelms == 0 and string.find(string.lower(unitName), "felms")) then
