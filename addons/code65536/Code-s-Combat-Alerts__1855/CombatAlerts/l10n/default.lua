...
Register("SI_CA_SETTINGS_CUTTHROAT_TT"          , "If the Cutthroat's Focus passive is active, this will block class abilities in a half-second window before the hit of a select few enemy abilities that have catastrophic missed-attack consequences.")
