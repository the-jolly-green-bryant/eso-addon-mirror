...
function GBP.RegisterStockConditionalEnablements( )
	...
	LCA.RegisterForFilteredEvent(name, EVENT_INVENTORY_SINGLE_SLOT_UPDATE, refresh, REGISTER_FILTER_BAG_ID, BAG_WORN, REGISTER_FILTER_INVENTORY_UPDATE_REASON, INVENTORY_UPDATE_REASON_DEFAULT)
