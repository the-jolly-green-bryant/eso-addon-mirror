...
D.companies = {
    ...
    amber={id="amber", name="琥珀帆商会", cash=42000, personality="wealth", aggression=.4, defense=.8, tacticBias="gift", acquisitionBias="port", alliances={}},
    iron={id="iron", name="鉄環輸送組合", cash=24000, personality="aggressive", aggression=.8, defense=.4, tacticBias="messenger", acquisitionBias="mine", alliances={}},
    ink={id="ink", name="銀墨帳簿会", cash=31000, personality="information", aggression=.5, defense=.6, tacticBias="rumor", acquisitionBias="books", alliances={}},
    ash={id="ash", name="灰燭契約連盟", cash=58000, personality="subversion", aggression=.7, defense=.7, tacticBias="defection", acquisitionBias="mages", alliances={}},
...
local rows = {
    ...
    {"str_hq","琥珀帆の大交易所","stormhaven","port",30000,1400,"amber",28,22,2.4,{"roads"},true},
