local strings = {
	...
	SI_PBSQTFC_POS_X = "横位置",
	SI_PBSQTFC_POS_X_TOOLTIP = "クエストトラッカーをゲーム標準の位置から左右にずらします。0でそのままです。プラスが右方向。「黄金の追跡」と「ハウス情報」はゲーム側でクエストトラッカーに接続されているため、一緒に移動し、縦の並びは保たれます。",
	SI_PBSQTFC_POS_Y = "縦位置",
	SI_PBSQTFC_POS_Y_TOOLTIP = "クエストトラッカーをゲーム標準の位置から上下にずらします。0でそのままです。プラスが下方向。",
	SI_PBSQTFC_SCALE = "表示倍率",
	SI_PBSQTFC_SCALE_TOOLTIP = "クエストトラッカー全体を拡大縮小します。文字・アイコン・キーバインド表示が比率を保ったまま変わります。100%がゲーム標準です。拡大縮小はクライアントにフォントを構築させないため、コンソールでもコストがかかりません。パネルは右上を基準に拡大縮小されます（そこがアンカー位置のため）。",
