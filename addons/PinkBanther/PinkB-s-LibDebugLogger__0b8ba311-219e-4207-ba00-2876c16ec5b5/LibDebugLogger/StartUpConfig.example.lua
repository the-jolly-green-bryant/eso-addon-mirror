...
-- how many entries the log keeps. This is the whole memory budget of the library, so raise it
-- only while you are actually hunting something down.
internal.settings.maxEntries = 1000
