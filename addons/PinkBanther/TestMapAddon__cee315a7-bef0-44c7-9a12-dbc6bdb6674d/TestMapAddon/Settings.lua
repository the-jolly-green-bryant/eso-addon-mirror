-- TESTMAPADDON is nil when Main.lua bailed out early (account not in the allow list).
if not TESTMAPADDON then
	return
end

local addon = TESTMAPADDON
...
function addon:InitMapSettings()
	...
	if type(self.account.titleFontSize) == "string" then
		TESTMAPADDON_MINIMAP_FONT = CreateFont("TESTMAPADDON_MINIMAP_FONT", "$(MEDIUM_FONT)|" .. self.account.titleFontSize)
		local _, fontSize = TESTMAPADDON_MINIMAP_FONT:GetFontInfo()
...
function addon:InitSettings()
	...
	local settings = LibHarvensAddonSettings:AddAddon("TestMapAddon 1.0.2")
	if not settings then
		return
	end
	self.settingsControls = settings
	settings.allowDefaults = true
	settings.version = "1.0.2 (base: votan's Minimap 2.2.2, edited by PinkBanther)"
	settings.website = "http://www.esoui.com/downloads/info1399-TestMapAddon.html"

	settings:AddSetting(
		{
			type = LibHarvensAddonSettings.ST_CHECKBOX,
			label = GetString(SI_TESTMAPADDON_WORLD_MAP_TWEAKS),
			tooltip = GetString(SI_TESTMAPADDON_WORLD_MAP_TWEAKS_TOOLTIP),
	...
	settings:AddSetting(
		{
			type = LibHarvensAddonSettings.ST_CHECKBOX,
			label = GetString(SI_KEYBINDINGS_CATEGORY_TESTMAPADDON),
			tooltip = GetString(SI_TESTMAPADDON_MINI_MAP_TOOLTIP),
	...
	settings:AddSetting(
		{
			...
			label = "",
			tooltip = nil,
			buttonText = GetString(SI_TESTMAPADDON_APPLY_BUTTON),
	...
	if self.account.enableMap then
		...
		settings:AddSetting(
			{
				...
				label = GetString(SI_TESTMAPADDON_ZOOM),
				tooltip = GetString(SI_TESTMAPADDON_ZOOM_TOOLTIP),
				min = 0.0,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_SUB_ZONE_ZOOM),
				tooltip = GetString(SI_TESTMAPADDON_SUB_ZONE_ZOOM_TOOLTIP),
				min = 0.0,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_DUNGEON_ZOOM),
				tooltip = GetString(SI_TESTMAPADDON_DUNGEON_ZOOM_TOOLTIP),
				min = 0.0,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_MOUNTED_ZOOM),
				tooltip = GetString(SI_TESTMAPADDON_MOUNTED_ZOOM_TOOLTIP),
				min = 0.0,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_BG_ZOOM),
				tooltip = GetString(SI_TESTMAPADDON_BG_ZOOM_TOOLTIP),
				min = 0.0,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_UNIT_PINS_MINIMUM_SIZE),
				tooltip = GetString(SI_TESTMAPADDON_UNIT_PINS_MINIMUM_SIZE_TOOLTIP),
				min = 0.65,
				max = 1,
				step = 0.01,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_MAP),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_MAP_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_HUD),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_HUD_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_LOOTING),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_LOOTING_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_MOUNTED),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_MOUNTED_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_COMBAT),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_COMBAT_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_SIEGE),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_SIEGE_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_SHOW_IN_HOUSING),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_IN_HOUSING_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_ASYNC_UPDATE),
				tooltip = GetString(SI_TESTMAPADDON_ASYNC_UPDATE_TOOLTIP),
		...
		settings:AddSetting(
			{
				...
				label = GetString(SI_TESTMAPADDON_KEYBINDINGS_ZOOM)
			}
		)
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_ZOOM_TO_PLAYER),
				tooltip = GetString(SI_TESTMAPADDON_ZOOM_TO_PLAYER_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_ZOOM_OUT),
				tooltip = GetString(SI_TESTMAPADDON_ZOOM_OUT_TOOLTIP),
				min = 0.0,
				max = 1,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_ZOOM_IN),
				tooltip = GetString(SI_TESTMAPADDON_ZOOM_IN_TOOLTIP),
				min = 1,
				max = 2,
				step = 0.05,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SECTION,
				label = GetString(SI_TESTMAPADDON_APPEARANCE)
			}
		)
		...
		local prevSetting =
			...
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_LOCK_POSITION),
				tooltip = GetString(SI_TESTMAPADDON_LOCK_POSITION_TOOLTIP),
		...
		locationSettings =
			settings:AddSettings(
			{
				{
					type = LibHarvensAddonSettings.ST_CHECKBOX,
					label = GetString(SI_TESTMAPADDON_SHOW_IN_SETTINGS),
					default = false,
					getFunction = function()
				...
				{
					type = LibHarvensAddonSettings.ST_SLIDER,
					label = GetString(SI_TESTMAPADDON_GRID_X),
					tooltip = GetString(SI_TESTMAPADDON_GRID_TOOLTIP),
					default = 0,
					min = -100000,
					max = 100000,
					step = 1,
				...
				{
					type = LibHarvensAddonSettings.ST_SLIDER,
					label = GetString(SI_TESTMAPADDON_GRID_Y),
					tooltip = GetString(SI_TESTMAPADDON_GRID_TOOLTIP),
					default = 0,
					min = -100000,
					max = 100000,
				...
				{
					type = LibHarvensAddonSettings.ST_SLIDER,
					label = GetString(SI_TESTMAPADDON_GRID_W),
					tooltip = GetString(SI_TESTMAPADDON_GRID_TOOLTIP),
					default = 304 / 8,
					min = 14,
					max = 100000,
				...
				{
					type = LibHarvensAddonSettings.ST_SLIDER,
					label = GetString(SI_TESTMAPADDON_GRID_H),
					tooltip = GetString(SI_TESTMAPADDON_GRID_TOOLTIP),
					default = 304 / 8,
					min = 14,
					max = 100000,
		...
		settings:AddSetting(
			{
				...
				label = GetString(SI_TESTMAPADDON_BORDER_STYLE),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = GetString(SI_TESTMAPADDON_BORDER_OPACITY),
				tooltip = GetString(SI_TESTMAPADDON_BORDER_OPACITY_TOOLTIP),
				min = 0,
				max = 100,
				step = 1,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_DROPDOWN,
				label = GetString(SI_TESTMAPADDON_TITLE_FONT),
				items = lookup.fonts,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_DROPDOWN,
				label = GetString(SI_TESTMAPADDON_TITLE_FONT_SIZE),
		...
		settings:AddSetting(
			{
				...
				label = GetString(SI_TESTMAPADDON_TITLE_COLOR),
		...
		do
			...
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_DROPDOWN,
					label = GetString(SI_TESTMAPADDON_TITLE_POSITION),
					items = items,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_FULL_TITLE),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_FULL_TITLE_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_KEEP_SQUARE),
				tooltip = GetString(SI_TESTMAPADDON_KEEP_SQUARE_TOOLTIP),
				default = true,
				getFunction = function()
		...
		do
			local Modes = {
				{name = GetString(SI_TESTMAPADDON_SHOW_CLOCK0), data = {false, false}},
				{name = GetString(SI_TESTMAPADDON_SHOW_CLOCK1), data = {true, false}},
				{name = GetString(SI_TESTMAPADDON_SHOW_CLOCK2), data = {false, true}},
				{name = GetString(SI_TESTMAPADDON_SHOW_CLOCK3), data = {true, true}}
			}
			local ModeToData = {}
			for i = 1, #Modes do
			...
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_DROPDOWN,
					label = GetString(SI_TESTMAPADDON_SHOW_CLOCK),
					tooltip = GetString(SI_TESTMAPADDON_SHOW_CLOCK_TOOLTIP),
					items = Modes,
		...
		do
			...
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_DROPDOWN,
					label = GetString(SI_TESTMAPADDON_TIME_FORMAT),
					items = Modes,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_CAMERA_HEADING),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_CAMERA_HEADING_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_SLIDER,
				label = " |u12:0::|u" .. GetString(SI_TESTMAPADDON_CAMERA_HEADING_ANGLE),
				tooltip = GetString(SI_TESTMAPADDON_CAMERA_HEADING_ANGLE_TOOLTIP),
				min = 20,
				max = 70,
				step = 1,
		...
		do
			local Modes = {
				{
					name = GetString(SI_TESTMAPADDON_ZONEALERTMODE_ALWAYS),
					data = self.zoneAlertMode.Always
				},
				{
					name = GetString(SI_TESTMAPADDON_ZONEALERTMODE_MAP_HIDDEN),
					data = self.zoneAlertMode.MiniMapHidden
				},
				{
					name = GetString(SI_TESTMAPADDON_ZONEALERTMODE_NEVER),
			...
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_DROPDOWN,
					label = GetString(SI_TESTMAPADDON_ZONE_CHANGE_ALERT),
					items = Modes,
		...
		do
			local Modes = {
				{name = GetString(SI_TESTMAPADDON_COMPASSMODE_UNTOUCHED), data = self.compassMode.Untouched},
				{name = GetString(SI_TESTMAPADDON_COMPASSMODE_HIDDEN), data = self.compassMode.Hidden},
				{name = GetString(SI_TESTMAPADDON_COMPASSMODE_SHOWN), data = self.compassMode.Shown}
			}
			local ModeToData = {}
			for i = 1, #Modes do
				ModeToData[Modes[i].data] = Modes[i]
			...
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_DROPDOWN,
					label = GetString(SI_TESTMAPADDON_SHOW_COMPASS),
					tooltip = GetString(SI_TESTMAPADDON_SHOW_COMPASS_TOOLTIP),
					items = Modes,
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_ON_TOP),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_ON_TOP_TOOLTIP),
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_ALL_TRAVEL_NODES),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_ALL_TRAVEL_NODES_TOOLTIP),
		...
		if not ZO_IsConsoleOrGameCoreUI() then
			settings:AddSetting(
				{
					type = LibHarvensAddonSettings.ST_SECTION,
					label = GetString(SI_TESTMAPADDON_FRAMEDROP_DEBUG)
				}
			)
		end
		...
		settings:AddSetting(
			{
				type = LibHarvensAddonSettings.ST_CHECKBOX,
				label = GetString(SI_TESTMAPADDON_SHOW_FREEZE_WARNING),
				tooltip = GetString(SI_TESTMAPADDON_SHOW_FREEZE_WARNING_TOOLTIP),
				default = false,
				getFunction = function()
