...
Junkee.localizations = {
	en = {
		...
		DisplayNameBindingName = "Toggle Display Name",
		JunkLabel = "Junk",
		UnjunkLabel = "UnJunk",
		LinkLabel = "Link",
		LockLabel = "Lock",
	...
	de = {
		...
		DisplayNameBindingName = "Anzeigenamen umschalten",
	...
	fr = {
		...
		DisplayNameBindingName = "Basculer le nom d'affichage",
	...
	ru = {
		...
		DisplayNameBindingName = "Переключить отображаемое имя",
		JunkLabel = "Хлам",
		UnjunkLabel = "Не хлам",
		LinkLabel = "Ссылка",
		LockLabel = "Замок",
