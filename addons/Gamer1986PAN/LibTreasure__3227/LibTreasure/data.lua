...
-- Greenshade
	[300] = {
		...
		[PIN_TYPE_CLUES] = {
			{ 0.2645, 0.1449, "no map opened", 187902 }, -- Serpentguard Rider Clue
		},
	},
-- Reaper’s March
	[256] = {
...
-- Rivenspire
	[10] = {
		...
		[PIN_TYPE_CLUES] = {
			{ 0.7139, 0.7308, "no map opened", 191157 }, -- Wispheart Totem Clue
		},
	},
...
-- High Isle
	...
	[2427] = {
		...
		[PIN_TYPE_CLUES] = {
			...
			{ 0.6622, 0.1466, "no map opened", 207972 }, -- Morihaus, Sacred Bull Clue
		},
	},
	-- Solstice
	[2603] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.3277, 0.5715, "treasuremap_u46_solstice_01", 217926 }, -- Solstice Treasure Map I
			{ 0.3956, 0.7709, "treasuremap_u46_solstice_02", 217927 }, -- Solstice Treasure Map II
			{ 0.4019, 0.3720, "treasuremap_u46_solstice_03", 217928 }, -- Solstice Treasure Map III
			{ 0.7744, 0.5497, "treasuremap_u48_solstice_04", 223773 }, -- Solstice Treasure Map IV
			{ 0.8102, 0.3232, "treasuremap_u48_solstice_05", 223774 }, -- Solstice Treasure Map V
			{ 0.7255, 0.6788, "treasuremap_u48_solstice_06", 223772 }, -- Solstice Treasure Map VI
		},
		[PIN_TYPE_SURVEYS] = {
...
do
	...
	for mapId, pinTypeData in pairs(ALL_DATA) do
		mapIdData[mapId] = { }
...
data.BOOK_ID =
{
	...
	[7298] = 188206, -- Ansei's Victory Clue
	[7219] = 187726, -- Blackfeather Knave Clue
	[7257] = 187898, -- Blood Sacrifice Clue
	[7256] = 187896, -- Ceporah's Insight Clue
	[7295] = 188203, -- Grand Larceny Clue
	[7297] = 188205, -- Grand Oratory Clue
	[7258] = 187900, -- Hagraven Matron Clue
	[7253] = 187890, -- Hlaalu Councilor Clue
	[7252] = 187888, -- House Embassy Clue
	[7261] = 187906, -- Knight Commander Clue
	[7260] = 187904, -- Knights of Saint Pelin Clue
	[7511] = 190927, -- Legions Arrival Clue
	[7251] = 187886, -- Murder of Crows Clue
	[7255] = 187894, -- Psijic Relicmaster Clue
	[7296] = 188204, -- Ring's Guile Clue
	[7259] = 187902, -- Serpentguard Rider Clue
	[7254] = 187892, -- Summerset Raid Clue
	[7545] = 191157, -- Wispheart Totem Clue
