...
AutoCategory_localization_strings["ru"] = {
    ...
    SI_AC_MENU_EC_BUTTON_CHECK_RULE_TOOLTIP = "Проверяет правило на ошибки",
    SI_AC_MENU_EC_BUTTON_COPY_CATEGORY = "Копировать",
    SI_AC_MENU_EC_BUTTON_COPY_CATEGORY_TOOLTIP = "Создает копию выбранной категории. (Копия предопределенной категории больше не является предопределенной и может быть изменена).",
