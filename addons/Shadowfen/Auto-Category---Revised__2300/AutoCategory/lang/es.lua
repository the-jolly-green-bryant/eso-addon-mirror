...
AutoCategory_localization_strings["es"] = {
    ...
    SI_AC_BAGTYPE_SHOWNAME_FURNVAULT = "Cámara de mobiliario",
	...
	SI_AC_BAGTYPE_TOOLTIP_FURNVAULT = "Cámara de mobiliario",
    ...
    SI_AC_MENU_BS_SHOWDROPDOWN_CATEGORIES = "Categorías ordenadas por visualización",
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY = "Prioridad de ejecución",
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY_TOOLTIP = "La prioridad de ejecución determina el orden en que se ejecutan las reglas de categoría en la bolsa; la más alta precede a la más baja.",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY = "Prioridad de visualización",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY_TOOLTIP = "La prioridad de visualización determina el orden de visualización de la categoría en la bolsa, la más alta se muestra antes que la más baja.",
    SI_AC_MENU_BS_BUTTON_SHOW = "Mostrar orden de categorías" ,
    SI_AC_TITLE_DSO = "Orden de visualización de categorías",
    SI_AC_MENU_BS_BUTTON_SHOW_TOOLTIP = "Abre una ventana que muestra las categorías en el orden de visualización que hayas seleccionado." ,
    ...
    SI_AC_MENU_BS_HIDE_CAT = "Ocultar categoría",
    SI_AC_MENU_BS_SHOW_CAT = "Mostrar categoría",
    ...
    SI_AC_MENU_BS_RESET_SHOW_PRIOR = "Restablecer prioridad de visualización",
    SI_AC_MENU_BS_RESET_ALL_SHOW_PRIOR = "Restablecer TODAS las prioridades de la bolsa",
