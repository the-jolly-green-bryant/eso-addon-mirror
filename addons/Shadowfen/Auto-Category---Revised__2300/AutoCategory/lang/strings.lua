...
AutoCategory_localization_strings["en"] = {
    ...
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY = "Run Priority",
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY_TOOLTIP = "Run Priority determines the that category rules are run on the bag, higher goes before lower.",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY = "Display Priority",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY_TOOLTIP = "Display Priority determines the display order of the category in the bag, higher displays before lower.",
    SI_AC_MENU_BS_BUTTON_SHOW = "Show Category Order" ,
    SI_AC_TITLE_DSO = "Category Display Order",
    SI_AC_MENU_BS_BUTTON_SHOW_TOOLTIP = "Open a window that shows the categories in the display order that you have selected." ,
    ...
    SI_AC_MENU_BS_RESET_SHOW_PRIOR = "Reset Show Priority",
    SI_AC_MENU_BS_RESET_ALL_SHOW_PRIOR = "Reset ALL Show Priorities for Bag",
    ...
    SI_AC_DEFAULT_TAG_PAPERS="Papers",
    ...
    SI_AC_DEFAULT_CATEGORY_MASTER_WRITS="Master Writs (All)",
