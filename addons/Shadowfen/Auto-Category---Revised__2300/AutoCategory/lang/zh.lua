...
AutoCategory_localization_strings["zh"] = {
    ...
    SI_AC_MENU_BS_SHOWDROPDOWN_CATEGORIES = "Display-ordered Categories",
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY = "执行优先级",
    SI_AC_MENU_BS_SLIDER_CATEGORY_RUNPRIORITY_TOOLTIP = "执行优先级决定了类别规则在库存袋上运行的顺序。优先级越高，执行优先级越高。",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY = "显示优先级",
    SI_AC_MENU_BS_SLIDER_CATEGORY_SHOWPRIORITY_TOOLTIP = "显示优先级决定了类别在库存中的显示顺序。优先级高的类别优先显示，优先级低的类别后显示。",
    SI_AC_MENU_BS_BUTTON_SHOW = "显示类别顺序" ,
    SI_AC_TITLE_DSO = "类别显示顺序",
    SI_AC_MENU_BS_BUTTON_SHOW_TOOLTIP = "打开一个窗口，按您选择的显示顺序显示类别。" ,
    ...
    SI_AC_MENU_BS_HIDE_CAT = "隐藏类别",
    SI_AC_MENU_BS_SHOW_CAT = "显示类别",
    SI_AC_MENU_BS_BUTTON_REMOVE = "移除分类",
    SI_AC_MENU_BS_BUTTON_REMOVE_TOOLTIP = "将选定的分类从背包中移除",
    SI_AC_MENU_BS_RESET_SHOW_PRIOR = "重置显示优先级",
    SI_AC_MENU_BS_RESET_ALL_SHOW_PRIOR = "重置库存袋中所有类别的显示优先级",

    SI_AC_MENU_BS_CHECKBOX_CATEGORY_HIDDEN = "隐藏类别",
    SI_AC_MENU_BS_CHECKBOX_CATEGORY_HIDDEN_TOOLTIP = "如果选中，所选类别和类别内的所有物品将不会出现在您的包中。",
    ...
    SI_AC_MENU_GS_CHECKBOX_SHOW_CATEGORY_ITEM_COUNT = "显示类别项目数",
    SI_AC_MENU_GS_CHECKBOX_SHOW_CATEGORY_ITEM_COUNT_TOOLTIP = "在类别名称后添加数字以显示该类别中有多少个项目", 
    SI_AC_MENU_GS_CHECKBOX_SAVE_CATEGORY_COLLAPSE_STATUS = "保存类别折叠状态",
    SI_AC_MENU_GS_CHECKBOX_SAVE_CATEGORY_COLLAPSE_STATUS_TOOLTIP = "退出或注销后，类别将保持折叠/展开状态。",

    SI_AC_MENU_SUBMENU_IMPORT_EXPORT = "|c0066FF[进出口]|r",
    SI_AC_MENU_HEADER_ACCOUNT_WIDE_SETTING = "帐户范围设置",
    ...
    SI_AC_DEFAULT_CATEGORY_BOP_TRADEABLE= "BoP 可交易",
    SI_AC_DEFAULT_CATEGORY_BOP_TRADEABLE_DESC= "装备可在限定时间内交易",
    ...
    SI_AC_DEFAULT_CATEGORY_JEWELRYCRAFTING= "珠宝制作",
    ...
    SI_CONTEXT_MENU_EXPAND = "扩张",
    SI_CONTEXT_MENU_COLLAPSE = "坍塌",
    SI_CONTEXT_MENU_EXPAND_ALL = "展开全部",
    SI_CONTEXT_MENU_COLLAPSE_ALL = "全部折叠",
}
