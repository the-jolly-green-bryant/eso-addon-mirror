...
CS.Lang = {
  de = {
    ...
    TT = {
      ...
      "CraftStore Styles",
      "CraftStore Runes",
      "CraftStore Provisioning",
      "CraftStore Furnishings",
    },
  ...
  ru = {
    ...
    TT = {
      ...
      'филе',
      'Стили CraftStore',
      'Зачарование CraftStore',
      'Снабжение CraftStore',
      'Мебель CraftStore',
    },
  ...
  zh = {
    options = {
      showbutton = '显示 CraftStore 按钮',
      lockbutton = '锁定 CraftStore 按钮',
      lockelements = '锁定 CraftStore 元素',
      closeonmove = '移动时关闭 CraftStore 窗口',
      useartisan = '使用 CraftStoreArtisan（尚未完成）',
      useflask = '使用 CraftStoreFlask（尚未完成）',
      usequest = '使用 CraftStoreQuest',
      usequestTooltip = '打开制作台时显示当前激活的制作委托任务',
      usecook = '使用 CraftStoreCook',
      usecookTooltip = '用 CraftStore 界面替换烹饪台的默认用户界面',
      userune = '使用 CraftStoreRune',
      useruneTooltip = '用 CraftStore 界面替换附魔台的默认用户界面',
      displaystyles = '在提示中显示物品样式',
      markitems = '标记需要的物品',
      showsymbols = '显示 ' .. i .. '/' .. o .. ' 符号',
      ...
      userunecreation = '使用 CraftStoreRune Creation',
      userunecreationTooltip = '用 CraftStore 界面替换符文制作的默认用户界面',
      useruneextraction = '使用 CraftStoreRune Extraction',
      useruneextractionTooltip = '用 CraftStore 界面替换符文提取的默认用户界面',
      userunerecipe = '使用 CraftStoreRune Furniture',
      userunerecipeTooltip = '用 CraftStore 界面替换附魔台家具图纸制作的默认用户界面',
