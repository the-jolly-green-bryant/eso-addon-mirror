...
ZO_CreateStringId("SI_BINDING_NAME_REFRESH_FRAMES",    "Rafraîchir les cadres")
...
ZO_CreateStringId("FTC_Menu_FWidth",        "Largeur des Cadres du joueur")
ZO_CreateStringId("FTC_Menu_FWidthDesc",    "Régler la larger des cadres unitaires de FTC. [Défaut: "..FTC.Defaults.FrameWidth.."]")

ZO_CreateStringId("FTC_Menu_FHeight",       "Hauteur des Cadres du joueur")
ZO_CreateStringId("FTC_Menu_FHeightDesc",   "Régler la hauteur des cadres unitaires de FTC. [Défaut: "..FTC.Defaults.FrameHeight.."]")

ZO_CreateStringId("FTC_Menu_TFWidth",        "Largeur des Cadres du cible")
ZO_CreateStringId("FTC_Menu_TFWidthDesc",    "Régler la larger des cadres cible de FTC. [Défaut: "..FTC.Defaults.TargetFrameWidth.."]")

ZO_CreateStringId("FTC_Menu_TFHeight",       "Hauteur des Cadres du cible")
ZO_CreateStringId("FTC_Menu_TFHeightDesc",   "Régler la hauteur des cadres cible de FTC. [Défaut: "..FTC.Defaults.TargetFrameHeight.."]")

ZO_CreateStringId("FTC_Menu_FOpacIn",       "Opacité en Combat")
...
ZO_CreateStringId("FTC_Menu_FOpacOut",      "Opacité Hors-Combat")
ZO_CreateStringId("FTC_Menu_FOpacOutDesc",  "Ajuster l'opacité Hors-Combat des cadres unitaires de FTC. Les valeurs faibles sont plus transparents. [Défaut: "..FTC.Defaults.FrameOpacityOut.."]")

ZO_CreateStringId("FTC_Menu_FTOpacIn",      "Cible Opacité en Combat")
ZO_CreateStringId("FTC_Menu_FTOpacInDesc",  "Ajuster l'opacité des cadre cible de FTC pendant le combat. Les valeurs faibles sont plus transparents. [Défaut: "..FTC.Defaults.FrameTargetOpacityIn.."]")

ZO_CreateStringId("FTC_Menu_FTOpacOut",      "Cible Hors-Combat Opacité")
ZO_CreateStringId("FTC_Menu_FTOpacOutDesc",  "Ajuster l'opacité Hors-Combat des cadre cible de FTC. Les valeurs faibles sont plus transparents. [Défaut: "..FTC.Defaults.FrameTargetOpacityOut.."]")
...
ZO_CreateStringId("FTC_Menu_FFontC",      "Couleur de la police")
ZO_CreateStringId("FTC_Menu_FFontCDesc",  "Définir la couleur du texte. [Default: "..default.."]")
...
local default = ( FTC.Defaults.TargetFrameLevel ) and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_FTargetL",      "Niveaux de cadre cible")
ZO_CreateStringId("FTC_Menu_FTargetLDesc",  "Incluez le niveau sur un cadre cible personnalisé? [Défaut: "..default.."]")

local default = ( FTC.Defaults.TargetFrameTitle ) and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_FTargetT",      "Titre de cadre cible")
ZO_CreateStringId("FTC_Menu_FTargetTDesc",  "Incluez le titre sur un cadre cible personnalisé? [Défaut: "..default.."]")

local default = ( FTC.Defaults.TargetFrameShowAccount ) and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_FTargetShowA",       "Afficher @Nom dans le cadre de cible")
ZO_CreateStringId("FTC_Menu_FTargetShowADesc",   "Afficher le nom du compte dans les cadres de cible. [Défaut: " .. default .."]")
...
local default = ( FTC.Defaults.GroupShowLevel ) and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_FGShowL",       "Afficher Niveaux dans le cadre de groupe")
ZO_CreateStringId("FTC_Menu_FGShowLDesc",   "Afficher niveaux dans le cadre de groupe. [Défaut: " .. default .."]")

local default = ( FTC.Defaults.GroupShowAccount ) and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_FGShowA",       "Afficher @Nom dans le cadre de groupe")
ZO_CreateStringId("FTC_Menu_FGShowADesc",   "Afficher le nom du compte dans les cadres de groupe. [Défaut: " .. default .."]")
...
local default = FTC.Defaults.LogHideHeal    and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_LHideHeal",     "Cacher la Guérison")
ZO_CreateStringId("FTC_Menu_LHideHealDesc", "Cacher la guérison en tout temps? [Default: "..default.."]")

local default = FTC.Defaults.LogCOH         and "Enabled" or "Disabled"
ZO_CreateStringId("FTC_Menu_LCOH",          "Combattre Seulement la Guérison")
ZO_CreateStringId("FTC_Menu_LCOHDesc",      "Cacher la guérison hors combat? [Default: "..default.."]")
...
local default = FTC.Defaults.SCTHideHeal    and "Activé" or "Désactivé"
ZO_CreateStringId("FTC_Menu_SHideHeal",     "Cacher la Guérison")
ZO_CreateStringId("FTC_Menu_SHideHealDesc", "Cacher la guérison en tout temps? [Default: "..default.."]")

local default = FTC.Defaults.SCTCOH         and "Enabled" or "Disabled"
ZO_CreateStringId("FTC_Menu_SCOH",          "Combattre Seulement la Guérison")
ZO_CreateStringId("FTC_Menu_SCOHDesc",      "Cacher la guérison hors combat? [Default: "..default.."]")
