...
function BUI.Stats:BuffsUp_Init()	--BuffsUp REPORT
	...
	local BuffsUp	=BUI.UI.Control(	"BUI_BuffsUp",			SatuveUI,	{270+fs*7,200},	BUI.Vars.BUI_BuffsUp,			true)
...
function BUI.Stats.Minimeter_Init()		--MINI DAMAGE METER
	...
	local ui	=BUI.UI.Control(	"BUI_MiniMeter",			SatuveUI,	{width,44},		BUI.Vars.BUI_MiniMeter,		not BUI.Vars.StatsMiniMeter)
...
function BUI.Stats.GroupDPS_Init()
	...
	local ui	=BUI.UI.Control(	"BUI_GroupDPS",			SatuveUI,	{w,h},	BUI.Vars.BUI_GroupDPS,		true)
...
local function EquipmentInfo()
	...
	BUI.UI.Texture("BUI_Report_Logo", ui, {128,128}, {CENTER,RIGHT,-BUFF_W/2,0}, "/SatuveXboxUI/textures/Satuve_logo.dds") BUI_Report_Logo:SetAlpha(.5)
