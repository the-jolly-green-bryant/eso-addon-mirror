...
local function UI_Init()
	...
	local space=5
	local texture="/SatuveXboxUI/textures/curved/Curved"..c..".dds"
	local half=coords[c][3] and .5 or 1
	local ui	=BUI.UI.Control("BUI_Curved",	SatuveUI,	{w,h},	{CENTER,CENTER,0,BUI.Vars.CurvedOffset}, false)
	--Shift animation
	ui.shift	=BUI.UI.Texture("BUI_Curved_Shift", ui, {w1*2,h}, {LEFT,LEFT,0,0}, "/SatuveXboxUI/textures/curved/Shift.dds", true, {0,0})
	...
	ui.health.hot=BUI.UI.Texture("BUI_Curved_HealthHoT", ui.health, {wh,wh/2}, {LEFT,LEFT,w1*coords[c][15]-wh*.2,wh}, '/SatuveXboxUI/textures/regen_sm.dds', true, {1,2})
	ui.health.hot:SetTextureRotation(math.pi*.5)
	ui.health.dot=BUI.UI.Texture("BUI_Curved_HealthDoT", ui.health, {wh,wh/2}, {LEFT,LEFT,w1*coords[c][15]-wh*.2,-wh}, '/SatuveXboxUI/textures/regen_sm.dds', true, {1,2})
	...
	--Target
	local target	=BUI.UI.Control("BUI_CurvedTarget",	SatuveUI,	{w,h},	{CENTER,CENTER,0,BUI.Vars.CurvedOffset}, true)
	...
	ui.target.hot=BUI.UI.Texture("BUI_Curved_TargetHoT", ui.target, {wh,wh/2}, {RIGHT,RIGHT,-w1*coords[c][15]+wh*.2,wh}, '/SatuveXboxUI/textures/regen_sm.dds', true, {1,2})
	ui.target.hot:SetTextureRotation(math.pi*.5)
	ui.target.dot=BUI.UI.Texture("BUI_Curved_TargetDoT", ui.target, {wh,wh/2}, {RIGHT,RIGHT,-w1*coords[c][15]+wh*.2,-wh}, '/SatuveXboxUI/textures/regen_sm.dds', true, {1,2})
