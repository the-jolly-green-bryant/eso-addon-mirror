...
local function Glyphs_Init()
	...
	local ui		=BUI.UI.Control(	"BUI_Glyphs",			SatuveUI,	{(size+10)*3,(size+10)*3},	anchor,				not BUI.Vars.Glyphs)
...
function BUI.OnScreen.UI_Init()
	...
	local ui		=BUI.UI.Control(	"BUI_OnScreen",			SatuveUI,	{w,30},	BUI.Vars.BUI_OnScreen,	false)
	...
	fs=fs*.75
	w=w*.75
	local ui		=BUI.UI.Control(	"BUI_OnScreenS",			SatuveUI,	{w,30},	BUI.Vars.BUI_OnScreenS,	false)
	...
	texture:SetTexture('/SatuveXboxUI/textures/reticle/circle_bar.dds')	--'/esoui/art/dye/gamepad/gp_colorselector_monoround.dds'
