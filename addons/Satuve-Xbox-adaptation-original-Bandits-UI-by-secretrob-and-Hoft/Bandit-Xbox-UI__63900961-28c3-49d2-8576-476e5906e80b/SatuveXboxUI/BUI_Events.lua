...
local function OnScreenResize()
	BUI.UI.TopLevelWindow("SatuveUI", GuiRoot, {GuiRoot:GetWidth(),GuiRoot:GetHeight()}, {CENTER,CENTER,0,0}, false)
end
...
function bui_pl(msg)
	-- Xbox-PC can initialize add-ons before CHAT_SYSTEM exists.
	-- Queue startup messages until the chat system and its primary container are ready.
