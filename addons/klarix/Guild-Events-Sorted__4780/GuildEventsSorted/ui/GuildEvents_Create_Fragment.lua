...
function GuildEventsUI:Create()
    ...
    ui.btnEventAdd_ClearSignUps = wm:CreateControl("GuildEvents_btnEventAdd_ClearSignUps", ui.main, CT_BUTTON)
    ...
    ui.btnEventAdd_Save:SetHandler("OnMouseEnter", function(self)
        ZO_Tooltips_ShowTextTooltip(self, BOTTOM, L.tooltipSave)
    end)
    ui.btnEventAdd_Save:SetHandler("OnMouseExit", function()
    ...
    ui.btnEventAdd_ClearSignUps:SetDimensions(40,40)
    ui.btnEventAdd_ClearSignUps:SetAnchor(TOPLEFT, ui.bdEventAdd_Info, BOTTOMLEFT, 60, 10)
    ui.btnEventAdd_ClearSignUps:SetAlpha(1)
    ui.btnEventAdd_ClearSignUps:SetDrawLayer(3)
    ui.btnEventAdd_ClearSignUps:SetScale(1)
    ui.btnEventAdd_ClearSignUps:SetNormalTexture("/esoui/art/crafting/smithing_tabicon_improve_up.dds")
    ui.btnEventAdd_ClearSignUps:SetMouseOverTexture("/esoui/art/crafting/smithing_tabicon_improve_over.dds")
    ui.btnEventAdd_ClearSignUps:SetHandler("OnClicked", function(h)
        GuildEventsUI:ClearAllSignUps()
    end)
    ui.btnEventAdd_ClearSignUps:SetHandler("OnMouseEnter", function(self)
        ZO_Tooltips_ShowTextTooltip(self, BOTTOM, L.tooltipClear)
    end)
    ui.btnEventAdd_ClearSignUps:SetHandler("OnMouseExit", function()
        ZO_Tooltips_HideTextTooltip()
    end)
...
function GuildEventsUI.create:refresh()
    ...
    if memberIsAdmin then
        ...
        ui.btnEventAdd_ClearSignUps:SetHidden(false)
        ...
        ui.btnEventAdd_ClearSignUps:SetHidden(true)
        ui.btnEventAdd_Cancel:SetHidden(true)
