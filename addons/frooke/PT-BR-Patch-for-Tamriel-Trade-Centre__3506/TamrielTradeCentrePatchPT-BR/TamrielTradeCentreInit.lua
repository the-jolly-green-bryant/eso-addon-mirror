...
function TamrielTradeCentre_ItemInfo:New(itemLink)
	...
	itemInfo.Name = zo_strformat(TTCBr.getItemName(itemLink) or SI_TOOLTIP_ITEM_NAME, itemName)
...
function TamrielTradeCentre_MasterWritInfo:New(itemLink)
	...
	--10 to 15
	local itemName = string.lower(zo_strformat(SI_TOOLTIP_ITEM_NAME, TTCBr.getItemName(itemLink) or GetItemLinkName(itemLink)))
