...
local function OnGuildHistoryCategoryUpdated(guildId, category)
...
function TamrielTradeCentre:Init()
	...
	if (clientCulture~= "en" and clientCulture ~= "de" and clientCulture ~= "fr" and clientCulture ~= "zh" and clientCulture ~= "ru" and clientCulture ~= "br") then
