local strings = {
	...
	UCT_MSG_CMD_OPTION_10 =	"    /uct ka - To show the elapsed time since your last %s completion.",
	UCT_MSG_CMD_OPTION_11 =	"    /uct rg - To show the elapsed time since your last %s completion.",
	UCT_MSG_CMD_OPTION_12 =	"    /uct all - To show the elapsed time since your last completion of all trials.",
	...
	UCT_MSG_LAST_KA =		"Last KA: ",
	UCT_MSG_NEXT_KA =		"Next KA: ",
	UCT_MSG_LAST_RG =		"Last RG: ",
	UCT_MSG_NEXT_RG =		"Next RG: ",
