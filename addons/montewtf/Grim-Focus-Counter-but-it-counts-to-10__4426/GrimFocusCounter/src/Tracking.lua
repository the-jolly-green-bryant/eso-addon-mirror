...
function GFC:CheckSkillSlotted()
    ...
    if abilityId == 61927 then
        GFC.procStacks = 4
    elseif abilityId == 61902 or abilityId == 61919 then
        GFC.procStacks = 5
    end
    ...
    for i = 1, GetNumBuffs("player") do
        ...
        for ability, stackId in pairs(GFC.skills) do
            ...
            if stackId == abilityId then
                ...
                if stackId == 122587 then
                    GFC.procStacks = 4
                elseif stackId == 122585 or stackId == 122586 then
                    GFC.procStacks = 5
                end
...
function GFC.OnEffectChanged(_, changeType, _, effectName, _, _, _, stackCount, _, _, _, _, _, _, _, effectAbilityId)
    ...
    if stackCount >= GFC.procStacks and changeType == EFFECT_RESULT_FADED then
