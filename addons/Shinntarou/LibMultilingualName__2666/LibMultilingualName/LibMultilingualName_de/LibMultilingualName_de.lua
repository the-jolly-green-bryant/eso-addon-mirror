LibMultilingualName_de = LibMultilingualName_de or {}
local LIB = LibMultilingualName_de
...
LIB.NAME = "LibMultilingualName_de"
...
local function onLibraryLoaded(event, name)
    ...
    table.insert(LIB_PARENT.LOADED_LANG_CODES, LIB_PARENT.CODE_GERMAN)
end
