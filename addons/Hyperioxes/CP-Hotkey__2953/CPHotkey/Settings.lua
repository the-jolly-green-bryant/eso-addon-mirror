...
function CPH_LoadSettings()
    local panelData = {
        type = "panel",
        name = "CP Hotkey",
        displayName = "CP Hotkey",
        author = "Hyperioxes",
        version = "0.5",
        website = "https://www.esoui.com/downloads/info2953-CPHotkey.html#info",
		feedback = "https://www.esoui.com/downloads/info2953-CPHotkey.html#comments",
		donation = "https://www.esoui.com/downloads/info2953-CPHotkey.html#donate",
        slashCommand = "/cph",
        registerForRefresh = true,
        registerForDefaults = true,
    }
    LibAddonMenu2:RegisterAddonPanel("CP Hotkey", panelData)

    local optionsTable = {}
    table.insert(optionsTable, {

                type = "checkbox",
                name = "Allow use of gold",
                getFunc = function() return CPHsavedVars.allowRespec end,
                setFunc = function(value) CPHsavedVars.allowRespec = value 
				end,
                width = "full",	--or "half" (optional)
                tooltip = "Allow use of gold for respeccing when you don't have slottables unlocked",
            })
   ...
   for _,v in pairs(HTTsavedVars.orderOfDebuffs) do
    ...
    LibAddonMenu2:RegisterOptionControls("CP Hotkey", optionsTable)
end