--[[
	...
	Based on LuaMatrix sourced from https://wiki.multitheftauto.com/wiki/Lua_matrix_library
	which is a modified version of https://github.com/davidm/lua-matrix/blob/master/lua/matrix.lua

	Modified to work as a LibStub-compatible library for ESO by @Datael

	NOTE: Has not been tested thoroughly and a lot of functionality is missing as
	the complex class is not included. If anyone needs this functionality also, feel
	free to contact me via ingame mail.

	This Add-on is not created by, affiliated with or sponsored by ZeniMax Media Inc. or its affiliates. 
	The Elder ScrollsR and related logos are registered trademarks or trademarks of ZeniMax Media Inc. in the United States and/or other countries. 
	All rights reserved
...
local MAJOR, MINOR = "LibMatrix-1.2", 8
local matrix = LibStub:NewLibrary(MAJOR, MINOR)
