-- Local treasure data module (no globals leaked)
local data = {}

local PIN_TYPE_TREASURE = "treasure"
local PIN_TYPE_SURVEYS = "survey"
local PIN_TYPE_ORDER = {
	PIN_TYPE_TREASURE,
	PIN_TYPE_SURVEYS,
}
...
-- Glenumbra
	[1] = {
		[PIN_TYPE_TREASURE] = {
			...
			{ 0.6070, 0.2047, "glenmoral_weapon_daggerfall_map", 153642 , "Glenmoril Wyrd Treasure Map: Glenumbra" },
		},
		[PIN_TYPE_SURVEYS] = {
...
-- Wrothgar
	[667] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.4798, 0.7865, "treasuremap_orsinium_01", 43727 , "Wrothgar Treasure Map I" },
			{ 0.7650, 0.5648, "treasuremap_orsinium_02", 43728 , "Wrothgar Treasure Map II" },
			{ 0.2724, 0.6782, "treasuremap_orsinium_03", 43729 , "Wrothgar Treasure Map III" },
			{ 0.4441, 0.4851, "treasuremap_orsinium_04", 43730 , "Wrothgar Treasure Map IV" },
			{ 0.7303, 0.3188, "treasuremap_orsinium_05", 43731 , "Wrothgar Treasure Map V" },
			{ 0.1850, 0.7600, "treasuremap_orsinium_06", 43732 , "Wrothgar Treasure Map VI" },
		},
		[PIN_TYPE_SURVEYS] = {
	...
	[895] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.8159, 0.1905, "treasuremap_orsinium_02", 43728 , "Wrothgar Treasure Map II" },
		},
	},
	-- SubPin: Morkul
	[954] = {
		[PIN_TYPE_TREASURE] = {
			{-0.0675, 0.6872, "treasuremap_orsinium_04", 43730 , "Wrothgar Treasure Map IV" },
		},
	},
-- Hew's Bane
	[994] = {
...
-- Northern Elsweyr
	[1555] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.6116, 0.4083, "treasuremap_elsweyr_04", 151613 , "Northern Elsweyr Treasure Map I" },
			{ 0.4213, 0.2241, "treasuremap_elsweyr_05", 151614 , "Northern Elsweyr Treasure Map II" },
			{ 0.4007, 0.5826, "treasuremap_elsweyr_06", 151615 , "Northern Elsweyr Treasure Map III" },
			{ 0.2691, 0.7504, "treasuremap_elsweyr_07", 151616 , "Northern Elsweyr Treasure Map IV" },
			{ 0.4872, 0.6790, "treasuremap_elsweyr_08", 151617 , "Northern Elsweyr Treasure Map V" },
			{ 0.6343, 0.4535, "treasuremap_elsweyr_09", 151618 , "Northern Elsweyr Treasure Map VI" },
			{ 0.3193, 0.7255, "treasuremap_elsweyr_01", 147922 , "Northern Elsweyr CE Treasure Map I" },
			{ 0.6995, 0.2519, "treasuremap_elsweyr_02", 147923 , "Northern Elsweyr CE Treasure Map II" },
			{ 0.8115, 0.3619, "treasuremap_elsweyr_03", 147924 , "Northern Elsweyr CE Treasure Map III" },
		},
		[PIN_TYPE_SURVEYS] = {
...
-- Southern Elsweyr
	[1654] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.4687, 0.6361, "treasuremap_dragonhold_01", 156716 , "Southern Elsweyr Treasure Map I" },
			{ 0.2967, 0.2558, "treasuremap_dragonhold_02", 156715 , "Southern Elsweyr Treasure Map II" },
		},
	},
-- Western Skyrim
	[1719] = {
...
-- Blackwood
	[1887] = {
		[PIN_TYPE_TREASURE] = {
			...
			{ 0.3182, 0.3547, "treasuremap_blackwood_10", 175546 , "Blackwood CE Treasure Map III" },
...
-- High Isle
	[2114] = {
		[PIN_TYPE_TREASURE] = {
			...
			{ 0.4597, 0.6066, "treasuremap_highisle_09", 187676 , "High Isle Treasure Map VI" },
		},
		[PIN_TYPE_SURVEYS] = {
			{ 0.6714, 0.3391, "highisle_survey_blacksmith", 188193 , "Blacksmith Survey: High Isle" },
			...
			{ 0.8966, 0.3736, "highisle_survey_clothier", 188194 , "Clothier Survey: High Isle" },
	...
	[2274] = {
		[PIN_TYPE_TREASURE] = {
			...
			{ 0.6377, 0.4985, "treasuremap_necrom_05", 198099 , "Telvanni Peninsula Treasure Map III" },
			{ 0.2896, 0.3852, "treasuremap_necrom_08", 198100 , "Telvanni Peninsula Treasure Map IV" },
		},
		[PIN_TYPE_SURVEYS] = {
			{ 0.7320, 0.5519, "necrom_survey_blacksmith", 198291 , "Blacksmith Survey: Telvanni Peninsula" },
			{ 0.5977, 0.5048, "necrom_survey_woodworker", 198297 , "Woodworker Survey: Telvanni Peninsula" },
			{ 0.4888, 0.7565, "necrom_survey_jewelrycrafting", 198294 , "Jewelry Crafting Survey: Telvanni Peninsula" },
		},
	},
	-- SubPin: Ald Isra
	[2386] = {
	...
	[2275] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.3842, 0.4650, "treasuremap_necrom_10", 196203 , "Apocrypha CE Treasure Map" },
			{ 0.7540, 0.4008, "treasuremap_necrom_07", 198101 , "Apocrypha Treasure Map I" },
			{ 0.4542, 0.3381, "treasuremap_necrom_09", 198102 , "Apocrypha Treasure Map II" },
		},
		[PIN_TYPE_SURVEYS] = {
			{ 0.7987, 0.7089, "necrom_survey_clothier", 198290 , "Clothier Survey: Apocrypha" },
			{ 0.6966, 0.4008, "necrom_survey_enchanter", 198289 , "Enchanter Survey: Apocrypha" },
	...
	[2427] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.7424, 0.1641, "treasuremap_u42_theforgottenprince_ce3", 206535 , "West Weald Pre-Purchase Treasure Map I" },
			...
			{ 0.6732, 0.2038, "treasuremap_u42_theforgottenprince_ce1", 207964 , "West Weald Treasure Map I" },
			{ 0.8735, 0.6098, "treasuremap_u42_theforgottenprince_02", 207965 , "West Weald Treasure Map II" },
			{ 0.5316, 0.6683, "treasuremap_u42_theforgottenprince_03", 207966 , "West Weald Treasure Map III" },
			{ 0.6317, 0.5825, "treasuremap_u42_theforgottenprince_04", 207967 , "West Weald Treasure Map IV" },
			{ 0.2013, 0.5373, "treasuremap_u42_theforgottenprince_05", 207968 , "West Weald Treasure Map V" },
	...
	[2603] = {
		[PIN_TYPE_TREASURE] = {
			{ 0.3302, 0.5740, "treasuremap_u46_solstice_01", 217926 , "Solstice Treasure Map I" },
			{ 0.3965, 0.7720, "treasuremap_u46_solstice_02", 217927 , "Solstice Treasure Map II" },
			{ 0.4027, 0.3770, "treasuremap_u46_solstice_03", 217928 , "Solstice Treasure Map III" },
			{ 0.7744, 0.5490, "treasuremap_u48_solstice_04", 223773 , "Solstice Treasure Map IV" },
			{ 0.8102, 0.3220, "treasuremap_u48_solstice_05", 223774 , "Solstice Treasure Map V" },
			{ 0.7255, 0.6800, "treasuremap_u48_solstice_06", 223772 , "Solstice Treasure Map VI" },
		},
		[PIN_TYPE_SURVEYS] = {
			{ 0.4627, 0.5950, "solstice_survey_blacksmith", 217930 , "Blacksmith Survey: Solstice" },
			{ 0.3751, 0.4749, "solstice_survey_woodworker", 217934 , "Woodworker Survey: Solstice" },
			{ 0.4354, 0.6729, "solstice_survey_jewelrycrafting", 217933 , "Jewelry Crafting Survey: Solstice" },
			{ 0.4171, 0.7088, "solstice_survey_clothier", 217931 , "Clothier Survey: Solstice" },
			{ 0.4615, 0.7346, "solstice_survey_enchanter", 217932 , "Enchanter Survey: Solstice" },
			{ 0.4967, 0.5268, "solstice_survey_alchemist", 217929 , "Alchemist Survey: Solstice" },
		},
	},
}
...
do
	...
	for _, mapId in ipairs(GetSortedNumericKeys(ALL_DATA)) do
		local pinTypeData = ALL_DATA[mapId]
		mapIdData[mapId] = { }
		for _, pinDataType in ipairs(PIN_TYPE_ORDER) do
			local pinData = pinTypeData[pinDataType]
			if pinData then
				for _, pinLayout in ipairs(pinData) do
					if type(pinLayout) == "table" then
						local itemId = pinLayout[INDEX_ITEMID]
						local texture = pinLayout[INDEX_TEXTURE]
						local x = pinLayout[INDEX_X]
						local y = pinLayout[INDEX_Y]
						if itemId and texture and x and y then
							local newPin =
							{
								itemId = itemId,
								mapId = mapId,
								...
								y = y,
								texture = texture,
								tooltip = pinLayout[INDEX_TOOLTIP],
							}
							-- itemsData
							itemsData[itemId] = itemsData[itemId] or {}
							itemsData[itemId][#itemsData[itemId] + 1] = newPin
							-- mapIdData
...
-- Attach localized API into addon internal namespace once MOMR exists
local function GetAllItemsData() return data.ITEMS_DATA end

-- Get the data of an item in the database
local function GetItemIdData(itemId, preferredMapId)
	local itemData = data.ITEMS_DATA
	local entries = itemData and itemData[itemId] or nil
	...
	if preferredMapId then
		for _, entry in ipairs(entries) do
			if entry.mapId == preferredMapId then
				return entry
			end
		end
	end

	-- Prefer the map that has the largest dataset (usually the parent zone), then lowest mapId.
	local best = entries[1]
	local bestScore = #(data.MAP_ID_DATA[best.mapId] or {})
	for i = 2, #entries do
		local entry = entries[i]
		local score = #(data.MAP_ID_DATA[entry.mapId] or {})
		if score > bestScore or (score == bestScore and entry.mapId < best.mapId) then
			best = entry
			bestScore = score
		end
	end
...
local function GetMapIdData(mapId)
	local mapIdData = data.MAP_ID_DATA
	return mapIdData and mapIdData[mapId] or nil
end


-- Export into addon namespace if available (addon loads after StartUp.lua which defines MOMR)
if _G.MOMR then
	MOMR.internal = MOMR.internal or {}
	MOMR.internal.treasure = {
		GetAllItemsData = GetAllItemsData,
		GetItemIdData = GetItemIdData,
		GetMapIdData = GetMapIdData,
		data = data,
	}
end

-- For reference, list of BOOK_IDs for surveys
--[[ 
data.BOOK_ID =
{
