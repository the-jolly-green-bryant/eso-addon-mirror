...
-- Last Updated October 17, 2018 by @tinydog
...
function tcc_SelectImprovementSkillRank(craftName, selectedRank, rankTbl, perUpgradeLabel)
	...
	-- Equivalent to ternary operator:  (itemTypeName == key) ? "down" : "up" 
	local greenQty = 	(craftName == "Jewelry") and tcc.ItemQuality.Green.JewelryUpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex] or tcc.ItemQuality.Green.UpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex]
	local blueQty = 	(craftName == "Jewelry") and tcc.ItemQuality.Blue.JewelryUpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex] or tcc.ItemQuality.Blue.UpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex]
	local purpleQty = 	(craftName == "Jewelry") and tcc.ItemQuality.Purple.JewelryUpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex] or tcc.ItemQuality.Purple.UpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex]
	local goldQty = 	(craftName == "Jewelry") and tcc.ItemQuality.Gold.JewelryUpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex] or tcc.ItemQuality.Gold.UpgradeMatQtyPerImprovementPassiveRank[improvementMatQtyIndex]
	...
	tcc.QualityMats[craftName].Green.MaterialQuantity =  (craftName == "Jewelry") and tcc.ItemQuality.Green.JewelryUpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank] or tcc.ItemQuality.Green.UpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank]
	tcc.QualityMats[craftName].Blue.MaterialQuantity =   (craftName == "Jewelry") and tcc.ItemQuality.Blue.JewelryUpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank] or tcc.ItemQuality.Blue.UpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank]
	tcc.QualityMats[craftName].Purple.MaterialQuantity = (craftName == "Jewelry") and tcc.ItemQuality.Purple.JewelryUpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank] or tcc.ItemQuality.Purple.UpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank]
	tcc.QualityMats[craftName].Gold.MaterialQuantity =   (craftName == "Jewelry") and tcc.ItemQuality.Gold.JewelryUpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank] or tcc.ItemQuality.Gold.UpgradeMatQtyPerImprovementPassiveRank[1 + selectedRank]
