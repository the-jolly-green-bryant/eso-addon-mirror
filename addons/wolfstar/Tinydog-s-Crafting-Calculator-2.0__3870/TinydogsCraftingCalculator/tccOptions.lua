...
function tcc_RegisterAddonSettingsMenu()
	...
	local optionsTable = {
		...
		[4] = {
			...
			text = "|cCFDCBDTo toggle TCC by pressing a single key:\n" .. 
				"From the game menu click |r|cFFFFFFControls|r|cCFDCBD > scroll down to |r|cFFFFFFTinydog's Crafting Calculator|r|cCFDCBD > click |r|cFFFFFFFirst Bind|r|cCFDCBD > press a key (e.g., |r|cFFFF00[F8]|r|cCFDCBD)|r",
		},
		[5] = {
			type = "header",
			name = "Global Options",
	...
	LAM:RegisterAddonPanel("tccOptions", panelData)
	LAM:RegisterOptionControls("tccOptions", optionsTable)
end
