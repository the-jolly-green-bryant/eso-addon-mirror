# =============================================================================
# Package GuildActivityTracker for ESO Console Upload
# Run this script from the GuildActivityTracker folder
# It creates a properly structured .zip ready for the Bethesda Uploader Tool
# =============================================================================

$addonName = "GuildActivityTracker"
...
$filesToInclude = @(
    "GuildActivityTracker.addon",
    "GuildActivityTracker.txt",
    "Bindings.xml",
    "GuildActivityTracker.lua",
    "GuildActivityTracker.xml",
    "GuildActivityTrackerUI.lua"
)
