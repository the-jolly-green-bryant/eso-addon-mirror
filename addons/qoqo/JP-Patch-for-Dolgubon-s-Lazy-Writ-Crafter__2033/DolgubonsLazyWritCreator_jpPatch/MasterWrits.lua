if WritCreater and WritCreater.patchedVersion and WritCreater.patchedVersion >= 4000 then return end
-----------------------------------------------------------------------------------
...
local function EnchantingMasterWrit(journalIndex, sealedText, reference)
	...
	local craftInfo = langInfo[CRAFTING_TYPE_ENCHANTING]
...
--        AddCustomMenuItem("Craft Sealed Writ", function ()
        AddCustomMenuItem("密封された依頼をクラフトする", function ()
-- jpPatch end
