...
function HGF.Menu.Initialize()
	...
	HGF.Menu.panel = {
		type = "panel",
		name = "HealersGroupFrame",
		displayName	= "Healers Group Frame",
		author = "ShaiT",
		version = HGF.version,
	...
	HGF.Menu.options = {
		...
		{
			type = "checkbox",
			name = "Indicate health regen change",
			tooltip = "Changes color of health bar based on change in health regen rates. This can for example be caused by a heal over time skill.",
			getFunc = function() return HGF.Menu.GetVar("showHealthRegen") end,
			setFunc = function(value) HGF.Menu.SetVar("showHealthRegen", value) end
		},
		...
		{
			type = "colorpicker",
			name = "Health regen increased color",
			tooltip = "Select color for HP bar when HP regen has been increased.",
			getFunc = function() return HGF.Menu.GetVar("incHealthRegenColor")[1], HGF.Menu.GetVar("incHealthRegenColor")[2], HGF.Menu.GetVar("incHealthRegenColor")[3] end,
			setFunc = function(r, g, b, a) HGF.Menu.SetVar("incHealthRegenColor", {r, g, b}) end,
		},
