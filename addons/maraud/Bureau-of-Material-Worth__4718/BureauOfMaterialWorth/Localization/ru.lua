...
local strings = {
    ...
    [SI_BMW_SETTING_PRICE_TREND_THRESHOLD_NAME] = "Существенное изменение цены (%)",
    [SI_BMW_SETTING_PRICE_TREND_THRESHOLD_TOOLTIP] = "Минимальный рост или спад для раздела «Динамика цен» за последние семь дней. Анализируются все движения внутри периода, поэтому короткий скачок за один-два дня останется видимым, даже если затем цена вернулась почти к исходной.",
    ...
    [SI_BMW_SETTING_NOTIFY_VISIT_TOOLTIP] = "Выкл: автоматических сообщений нет.\nСводка: стоимость ремесленной сумки при первом открытии за сессию.\nСущественные: сообщать об изменениях запасов не менее чем на 1%% и новых значимых ценовых сигналах за семь дней.\nПодробно: сводка и ценовые сигналы, результаты извлечения и завершённая подгрузка цен.",
    ...
    -- Аналитическая строка под «Прочим» и её семидневный список.
    [SI_BMW_PRICE_TREND_ROW] = "Динамика цен",
    [SI_BMW_PRICE_TREND_TOOLTIP_WINDOW] = "Сильнейшие движения цены в любой момент последних семи дней (порог: %d%%).",
    [SI_BMW_PRICE_TREND_TOOLTIP_GAINS] = "Сильный рост: %d",
    [SI_BMW_PRICE_TREND_TOOLTIP_LOSSES] = "Сильный спад: %d",
    [SI_BMW_PRICE_TREND_CLICK_HINT] = "Нажмите для просмотра динамики цен",
    [SI_BMW_PRICE_TREND_TITLE] = "Динамика цен",
    [SI_BMW_PRICE_TREND_GROUP] = "Анализ",
    [SI_BMW_PRICE_TREND_CONTEXT] = "%d сигналов · последние 7 дней · порог %d%%",
    [SI_BMW_PRICE_TREND_EMPTY] = "Пока ни одно изменение цены не достигло выбранного порога.",
    [SI_BMW_PRICE_TREND_EMPTY_HISTORY] = "История цен ещё копится. Материалу нужно два записанных наблюдения, прежде чем появится сигнал.",
    [SI_BMW_PRICE_TREND_COL_PRICE] = "Цена",
    [SI_BMW_PRICE_TREND_COL_OVERALL] = "За 7 дней",
    [SI_BMW_PRICE_TREND_COL_GAIN] = "Макс. рост",
    [SI_BMW_PRICE_TREND_COL_LOSS] = "Макс. спад",
    [SI_BMW_PRICE_TREND_COL_IMPACT] = "Влияние",
    [SI_BMW_PRICE_TREND_IMPACT_TOOLTIP_TITLE] = "Влияние на стоимость",
    [SI_BMW_PRICE_TREND_IMPACT_TOOLTIP_BODY] = "Сколько золота добавилось или потерялось на текущем количестве материала из-за разницы между текущей ценой за единицу и старейшим сопоставимым наблюдением за последние семь дней: (текущая цена - старая цена) x количество. Это не полная стоимость стака.",
    [SI_BMW_PRICE_TREND_OVERALL_TOOLTIP_TITLE] = "Изменение за семь дней",
    [SI_BMW_PRICE_TREND_OVERALL_TOOLTIP_BODY] = "Разница в процентах между самой ранней доступной записью цены в пределах последних семи дней и текущей ценой. Пока полная неделя ещё не накоплена, используется самое раннее доступное наблюдение.",
    [SI_BMW_PRICE_TREND_GAIN_TOOLTIP_TITLE] = "Максимальный рост",
    [SI_BMW_PRICE_TREND_GAIN_TOOLTIP_BODY] = "Наибольший процент роста между любыми более ранним и поздним наблюдениями цены за последние семь дней. Короткий скачок остаётся видимым, даже если затем цена снизилась обратно.",
    [SI_BMW_PRICE_TREND_LOSS_TOOLTIP_TITLE] = "Максимальный спад",
    [SI_BMW_PRICE_TREND_LOSS_TOOLTIP_BODY] = "Наибольший процент снижения между любыми более ранним и поздним наблюдениями цены за последние семь дней. Короткий спад остаётся видимым, даже если затем цена восстановилась.",
    [SI_BMW_PRICE_TREND_FOOTER_GAINS] = "Растут: %d",
    [SI_BMW_PRICE_TREND_FOOTER_LOSSES] = "Падают: %d",
    [SI_BMW_PRICE_TREND_TOOLTIP_SECTION] = "Движение за семь дней",
    [SI_BMW_PRICE_TREND_TOOLTIP_CURRENT] = "Текущая цена: %s",
    [SI_BMW_PRICE_TREND_TOOLTIP_OVERALL] = "От старейшей точки: %s",
    [SI_BMW_PRICE_TREND_TOOLTIP_MAX_GAIN] = "Максимальный рост: %s",
    [SI_BMW_PRICE_TREND_TOOLTIP_MAX_LOSS] = "Максимальный спад: %s",
    [SI_BMW_PRICE_TREND_TOOLTIP_IMPACT] = "Влияние на стоимость: %s",
    [SI_BMW_PRICE_TREND_TOOLTIP_POINTS] = "Сравнено наблюдений: %d",
    ...
    [SI_BMW_DETAIL_CUM_THRESHOLD_HINT] = "Золотая отметка: на этом материале накопленная доля достигает %d%%.",
    ...
    [SI_BMW_DETAIL_EMPTY_BAG] = "В ремесленной сумке нет материалов.",
    [SI_BMW_DETAIL_EMPTY_SEARCH] = "Поиску не соответствует ни один материал.",
    [SI_BMW_DETAIL_EMPTY_FILTER] = "Фильтру не соответствует ни один материал.",
    ...
    [SI_BMW_DETAIL_CONTEXT_SEARCH] = "Поиск «%s» · %d результатов · %s",
    ...
    [SI_BMW_DETAIL_LINK_HINT] = "Shift-клик — ссылка в чат",
    ...
    [SI_BMW_DETAIL_BTN_CHANGES] = "С момента снимка",
    ...
    [SI_BMW_DETAIL_REPLACE_CONFIRM_TITLE] = "Заменить снимок?",
    [SI_BMW_DETAIL_REPLACE_CONFIRM_BODY] = "Сохранённый снимок уже существует. Его замена перенесёт точку сравнения на текущее содержимое ремесленной сумки. Продолжить?",
    [SI_BMW_DETAIL_REPLACE_CONFIRM_ACCEPT] = "Заменить",
    [SI_BMW_DETAIL_REPLACE_CONFIRM_CANCEL] = "Отмена",
    [SI_BMW_DETAIL_BTN_BACK] = "Назад",
    [SI_BMW_DETAIL_BTN_BACK_TOOLTIP_TITLE] = "Назад к материалам",
    [SI_BMW_DETAIL_BTN_BACK_TOOLTIP_BODY] = "Вернуться к списку материалов.",
    [SI_BMW_DETAIL_DIFF_TITLE] = "Изменения с момента снимка (%s)",
    ...
    [SI_BMW_WITHDRAW_PRESET_MAX] = "Макс.",
    ...
    [SI_BMW_FOOTER_PRICES_TOOLTIP_BUSY] = "Обновление цен уже выполняется.",
    [SI_BMW_FOOTER_PRICES_REFRESHING] = "Обновление...",
    [SI_BMW_FOOTER_PRICES_REFRESHED] = "Обновлено",
    ...
    [SI_BMW_NET_TOOLTIP_CLICK] = "Нажмите, чтобы открыть все материалы ремесленной сумки",
    ...
    [SI_BMW_MSG_PRICE_TRENDS] = "Динамика цен · порог %d%%: %s.",
    [SI_BMW_MSG_PRICE_TREND_GAIN] = "рост цены «%s»: %s%%",
    [SI_BMW_MSG_PRICE_TREND_LOSS] = "снижение цены «%s»: %s%%",
    [SI_BMW_MSG_PRICE_TREND_MORE] = "и ещё %d",
    ...
    [SI_BMW_MSG_REFRESH_STARTED] = "Обновление цен запущено.",
    [SI_BMW_MSG_REFRESH_BUSY] = "Обновление цен уже выполняется.",
