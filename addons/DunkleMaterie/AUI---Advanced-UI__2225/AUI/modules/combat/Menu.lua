...
local function GetDefaultSettings()
	local defaultSettings =
	{
		...
		minimeter_show_background = false,
		minimeter_show_dps_out = true,
		minimeter_show_total_damage_out = true,
		minimeter_show_hps_out = false,
		minimeter_show_total_heal_out = false,
		...
		scrolling_text_damage_out_normal_font_art = "Sansita One",	
		...
		--Crital Damage
		scrolling_text_show_critical_damage_out = true,	
		scrolling_text_out_damage_crit_size = 34,
		scrolling_text_damage_out_crit_font_art = "Sansita One",
		...
		scrolling_text_heal_out_normal_font_art = "Sansita One",
		...
		--Critical Heal
		scrolling_text_show_critical_heal_out = true,
		scrolling_text_out_heal_crit_size = 34,		
		scrolling_text_heal_out_crit_font_art = "Sansita One",	
		...
		scrolling_text_damage_in_normal_font_art = "Sansita One",
		...
		scrolling_text_damage_in_crit_font_art = "Sansita One",	
		...
		scrolling_text_heal_in_normal_font_art = "Sansita One",
		...
		scrolling_text_heal_in_crit_font_art = "Sansita One",	
		...
		scrolling_text_exp_font_art = "Sansita One",
		...
		scrolling_text_cxp_font_art = "Sansita One",
		...
		scrolling_text_telvar_font_art = "Sansita One",	
		...
		scrolling_text_ap_font_art = "Sansita One",	
		...
		scrolling_text_combat_start_font_art = "Sansita One",
		...
		scrolling_text_combat_end_font_art = "Sansita One",
		...
		scrolling_text_instant_cast_font_art = "Sansita One",
		...
		scrolling_text_ultimate_ready_font_art = "Sansita One",
		...
		scrolling_text_potion_ready_font_art = "Sansita One",
		...
		scrolling_text_health_low_font_art = "Sansita One",
		...
		scrolling_text_magicka_low_font_art = "Sansita One",
		...
		scrolling_text_stamina_low_font_art = "Sansita One",
		...
		scrolling_text_health_reg_font_art = "Sansita One",
		...
		scrolling_text_magicka_reg_font_art = "Sansita One",
		...
		scrolling_text_stamina_reg_font_art = "Sansita One",
		...
		scrolling_text_health_dereg_font_art = "Sansita One",
		...
		scrolling_text_magicka_dereg_font_art = "Sansita One",
		...
		scrolling_text_stamina_dereg_font_art = "Sansita One",
		...
		--damage meter
		damage_meter_enabled = false,
		damage_meter_show_background = true,
		damage_meter_damage_mode = AUI_COMBAT_DATA_TYPE_DAMAGE_OUT,
		damage_meter_font_art = "ESO-FWNTLGUDC70 DB",
		damage_meter_font_size = 13,
		damage_meter_font_color = AUI.Color.ConvertHexToRGBA(DEFAULT_DAMAGE_METER_FONT_COLOR, 1),
		damage_meter_show_only_in_group = true,
		...
		weapon_charge_warner_enabled = true,
...
local function AcceptSettings()
	...
	AUI.Settings.Combat.damage_meter_enabled = damage_meter_enabled
		...
		table.insert(generalOptions,				
			{
				...
				default = GetDefaultSettings().scrolling_text_panel_animation[panelData.internName],		
			})
		...
		table.insert(generalOptions,
			{
				...
				default = GetDefaultSettings().scrolling_text_panel_animation_mode[panelData.internName],		
			})
		...
		{		
			...
			controls = 
			{
				...
				},	
				{
					...
					getFunc = function() return AUI.Settings.Combat.scrolling_text_damage_out_normal_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_damage_out_normal_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_damage_out_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_damage_out_normal_font_art,		
				},	
				{
					type = "dropdown",
					...
					default = GetDefaultSettings().scrolling_text_damage_out_parent_panelName,	
				},					
				{
					type = "checkbox",
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_damage_out_crit_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_damage_out_crit_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_damage_out_crit_parent_panelName)			
					end,
					default = GetDefaultSettings().scrolling_text_damage_out_crit_font_art,		
				},		
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_damage_out_crit_parent_panelName,	
				},					
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_heal_out_normal_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_heal_out_normal_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_heal_out_parent_panelName)		
					end,
					default = GetDefaultSettings().scrolling_text_heal_out_normal_font_art,		
				},		
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_heal_out_parent_panelName,	
				},					
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_heal_out_crit_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_heal_out_crit_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_heal_out_crit_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_heal_out_crit_font_art,		
				},
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_heal_out_crit_parent_panelName,	
				},					
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_damage_in_normal_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_damage_in_normal_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_damage_in_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_damage_in_normal_font_art,		
				},		
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_damage_in_parent_panelName,	
				},					
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_damage_in_crit_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_damage_in_crit_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_damage_in_crit_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_damage_in_crit_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_damage_in_crit_parent_panelName,	
				},						
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_heal_in_normal_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_heal_in_normal_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_heal_in_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_heal_in_normal_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_heal_in_parent_panelName,	
				},				
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_heal_in_crit_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_heal_in_crit_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_heal_in_crit_parent_panelName)			
					end,
					default = GetDefaultSettings().scrolling_text_heal_in_crit_font_art,		
				},			
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_heal_in_crit_parent_panelName,	
				},					
				{
					type = "checkbox",
					name = AUI.L10n.GetString("assembling_value"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_exp_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_exp_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_exp_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_exp_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_exp_parent_panelName,	
				},									
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_cxp_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_cxp_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_cxp_parent_panelName)			
					end,
					default = GetDefaultSettings().scrolling_text_cxp_font_art,		
				},		
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_cxp_parent_panelName,	
				},									
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_telvar_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_telvar_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_telvar_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_telvar_font_art,		
				},
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_telvar_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_ap_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_ap_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_ap_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_ap_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_ap_parent_panelName,	
				},										
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_combat_start_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_combat_start_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_combat_start_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_combat_start_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_combat_start_parent_panelName,	
				},					
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_combat_end_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_combat_end_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_combat_end_panelName)		
					end,
					default = GetDefaultSettings().scrolling_text_combat_end_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_combat_end_panelName,	
				},				
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},				
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_instant_cast_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_instant_cast_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_instant_cast_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_instant_cast_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_instant_cast_parent_panelName,	
				},					
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},				
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_ultimate_ready_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_ultimate_ready_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_ultimate_ready_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_ultimate_ready_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_ultimate_ready_parent_panelName,	
				},					
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},					
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_potion_ready_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_potion_ready_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_potion_ready_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_potion_ready_font_art,		
				},		
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_potion_ready_parent_panelName,	
				},					
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_health_low_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_health_low_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_health_low_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_health_low_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_stamina_low_parent_panelName,	
				},									
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_magicka_low_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_magicka_low_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_magicka_low_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_magicka_low_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_stamina_low_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_stamina_low_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_stamina_low_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_stamina_low_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
				...
				},					
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_health_reg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_health_reg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_health_reg_parent_panelName)			
					end,
					default = GetDefaultSettings().scrolling_text_health_reg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_health_reg_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},				
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_magicka_reg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_magicka_reg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_magicka_reg_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_magicka_reg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_magicka_reg_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_stamina_reg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_stamina_reg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_stamina_reg_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_stamina_reg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_stamina_reg_parent_panelName,	
				},									
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_health_dereg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_health_dereg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_health_dereg_parent_panelName)					
					end,
					default = GetDefaultSettings().scrolling_text_health_dereg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_health_dereg_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_magicka_dereg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_magicka_dereg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_magicka_dereg_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_magicka_dereg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_magicka_dereg_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
				...
				},	
				{
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.scrolling_text_stamina_dereg_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.scrolling_text_stamina_dereg_font_art = value
						AUI.Combat.Text.UpdatePreview(AUI.Settings.Combat.scrolling_text_stamina_dereg_parent_panelName)				
					end,
					default = GetDefaultSettings().scrolling_text_stamina_dereg_font_art,		
				},	
				{
					type = "dropdown",
					name = AUI.L10n.GetString("panel"),
					...
					default = GetDefaultSettings().scrolling_text_stamina_dereg_parent_panelName,	
				},								
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("color"),
...
local function GetDamageMeterOptions()
	local optionsTable = 
	{	
		{		
			type = "submenu",
			name = AUI_TXT_COLOR_SUBMENU:Colorize(AUI.L10n.GetString("damage_meter")),
			controls = 
			{		
				{
					type = "checkbox",
					name = AUI.L10n.GetString("show_background"),
					getFunc = function() return AUI.Settings.Combat.damage_meter_show_background end,
					setFunc = function(value)
						AUI.Settings.Combat.damage_meter_show_background = value
						AUI.Combat.DamageMeter.UpdatePreview()
					end,
					default = GetDefaultSettings().damage_meter_show_background,
					width = "full",
				},
				{
					type = "checkbox",
					name = AUI.L10n.GetString("show_only_in_group"),
					getFunc = function() return AUI.Settings.Combat.damage_meter_show_only_in_group end,
					setFunc = function(value)
						AUI.Settings.Combat.damage_meter_show_only_in_group = value
						AUI.Combat.DamageMeter.UpdatePreview()
					end,
					default = GetDefaultSettings().damage_meter_show_only_in_group,
					width = "full",
				},				
				{
					type = "dropdown",
					...
					tooltip = AUI.L10n.GetString("font_art_tooltip"),
					choices = LMP:List(LMP.MediaType.FONT),
					getFunc = function() return AUI.Settings.Combat.damage_meter_font_art end,
					setFunc = function(value) 		
						AUI.Settings.Combat.damage_meter_font_art = value
						AUI.Combat.DamageMeter.UpdatePreview()			
					end,
					default = GetDefaultSettings().damage_meter_font_art,		
				},	
				{
					type = "slider",
					name = AUI.L10n.GetString("size"),
					...
					max = 16,
					step = 1,
					getFunc = function() return AUI.Settings.Combat.damage_meter_font_size end,
					setFunc = function(value) 
						AUI.Settings.Combat.damage_meter_font_size = value
						AUI.Combat.DamageMeter.UpdatePreview()
					  end,
					default = GetDefaultSettings().damage_meter_font_size,
					width = "full",
				},	
				{
					type = "colorpicker",
					name = AUI.L10n.GetString("font_color"),
					getFunc = function() return AUI.Color.GetColorDefFromNamedRGBA(AUI.Settings.Combat.damage_meter_font_color):UnpackRGBA() end,
					setFunc = function(r,g,b,a) 
						AUI.Settings.Combat.damage_meter_font_color = {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a}	
						AUI.Combat.DamageMeter.UpdatePreview()
					end,
					default = GetDefaultSettings().damage_meter_font_color,
					width = "full",
				},				
				{
					type = "header",
				},				
				{
					...
					name = AUI.L10n.GetString("reset_to_default_position"),
					tooltip = AUI.L10n.GetString("reset_to_default_position_tooltip"),
					func = function() AUI.Combat.DamageMeter.SetToDefaultPosition(GetDefaultSettings()) end,
				},					
			}
		},
	}
...
local function CreateOptionTable()
	...
	{	
		...
		},
		{
			...
			getFunc = function() return AUI.MainSettings.modul_combat_account_wide end,
			setFunc = function(value)
						AUI.MainSettings.modul_combat_account_wide = value
						ReloadUI()
			end,
			default = true,
			width = "full",
		...
		{		
			...
			{	
				...
				{
					type = "checkbox",
					name = AUI.L10n.GetString("damage_meter") .." (" .. AUI.L10n.GetString("currently_not_supported") .. ")",
					getFunc = function() return damage_meter_enabled end,
					setFunc = function(value)
						damage_meter_enabled = value
						changed = true
					end,
					default = GetDefaultSettings().damage_meter_enabled,
					width = "full",
					warning = AUI.L10n.GetString("reloadui_manual_warning_tooltip"),
					disabled = true,
				},					
	...
	if damage_meter_enabled then
		local damageMeterTextOptions = GetDamageMeterOptions()
		for i = 1 , #damageMeterTextOptions do 
			table.insert(optionsTable, damageMeterTextOptions[i]) 
		end		
	end		
	...
	LAM:RegisterOptionControls("AUI_Menu_Combat", optionsTable)
end

local function LoadSettings()
	if AUI.MainSettings.modul_combat_account_wide then
		AUI.Settings.Combat = ZO_SavedVars:NewAccountWide("AUI_Combat", 4, nil, GetDefaultSettings())
		AUI.Settings.Combat.Fights = ZO_SavedVars:NewAccountWide("AUI_Combat_Fights", 1, nil, GetDefaultFightData())
	else
		AUI.Settings.Combat = ZO_SavedVars:New("AUI_Combat", 4, nil, GetDefaultSettings())
		AUI.Settings.Combat.Fights = ZO_SavedVars:New("AUI_Combat_Fights", 1, nil, GetDefaultFightData())
	end		
	
	minimeter_enabled = AUI.Settings.Combat.minimeter_enabled
	scrolling_text_enabled = AUI.Settings.Combat.scrolling_text_enabled
	damage_meter_enabled = AUI.Settings.Combat.damage_meter_enabled
	weapon_charge_warner_enabled = AUI.Settings.Combat.weapon_charge_warner_enabled
end

function AUI.Combat.SetMenuData()
	if isLoaded then
		return
	end
	...
	AUI.Settings.Combat.damage_meter_enabled = false
	
	LAM:RegisterAddonPanel("AUI_Menu_Combat", panelData)
