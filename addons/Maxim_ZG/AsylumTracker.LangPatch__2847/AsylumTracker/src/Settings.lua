...
local locales = {
     ...
     ["Deutsche"] = "de",
	 ["Español"] = "es",
	 ["Japanese"] = "jp", -- "jp" is the code the game itself returns on the Japanese client (GetCVar), so the file is jp.lua
	 ["中文"] = "zhj",
	 ["Chinese"] = "zh",
}
...
function AST.CreateSettingsWindow()
     ...
     local panelData = {
          ...
          author = "|cAD601C" .. AST.author .. "|r, moded |c02fcffLost.Seeker|r",
     ...
     local Settings = {
          ...
          {
               type = "checkbox",
               name = AST_SETT_OSI_SUPPORT,
               tooltip = AST_SETT_OSI_SUPPORT_TOOL,
               getFunc = function() return sv.osi_support end,
               setFunc = function(value) sv.osi_support = value end,
               default = true,
               disabled = function() return OSI == nil end, -- Greyed out if OdySupportIcons is not installed
               width = "full",
          },
          {
               type = "checkbox",
          ...
          },
          {
               ...
               controls = {
                    ...
                    {
                         type = "checkbox",
                         name = AST_SETT_BLAST_OSI,
                         getFunc = function() return sv.defiling_blast_osi end,
                         setFunc = function(value) sv.defiling_blast_osi = value end,
                         default = true,
                         disabled = function() return OSI == nil or not sv.osi_support or not sv.defiling_blast end,
                         width = "full",
                    },
                    {
                         type = "slider",
                    ...
                    {
                         type = "checkbox",
                         name = AST_SETT_JUMP_OSI,
                         getFunc = function() return sv.teleport_strike_osi end,
                         setFunc = function(value) sv.teleport_strike_osi = value end,
                         default = true,
                         disabled = function() return OSI == nil or not sv.osi_support or not sv.teleport_strike end,
                         width = "full",
                    },
                    {
                         type = "slider",
                    ...
                    {
                         type = "checkbox",
                         name = AST_SETT_MAIM_OSI,
                         getFunc = function() return sv.maim_osi end,
                         setFunc = function(value) sv.maim_osi = value end,
                         default = true,
                         disabled = function() return OSI == nil or not sv.osi_support or not sv.maim end,
                         width = "full",
                    },
                    {
                         type = "slider",
          ...
          },
          {
               ...
               controls = {
                    ...
                    },
                    {
                         ...
                         choices = {"English", "Russian", "Français", "Deutsche", "Español", "Japanese", "中文", "Chinese"},
                         getFunc = function()
