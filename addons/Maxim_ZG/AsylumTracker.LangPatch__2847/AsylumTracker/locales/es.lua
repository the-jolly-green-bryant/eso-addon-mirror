...
-- Spanish client names (from ESO Logs): "San Llothis el Pío" and "San Felms el Osado".
-- Matched as plain substrings, so the distinctive part of each name is enough.
AST.lang.es.bossNames = {
     llothis = { "Llothis" },
     felms = { "Felms" },
}

-- Spanish client has no addon translation yet, so the UI strings are kept in English (same as the original en.lua).
local locale_strings = {
     ...
     ["AST_SETT_OSI_SUPPORT"] = "Compatibilidad con OdySupportIcons",
     ["AST_SETT_OSI_SUPPORT_TOOL"] = "Muestra marcadores sobre los jugadores mediante OdySupportIcons para las mecánicas de los jefes (requiere el complemento OdySupportIcons)",
     ...
     ["AST_SETT_BLAST_OSI"] = "Icono de OdySI",
     ...
     ["AST_SETT_JUMP_OSI"] = "Icono de OdySI",
     ...
     ["AST_SETT_MAIM_OSI"] = "Icono de OdySI",
...
function AST.lang.es.LoadStrings()
