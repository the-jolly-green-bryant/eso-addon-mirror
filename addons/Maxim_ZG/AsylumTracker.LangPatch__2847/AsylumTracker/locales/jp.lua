...
-- Boss name fragments on the Japanese client (matched as plain substrings of the unit name).
AST.lang.jp.bossNames = {
     llothis = { "ロシス" },
     felms = { "フェルムス" },
}
...
local locale_strings = {
     ...
     ["AST_SETT_OSI_SUPPORT"] = "OdySupportIcons サポート",
     ["AST_SETT_OSI_SUPPORT_TOOL"] = "OdySupportIcons を使ってボスギミック用マーカーをプレイヤーの頭上に表示します（アドオン OdySupportIcons が必要）",
