...
--Delete
DeleteMailConfirm ="你确定要销毁附件或附件的金币吗?",
...
PvPmodeAnnouncementDesc="在聊天栏显示PvP模式公告",
ChampionHelper	="勇士系统助手",
ChampionHelperDesc	="在勇士系统界面记住技能和应用记住的勇士系统配置\n"..default..(BUI.Defaults.ChampionHelper and on or off),
DisableHelpAnnounce ="禁用启动公告",
DisableHelpAnnounceDesc ="禁用游戏手柄和辅助功能模式警告公告.",
GamepadHelpAnnouncement ="您当前处于游戏手柄模式，BUI 不完全支持该模式.",
AccessibilityHelpAnnouncement ="您当前处于辅助功能模式，这可能会导致 BUI 和其他插件出现问题.",
...
ShieldGroup="护盾",
ShieldGroupDesc="在栏上显示护盾",
TraumaGroup = "创伤",
TraumaGroupDesc = "在栏上显示创伤",
--Stats share
StatShare	="分享状态",
...
FullSwapPanel	="显示完整交换面板",
FullSwapPanelDesc	="显示整个交换面板\n"..default..(BUI.Defaults.UseSwapPanel and on or off),
