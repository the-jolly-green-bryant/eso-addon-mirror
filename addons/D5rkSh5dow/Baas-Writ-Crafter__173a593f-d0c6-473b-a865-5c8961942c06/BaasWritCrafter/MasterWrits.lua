...
local BaasDebugRunningDebugString = ""
local BaasGlobalDebugToggle = false
...
function BaasGlobalDebugOutput(...)
	if false and (BaasGlobalDebugToggle or localDebugToggle) then
		d(...)
	else
		local t = {...}
		for i = 1, #t do
			local str = t[i]
			str = tostring(str)
			BaasDebugRunningDebugString = BaasDebugRunningDebugString.."\n"..str
			if string.len(BaasDebugRunningDebugString)>2100 then
				BaasDebugRunningDebugString = string.sub(BaasDebugRunningDebugString, string.len(BaasDebugRunningDebugString)-2099)
			end
		end
	end
end
