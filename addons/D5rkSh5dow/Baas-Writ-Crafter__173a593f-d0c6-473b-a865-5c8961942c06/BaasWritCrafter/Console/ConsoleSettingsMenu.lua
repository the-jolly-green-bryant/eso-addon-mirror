...
WritCreater.settings["panel"] =  
{
     ...
     displaylabel = "|c8080FF Baas Writ Crafter|r",
     author = "@Baas",
...
function WritCreater.initializeSettingsMenu()
    ...
    local settingsMenuName = "|c8080FFBaas Writ Crafter|r"
    if false then -- dev block -- trebuchet it to the start of the list
        settingsMenuName = "|c8080FFBaas Writ Crafter|r"
    end
