...
-- File Description: Japanese Localization (Translated by qoqo and Calamath: last update Feb.17, 2026)
...
WritCreater.strings['masterWritSave']			= "Baas Writ Crafterは、あなたが誤ってマスター依頼を受諾してしまうのを防ぎました! 設定メニューでこの機能をオフにできます"
WritCreater.strings['missingLibraries']			= "Baas Writ Crafterには次のスタンドアロンライブラリが必要です。ダウンロードしてインストールするかライブラリをオンにしてください: "
...
WritCreater.strings['welcomeMessage']				= "Baas Writ Crafterをインストールしていただきありがとうございます！アドオンの動作をカスタマイズするための設定をご確認ください"
...
WritCreater.optionStrings["skinOptions"]								= {"標準", "チーズくさい", "山羊っぽい", "キラキラ"}
WritCreater.optionStrings["goatSkin"]									= "山羊っぽい"
WritCreater.optionStrings["cheeseSkin"]									= "チーズくさい"
WritCreater.optionStrings["fabulousSkin"]								= "キラキラ"
...
=
{
	...
	['menuName'] = "|cFFBF00黄鉄鉱の追跡|r",
	['initialDescription'] = "まずパンフレットを読んで(/read)みてはいかがでしょうか？",
	['readDescription'] = "クラフター長が加工されたゴミを自動生成するクラフトアドオンを使っていることを知った後、創造者の君主は新しい主任クラフターを探しています！ この仕事に挑戦してみよう！",
	['endeavorName'] = "黄鉄鉱の追跡",-- Note for translation: Pyrite, aka Fool's Gold. Play on Fool = Crazy =  Sheogorath, Fool in April Fools, and Golden Pursuits, bc that's where this lives
	['completionShout'] = "<<1>>/<<2>> |cFFBF00黄鉄鉱の追跡|rを完了した！", -- e.g. 1/6 pyrite pursuit completed!
	['tasks']={
		-------------------------
		...
		-------------------------
		{original="あなたは「人材募集」と題されたパンフレットを見つけた．．．多分それを読む(/read)べきです。",name="見つけたパンフレットを読む",placehold="創造者の君主からの求人パンフレットを見つけた", completion = "創造者の君主が求人しているようだが？",
			description="あなたは「人材募集」と書かれたパンフレットを見つけました。感情表現の読む(/read)を使って読むことができます", completedDescription="パンフレットを読んだ"},

		{original="???", name = "ロバジャックを作る", completion = "誰かをチーズに変えることはできないようだが、それでもあなたの見た目は変わります！",
			description="詐欺師シェオおじさんは変身するのがお好き。ロバー（盗賊）のジャック（上着）、つまり大胆な海賊セットの胴当てを作成して、盗賊に変身しよう！", 
			completedDescription="やがてロバジャックはワバジャックと同じくらい強力になるだろう"}, -- requires 3 traits

		{original="???", name = "煌者のアミュレットを作る", completion = "このネックレス、あなたにピッタリよ！身につけた姿があなたにも見えたらいいのに",
			description="狂気の王は金持ちだ！ キラキラに煌めく琥珀金のネックレスを作って、彼の富を利用してみせよう！",
		completedDescription="本物の金属で作られているのに、身に着けると消えてしまうようです．．．権力の象徴なのかしら？"},

		{original="???", name = "黒檀の刀剣を作る", completion = "これは魂を吸い取るものじゃなかったっけ？ 間違えたかもしれないな",
			description="災厄の四柱神は、使い手を狂気に陥れるという黒檀の刀剣の能力を再現したいとお考えです。刃のついた黒檀製の武器を作ることで協力できることを示そう",
		completedDescription="黒檀の刀剣、こんなのになんて地味な名前．．．いや、この刀剣はごくありふれたものだから、この名前はまさにぴったりだ。"},

		{original="???", name = "マグナス|L0:0:0:40%%:20%%:|lの贈物|lの杖を作る", completion = "マグナス|L0:0:0:40%%:20%%:|lの贈物|lの力はあなたのものだ！",
		description="不在の主の主任クラフターは、|L0:0:0:50%%:10%%:|l強力な|l杖を作れる必要があります。マグナスの贈物セットの杖を作ろう",
		completedDescription="残念ながら、名前のなかの厄介な|L0:0:0:50%%:10%%:|lの贈物|lの部分を無視しても、これ以上強力にはならなかった"}, -- requires 4 traits

		{original="???", name = "チーズケーキは嘘だを焼く", completion = "チーーーズケーキ．．間違いなく十分に本物っぽいぞ",
		description="スクゥーマの猫はチーズケーキが大好き！ 主任クラフターには最高のケーキを焼く能力が求められます",completedDescription="あなたはチーズケーキを焼き、それが本物だと確信している"},
	},
	["unknownMonumentalTask"] = "パンフレットを読んで課題を明らかにする",
	['claimRewardHeader'] = "|cFFBF00黄鉄鉱の追跡|rを楽しんでいただけましたでしょうか！",
	['claimRewardSubheading'] = "今度クラフトデイリーをやるときに、Writ Crafterアドオンの新しい外観をチェックしてみてください！",
	...
	["bookText"] = 
[=[
クラフター長が加工されたゴミを自動生成するクラフトアドオンを使っていることを知った後、創造者の君主は新しい主任クラフターを探しています！（彼には依然としてクラフター長がいますが、身体がなければ役に立たない）

ご応募の際は、以下の作品をご持参ください。
・ロバジャック
・煌者のアミュレット
・マジで本物の黒檀の刀剣
・マグナス|L0:0:0:40%%:20%%:|lの贈物|lの杖
・チーズケーキは嘘だ
]=],
	["bookTitle"] = "人材募集",
	["superAmazingCraftSounds"] = { 
		-- Translation notes: These are displayed randomly when crafting around the screen
		{"カヵン","カコッ","カンッ","カカッ","チチッ"}, -- Blacksmithing sounds
		{"チョキッ","ザクッ","カサッ","チョキチョキ"}, -- Clothing sounds
		{"ジリッ","シュイィン","ドゴッ","ゴゴゴ","ピキッ","ヒュォン"}, -- Enchanting sounds
		{"ピチャ","ポチャ","ポコッ","プクプク","ゴポッ"}, -- Alchemy sounds
		{"ザクッ","トントン","ジューッ","グツグツ","コトコト"}, -- Cooking sounds
		{"ギィーコ","コンコン","カンッ","トンッ","シャーッ"}, -- Woodworking sounds
		{"ジーーコ","チリッ","カッカッ","キィン","シュッ"}, -- Jewelry sounds
	},
