...
function WritCreater.surveyNames() --Exacts!!!  I know for german alchemy writ is Alchemistenschrieb - so ["G"] = schrieb, and ["A"]=Alchemisten
	local names = {
	["G"] = "Commande",
	[CRAFTING_TYPE_ENCHANTING] = "d'enchantement",
	[CRAFTING_TYPE_BLACKSMITHING] = "forge",
	...
	[CRAFTING_TYPE_WOODWORKING] = "bois",
	[CRAFTING_TYPE_ALCHEMY] = "d'alchimie",
	[CRAFTING_TYPE_JEWELRYCRAFTING] = "joaillier",
	}
	return names
end
...
WritCreater.strings["includesStorage"]				= function(type) local a= {"repérages", "commande de maître"} a = a[type] return zo_strformat("Le total inclus <<1>> qui sont dans les coffres de domicile", a) end
WritCreater.strings["surveys"]						= "Repérages d'artisanat"
WritCreater.strings["sealedWrits"]					= "Commandes scellées"
WritCreater.strings["withdrawItem"]				= function(amount, link, remaining) return "Baas Writ Crafter a récupéré " .. amount .. " " .. link .. " (reste en banque : " .. remaining .. ")." end -- in Bank for German
WritCreater.strings['fullBag']						= "Vous n’avez plus de place dans votre sac. Merci de le vider."
WritCreater.strings['masterWritSave']				= "Baas Writ Crafter vous a évité d’accepter accidentellement une commande de maître ! Allez dans le menu Réglages > Extensions pour désactiver cette option."
WritCreater.strings['missingLibraries']			= "Baas Writ Crafter a besoin des librairies indépendantes suivantes. Merci de télécharger, installer ou activer ces librairies :"
...
WritCreater.strings["alchemyNoCombo"] = "Pas pu trouver une combinaison connue de réactifs assez bon marché. Essayez d'acquérir d'autres objets d'alchimie"
WritCreater.strings["alchemyMissing"] = "Il vous manque  <<list of items missing>>  pour fabriquer la combinaison la moins chère "
WritCreater.strings["alchemyLowPassive"] = "Vous avez sélectionné de fabriquer une pile complète, mais vous n'avez pas les compétences passives d'artisanat activées "
WritCreater.strings["alchemyCraftReqs"] = "Fabriquer va utiliser <<t:4>> <<t:1>>, <<t:4>> <<t:2>>, et <<t:4>> <<t:3>>"
WritCreater.strings["alchemyMasterReqs"] = "<<t:1>>: Favrique un <<t:2>> avec <<t:3>>, <<t:4>>, et <<t:5>>"
WritCreater.strings["depositGold"] = "Writ Crafter: Dépose <<1>> or"
WritCreater.strings["depositItemMissing"] = "Writ Crafter: Pas pu trouver <<t:1>> à déposer. L'objet a peut être été détruit ou déplacé"
WritCreater.strings["depositItem"] = "Writ Crafter: Dépose <<t:1>>"
WritCreater.strings["welcomeMessage"] = "Merci d'avoir installé Baas Writ Crafter! Allez s'il vous plait vérifier les réglages pour customiser le comportement de l'addon"
WritCreater.strings["keybindStripBlurb"] = "Objets de commandes d'artisanat"
WritCreater.strings["pressToCraft"] = "Appuyez sur <<Picture of button>> pour fabriquer"
WritCreater.strings["goldenPursuitCraft"] = "Fabriquer les objets de sets pour les poursuites dorées restantes ? (il est possible que cela ne soit pas possible. Hache/Arc/Bague/Robe seulement, utilise du fer)"
WritCreater.strings["fullInventory"] = "Votre inventaire est plein"
WritCreater.strings["provisioningUnknownRecipe"] = "Vous ne connaîssez pas la recette pour <<1>>"
WritCreater.strings["provisioningCraft"] = "Writ Crafter va fabriquer <<1>>"
WritCreater.strings["transmuteLooted"] = "<<1>> Cristaux de transmutation reçus (Vous en avez <<2>>)"
WritCreater.strings["transmuteLimitApproach"] = "Vous vous approchez de la limite de cristaux de transmutation. Si une boîte va vous faire dépasser cette limite, Writ Crafter ne vas pas prendre les cristaux."
WritCreater.strings["transmuteLimitHit"] = "Prendre ces cristaux de trasmutation vous mettrait au dessus du maximum, donc <<1>> cristaux de transmutation n'ont pas été pris"
WritCreater.strings["lootingMarkJunk"] = "Writ Crafter: A marqué <<1>> comme rebut"
WritCreater.strings["lootingDestroyItem"] = "Writ Crafter: A détruit <<1>> car vous l'avez indiqué dans les paramètres"
WritCreater.strings["lootingDeconItem"] = "Writ Crafter: A mis <<1>> dans la queue des objets à déconstruire"
WritCreater.strings["lootingDeposit"] = "Writ Crafter: <<1>> objets ont été mis dans la queue pour déposer à la banque"
WritCreater.strings["mailComplete"] = "Writ Crafter: Rafle de courrier terminée"
WritCreater.strings["mailNumLoot"] = "Writ Crafter: <<1>> courriers de fournisseurs trouvés"
WritCreater.strings["masterRecipeUnknown"] = "<<t:1>>: N'a pas pu être ajouté à la queue car vous n'avez pas la recette pour <<t:2>>"
WritCreater.strings["masterEnchantCraft"] = "<<t:1>>: Fabrique <<t:2>>"
WritCreater.strings["masterRecipeCraft"] = "<<t:1>>: Fabrique <<t:3>>x<<t:2>>"
WritCreater.strings["masterRecipeError"] = "<<1>>: N'a pas pu être ajouté à la queue de commandes. Il est possible que vous ne connaîssiez pas la recette"
WritCreater.strings["masterQueueNotFound"] = "N'a pas pu déterminer combien d'objets à fabriquer. Essayer d'accepter la commande."
WritCreater.strings["masterQueueBlurb"] = "Commande d'artisanat"
WritCreater.strings["masterQueueSummary"] = "Writ Crafter a mis dans la queue <<1>> commandes de maître"
WritCreater.strings["abandonQuestBanItem"] = "Writ Crafter a abandonné <<1>> car il requiert <<2>> qui a été exclu d'utilisation dans les paramètres"
WritCreater.strings["writBufferNotification"] = "Le buffer de quêtes de commandes d'artisanat de Lazy Writ Crafter™ vous empêche d'accepter cette quête"
WritCreater.strings["masterStopAcceptNoCraftSkill"] = "Lazy Writ Crafter™ vous a empêché d'accepter cette commande d'artisanat car vous ne pouvez pas la fabriquer"
WritCreater.strings["statsWitsDone"] = "Commandes d'artisanat faites : <<1>> durant les <<2>> derniers jours"
WritCreater.strings["deconstructSuccess"] = "Writ Crafter: A déconstruit <<1>>"
WritCreater.strings['potion']						= "potion"
WritCreater.strings['poison']						= "poison"
WritCreater.strings['npcStyleStoneReminder'] = "Rappel: Vous pouvez acheter une pierre de style raciale de base chez n'importe quel PNJ vendeur d'artisanat pour 15g"
...
WritCreater.optionStrings["skinOptions"]								= {"Défaut", "Gratiné", "Chèvre", "Fabulous"}
...
WritCreater.optionStrings["alchemyChoices"] = {"Désactivé" , "Toutes fonctions" , "Pas de fabrique automatique"}
WritCreater.optionStrings["despawnBankerDeposit"] = "Quitter et désinvoquer le banquier (Dépôts)"
WritCreater.optionStrings["despawnBankerDepositTooltip"] = "Désinvoquer le banquier automatiquement après avoir déposé les objets"
WritCreater.optionStrings["craftMultiplierConsumables"] = "Multiplicateur d'artisanat (alchimie et cuisine)"
WritCreater.optionStrings["craftMultiplierConsumablesTooltip"] = "Fabrication simple va fabriquer un objet, lequel peut être multiplié grâce aux compétances passives. Pile complète va fabriquer 100 objets demandés si les compétances passives sont activées"
WritCreater.optionStrings["craftMultiplierConsumablesChoices"] = {"Fabrication simple" , "Pile complète"}
WritCreater.optionStrings["currencyReward"] = "Devise or"
WritCreater.optionStrings["currencyRewardTooltip"] = "Que faire avec l'or donné en récompense des quêtes"
WritCreater.optionStrings["goldMatReward"] = "Matériaux d'or (Non ESO+ seulement)"
WritCreater.optionStrings["goldMatRewardTooltip"] = "Que faire avec les materiaux or provenant des récompenses de commandes d'artisanat. Ignoré pour les souscrivants à ESO+"
WritCreater.optionStrings["scan for unopened"] = "Ouvrir les Boîtes au démarrage de la session"
WritCreater.optionStrings["scan for unopened tooltip"] = "Quand la session démarre, scanner l'inventaire pour trouver des contenants de commandes d'artisanat et essayer de les ouvrir"
WritCreater.optionStrings["smart style slot save"] = "Quantité la plus basse d'abord"
WritCreater.optionStrings["smart style slot save tooltip"] = "Va essayer d'optimiser les emplacements utilisés si non ESO+ en utilisant les plus petites piles de pierres de style en premier "
WritCreater.optionStrings["abandon quest for item"] = "Commandes avec 'livrez <<1>>'"
WritCreater.optionStrings["abandon quest for item tooltip"] = "Si désactivé, va abandonner automatiquement les commandes d'artisanat demandant de livrer des <<1>>. Les quêtes vous demandant de fabriquer un objet nécessitant des <<1>> ne seront jamais abandonnées"
WritCreater.optionStrings["status bar submenu"] = "Barre d'état"
WritCreater.optionStrings["status bar submenu tooltip"] = "Options pour la barre d'état de commandes d'artisanat"
WritCreater.optionStrings["showStatusBar"] = "Afficher la barre d'état"
WritCreater.optionStrings["showStatusBarTooltip"] = "Afficher ou cacher la barre d'état de quêtes"
WritCreater.optionStrings["statusBarIcons"] = "Utiliser les icônes"
WritCreater.optionStrings["statusBarIconsTooltip"] = "Affiche des icônes d'artisanat à la place des lettres pour chaque type d'artisanat"
WritCreater.optionStrings["transparentStatusBar"] = "Barre d'état transparente"
WritCreater.optionStrings["transparentStatusBarTooltip"] = "Rendre la barre d'état transparente"
WritCreater.optionStrings["statusBarInventory"] = "Inspecteur d'inventaire "
WritCreater.optionStrings["statusBarInventoryTooltip"] = "Ajouter un inspecteur d'inventaire (nombre d'emplacements libres/total) à la barre d'état"
WritCreater.optionStrings["incompleteColour"] = "Couleur pour les quêtes en cours"
WritCreater.optionStrings["completeColour"] = "Couleur pour les quêtes terminées"
WritCreater.optionStrings["smartMultiplier"] = "Multiplicateur intelligent"
WritCreater.optionStrings["smartMultiplierTooltip"] = "Si activé, Writ Crafter va fabriquer les objets pour un cycle complet de 3 jours de commandes. Il va aussi vérifier si vous avez des objets déjà fabriqués et les prendre en compte. Si désactivé, Writ Crafter va simplement fabriquer plusieurs objets pour les commandes d'artisanat de la journée"
WritCreater.optionStrings["craftHousePort"] = "Se téléporter à la maison d'artisanat"
WritCreater.optionStrings["craftHousePortTooltip"] = "Se téléporter à une maison d'artisanat accessible publiquement"
WritCreater.optionStrings["craftHousePortButton"] = "Se téléporter"
WritCreater.optionStrings["reportBug"] = "Signaler un bug"
WritCreater.optionStrings["reportBugTooltip"] = "Ouvrir un rapport de bug spécifique à la version console de writ crafter. Vérifiez s'il vous plaît que le problème n'a pas déja été signalé."
WritCreater.optionStrings["openUrlButtonText"] = "Ouvrir l'URL"
WritCreater.optionStrings["writStats"] = "Statistiques de commandes d'artisanat"
WritCreater.optionStrings["writStatsTooltip"] = "Voir l'historique des stats de commandes fabriquées depuis que l'addon est installé"
WritCreater.optionStrings["writStatsButton"] = "Ouvrir la fenêtre"
WritCreater.optionStrings["queueWrits"] = "Mettre toutes les commandes de maître dans la queue"
WritCreater.optionStrings["queueWritsTooltip"] = "Mettre toutes les commandes de maître de votre inventaire dans la queue"
WritCreater.optionStrings["queueWritsButton"] = "Mettre dans la queue"
WritCreater.optionStrings["mainSettings"] = "Paramètres principaux"
WritCreater.optionStrings["statusBarHorizontal"] = "Position Horizontale"
WritCreater.optionStrings["statusBarHorizontalTooltip"] = "Position Horizontale de la barre d'état"
WritCreater.optionStrings["statusBarVertical"] = "Position verticale"
WritCreater.optionStrings["statusBarVerticalTooltip"] = "Position verticale de la barre d'état"
WritCreater.optionStrings["keepItemWritFormat"] = "Garder <<1>>"
