...
local function Menu_Init()
	...
	--Base settings
	local label=BUI.UI.Label(nil, scroll, {w/2-h-20,h}, {TOPLEFT,TOPLEFT,0,0}, BUI.UI.Font("standard",24,true), nil, {0,1}, BUI.Loc("CustomBar"))
	...
	BUI.UI.Label(nil, header, {w,h}, {LEFT,LEFT,10,0}, BUI.UI.Font("standard",24,true), nil, {1,1}, BUI.Loc("LeaderCommands"))
	...
	for i,data in pairs(LeaderCommands) do
		...
		local label	=BUI.UI.Label(nil, bg, {w/2-h1-30-h,h}, {LEFT,RIGHT,10,0}, BUI.UI.Font("standard",24,true), nil, {0,1}, data.mess)
	...
	BUI.UI.Label(nil, header, {w,h}, {LEFT,LEFT,10,0}, BUI.UI.Font("standard",24,true), nil, {1,1}, BUI.Loc("CustomCommands"))
	--Custom buttons
	...
	for i in pairs(SlashCommands) do
		...
		local label	=BUI.UI.Label(nil, frame, {130,h}, {TOPLEFT,TOPLEFT,h1+10,0}, BUI.UI.Font("standard",20,true), nil, {0,0}, BUI.Loc("TextureFilename"))
		...
		local label	=BUI.UI.Label(nil, frame, {130,h}, {TOPLEFT,TOPLEFT,h1+10,h}, BUI.UI.Font("standard",20,true), nil, {0,0}, BUI.Loc("SlashCommand"))
