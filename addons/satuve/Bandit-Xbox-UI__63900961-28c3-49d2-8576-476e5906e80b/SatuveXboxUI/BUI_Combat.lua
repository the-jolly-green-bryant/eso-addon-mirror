...
local function Targets_Init()	--TARGETS REPORT
	local Targets	=BUI.UI.Control(	"BUI_Targets",					SatuveUI,	{390,200},				BUI.Vars.BUI_Targets,			true)
...
function BUI.Damage.Attackers_UI()	--UI init
	...
	local ui	=BUI.UI.Control(	"BUI_Attackers",				SatuveUI,	{w,h*3+8},		BUI.Vars.BUI_Attackers or {TOPLEFT,TOP,710/2,5,ZO_CompassFrame},	not (BUI.Vars.Attackers and BUI.inMenu))
