...
local function Setup_ActionSlot()
	local normal=BUI.Vars.Theme<=3 and "/esoui/art/actionbar/abilityframe64_up.dds" or "/SatuveXboxUI/textures/theme/abilityframe64_up.dds"
	BUI.abilityframe=normal
--	local mouseDown=BUI.Vars.Theme<=3 and "/esoui/art/actionbar/abilityframe64_down.dds" or "/SatuveXboxUI/textures/theme/abilityframe64_down.dds"
...
local function Setup_TargetFrame()
	local texture=BUI.Vars.Theme<=3 and "/esoui/art/unitattributevisualizer/targetbar_dynamic_frame.dds" or "/SatuveXboxUI/textures/theme/targetbar_dynamic_frame.dds"
...
local function Setup_AdvancedTheme()
	...
	HideElements(true)
	local ui=BUI.UI.Control("BUI_AdvancedTheme", SatuveUI, "inherit", {TOPLEFT,TOPLEFT,0,0}, false)
--[[	--HUD
	if BUI.Vars.CurvedFrame==0 then
		local w,h=SatuveUI:GetDimensions()
		local points={
...
--		RedirectTexture("/esoui/art/miscellaneous/progressbar_frame.dds","/SatuveXboxUI/textures/theme/progressbar_frame.dds")
--		for i,data in pairs(textures) do RedirectTexture("/esoui/art/"..data[1].."/"..data[2],"/SatuveXboxUI/textures/theme/"..data[2]) end
	end
	...
	if BUI.Vars.Theme==6 then
		if BUI_Theme_Pony then
			...
			BUI.UI.Statusbar("BUI_Theme_Pony",QuickslotButton,{128*scale,128*scale},{BOTTOMRIGHT,BOTTOMRIGHT,0,0},{1,1,1,1},"/SatuveXboxUI/textures/pink_pony.dds",false)
		end
	elseif BUI_Theme_Pony then
		BUI_Theme_Pony:SetHidden(true)
	end
	--Player exp bar
	local texture=BUI.Vars.Theme<=3 and "/esoui/art/miscellaneous/progressbar_frame.dds" or "/SatuveXboxUI/textures/theme/progressbar_frame.dds"
	...
	--Attribute bars
	local texture=BUI.Vars.Theme<=3 and "/esoui/art/unitattributevisualizer/attributebar_dynamic_frame.dds" or "/SatuveXboxUI/textures/theme/attributebar_dynamic_frame.dds"
...
--			local frame=_G[bar.."BgContainerBG"..text] if frame then frame:SetTexture(fill) end
	...
	local frame=_G["ZO_PlayerAttributeSiegeHealthFrame"] if frame then
		local texture=BUI.Vars.Theme<=3 and "/esoui/art/unitattributevisualizer/attributebar_small_frame_center.dds" or "/SatuveXboxUI/textures/theme/attributebar_small_frame_center.dds"
	...
	local frame=_G["ZO_PlayerAttributeWerewolfFrame"] if frame then
		local texture=BUI.Vars.Theme<=3 and "/esoui/art/unitattributevisualizer/attributebar_small_frame.dds" or "/SatuveXboxUI/textures/theme/attributebar_small_frame.dds"
		frame:SetTexture(texture) if color then frame:SetColor(unpack(color)) end
	end
	...
	local frame=_G["ZO_WorldMapMapFrame"] if frame then
		local texture=BUI.Vars.Theme<=3 and "/esoui/art/worldmap/worldmap_frame_edge.dds" or "/SatuveXboxUI/textures/theme/worldmap_frame_edge.dds"
...
--	if v==3 or v==5 then for i,data in pairs(flat) do RedirectTexture("/esoui/art/"..data[1].."/"..data[2],"/SatuveXboxUI/textures/theme/blank.dds") end end
end
