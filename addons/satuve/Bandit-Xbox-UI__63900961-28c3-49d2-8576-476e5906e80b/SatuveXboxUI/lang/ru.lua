...
PvPmodeAnnouncement="Анонс режима PvP",
...
PrimaryStat		="Первичная статистика",
...
Shield="Щит",
ShieldDesc="Показать щита на панель",
Trauma = "Травма",
TraumaDesc = "Показать травму на панель",
...
FullSwapPanel	="Показать всю панель подкачки",
FullSwapPanelDesc	=default..(BUI.Defaults.UseSwapPanel and on or off),
...
AutoDismissPet="Отозвать боевых питомцев (Триалы).",
AutoDismissPetDesc="Отозвать питомцев животных при входе в триалы.",
