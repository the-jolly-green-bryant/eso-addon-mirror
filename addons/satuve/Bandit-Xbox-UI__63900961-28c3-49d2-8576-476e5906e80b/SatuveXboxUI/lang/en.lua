...
PanelSettings	="Satuve Xbox UI settings",
...
PvPmodeAnnouncement="PvP mode announcement",
...
Shield="Shield",
ShieldDesc="Show Shield on bars",
Trauma = "Trauma",
TraumaDesc = "Show Trauma on bars",
...
ShieldGroup="Shield",
ShieldGroupDesc="Show Shield on bars",
TraumaGroup = "Trauma",
TraumaGroupDesc = "Show Trauma on bars",
--Stats share
...
StatsReportScale	="Statistics Report Scale",
StatsReportScaleDesc	="Scales the complete statistics report. The current size is preserved at 1.00.\n"..default.."1.00",
StatsReportGamepadHeader="Statistics Report / Gamepad",
StatsGamepadNavigation="Gamepad Statistics Navigation",
StatsGamepadNavigationDesc="Enables focus-based controller navigation while the statistics report is open.\n"..default..on,
StatsLargeGamepadUI="Large Gamepad Statistics UI",
StatsLargeGamepadUIDesc="Uses a larger, stronger controller focus highlight without changing your chosen report scale.\n"..default..on,
StatsAutoGamepadNavigation="Auto Enable Gamepad Navigation",
StatsAutoGamepadNavigationDesc="Automatically gives the statistics report controller focus when ESO is using gamepad mode.\n"..default..on,
...
FullSwapPanelDesc	="Show the entire swap panel\n"..default..(BUI.Defaults.UseSwapPanel and on or off),
...
UpdateTimeDesc="How often to update ability timers in milliseconds.\nLower values may cause FPS drops.\n"..default..BUI.Defaults.UpdateTime,
