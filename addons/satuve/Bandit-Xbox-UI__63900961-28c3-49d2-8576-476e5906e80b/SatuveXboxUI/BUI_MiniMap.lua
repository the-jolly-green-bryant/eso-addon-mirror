...
--			EVENT_MANAGER:UnregisterForEvent("BUI_Minimap", EVENT_RETICLE_HIDDEN_UPDATE)
			...
			for scene in pairs(BUI.MiniMap.BUI_MINIMAP_SCENE_NAMES) do local sceneObject=SCENE_MANAGER:GetScene(scene) if sceneObject then sceneObject:UnregisterCallback("StateChange") end end
...
--]]
	...
	for scene in pairs(BUI.MiniMap.BUI_MINIMAP_SCENE_NAMES) do local sceneObject=SCENE_MANAGER:GetScene(scene) if sceneObject then sceneObject:RegisterCallback("StateChange", OnHUD) end end
