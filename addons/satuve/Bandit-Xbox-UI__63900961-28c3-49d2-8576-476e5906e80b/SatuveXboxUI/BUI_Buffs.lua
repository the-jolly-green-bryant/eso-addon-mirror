...
function BUI.Frames.CustomBuffs_Init()
	...
	--Create the Self Buffs frame container
	local ui	=BUI.UI.Control(	"BUI_BuffsC",			SatuveUI,	dimensions,				BUI.Vars.BUI_BuffsC,		false)
	...
	local bar_texture=side and "/SatuveXboxUI/textures/theme/progressbar_right_2.dds" or "/SatuveXboxUI/textures/theme/progressbar_left_2.dds"
	for i=1, number do
...
function BUI.Frames.SynergyCd_Init()
	...
	--Create the Self Buffs frame container
	local ui	=BUI.UI.Control(	"BUI_BuffsS",			SatuveUI,	dimensions,				BUI.Vars.BUI_BuffsS,		false)
...
function BUI.Frames.Widgets_Init(widget,dup)
	...
	local bar_texture=side and "/SatuveXboxUI/textures/theme/progressbar_left_2.dds" or "/SatuveXboxUI/textures/theme/progressbar_right_2.dds"
	local fname		="BUI_Widget_"..id..(dup and "_"..dup or "")
	local ability	=BUI.UI.Control(	fname,	SatuveUI,	{size,size},	anchor,	not widget and not data[12])
...
function BUI.Frames.PassiveBuffs_Init()
	...
	--Create the Self Buffs frame container
	local ui	=BUI.UI.Control(	"BUI_BuffsPas",			SatuveUI,	{size,(size+space)*number-space},	BUI.Vars.BUI_BuffsPas,		false)
...
function BUI.Frames.TargetBuffs_Init()
	...
	-- Place target buffs closer to the target frame so they do not sit on top of the player resources.
	local targetBuffAnchor=BUI.Vars.BUI_BuffsT
	if type(targetBuffAnchor)=="table" then
		targetBuffAnchor={targetBuffAnchor[1],targetBuffAnchor[2],targetBuffAnchor[3] or 0,(targetBuffAnchor[4] or 0)+55}
	end
	local ui		=BUI.UI.Control(	"BUI_BuffsT",			SatuveUI,	{(size+space)*number-space,size},	targetBuffAnchor,		false)
...
--	ability.debuff	=BUI.UI.Statusbar("BUI_BuffsT"..i.."_Debuff",	ability,	{size,size/2},			{BOTTOM,TOP,0,0},			{1,1,1,1},'/SatuveXboxUI/textures/debuff.dds', true)
	...
	ability.timer	=BUI.UI.Label(	"BUI_BuffsT"..i.."_Timer",	ability,	{fs*4,fs+4},			{BOTTOM,BOTTOM,0,-7},		BUI.UI.Font(BUI.Vars.FrameFont1,math.max(fs+2,18),true,true), nil, {1,2}, '', false)
