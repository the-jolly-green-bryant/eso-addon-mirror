...
function BUI.PlaceMarker(num)
	...
	marker:SetTexture("/SatuveXboxUI/textures/marker.dds")
...
function BUI.Compass_Init()
	if BUI.Compass then
		...
		compass:SetTexture("/SatuveXboxUI/textures/compass.dds")
	...
	--	compass:SetColor(1,1,1,1)
		...
		crown:SetTexture("/SatuveXboxUI/textures/crown.dds")
...
/script BUI_Compass:SetTexture("/SatuveXboxUI/textures/compass.dds")
