...
function BUI.Reticle.Mode(n)
	...
	elseif n==8 then
		...
		ZO_ReticleContainerReticle:SetTexture('/SatuveXboxUI/textures/reticle/reticle'.. n ..'.dds')
	end
...
function BUI.Reticle.LeaderArrow()
	...
	if not texture then
		...
		texture:SetTexture('/SatuveXboxUI/textures/reticle/arrow_bar.dds')
		texture:SetAlpha(.8)
	end
...
local function UI_Init()
	...
	boost:SetTexture('/SatuveXboxUI/textures/reticle/boost.dds')
	...
	invul:SetTexture('/SatuveXboxUI/textures/reticle/circle_bar.dds')
...
--	invul:SetDrawLayer(1)
	...
	if not bar then
		...
		bar:SetTexture('/SatuveXboxUI/textures/reticle/bot_bar.dds')
		bar:SetHidden(true)
--		bar:SetDrawLayer(2)
	end
	--Cast bar
...
--		bar:SetDrawLayer(2)
	...
	if not bar then
		...
		bar:SetTexture('/SatuveXboxUI/textures/reticle/res_bar.dds')
	...
	for i=1,7 do
		...
		bar[i]:SetTexture('/SatuveXboxUI/textures/reticle/res_bar.dds')
	...
	for i=3,7 do
		...
		bar[b]:SetTexture('/SatuveXboxUI/textures/reticle/res_bar.dds')
