...
--	if _G["BUI_Meter_"..name.."_Panel"] then _G["BUI_Meter_"..name.."_Panel"]:SetHidden(true) end
	...
	local ui	=BUI.UI.Control(	"BUI_Meter_"..name,		SatuveUI,	{w,h},		BUI.Vars["BUI_Meter_"..name] or BUI.Meters.Default["BUI_Meter_"..name],		false)
	...
	ui.bg		=BUI.UI.Texture(	"BUI_Meter_"..name.."_Bg",	ui.base,	{w,h},	{TOPLEFT,TOPLEFT,0,0},		"/SatuveXboxUI/textures/meter.dds",	false,0,{0,1,.5,1})
	ui.bg:SetColor(unpack(theme_color))
	ui.border	=BUI.UI.Texture(	"BUI_Meter_"..name.."_Bord",	ui.base,	{w,h},	{TOPLEFT,TOPLEFT,0,0},		"/SatuveXboxUI/textures/meter.dds",	false,2,{0,1,0,.5})
