...
local styles = {
	...
	[108] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2903},	-- 82: - Ancestral Akaviri
	[114] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2959},	-- 98: House Hexos Style, wrong achievement down
	[116] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2984},	-- 100: True-Sworn Style
	[117] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2991},	-- 99: Waking Flame Style
	[119] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 2999},	-- 104: Ancient Daedric Style
	[120] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3000},	-- 103: Black Fin Legion Style
	[121] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3001},	-- 101: Ivory Brigade Style
	[122] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3002},	-- 102: Sul-Xan Style
	[123] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3094},	-- 105: - Crimson Oath
	[124] = {stype = AIRG_STYLE_CHAPTERIZED, achiev = 3097}		-- 106: - Silver Rose

	-- Writing style numbers here because Data Extractor failed to extract them and i looked for them by trial and error - Kationa
	-- 115 - Deadlands Gladiator (not added yet)
	-- 118 - Dremora Kynreeve (not added yet)
	-- 125 - Annihilarch's chosen (not added yet)
	-- 126 - Fargrave guardian (not added yet)
}
...
local styleOrder = {
	...
	[90] = 110,		-- Ancestral Reach
	[91] = 112,     -- Arkthzand Armory
	[92] = 106, 	-- Thorn Legion
	[93] = 107,		-- Hazardous Alchemy
	[94] = 113, 	-- Wayward Guardian
	[95] = 111, 	-- Nighthollow
	[96] = 108,		-- 82: - Ancestral Akaviri
	[97] = 114,		-- 98: House Hexos Style
	[98] = 116,		-- 99: Waking Flame Style
	[99] = 117,		-- 100: True-Sworn Style
	[100] = 121,	-- 101: Ivory Brigade Style
	[101] = 122,	-- 102: Sul-Xan Style
	[102] = 120,	-- 103: Black Fin Legion Style
	[103] = 119,	-- 104: Ancient Daedric Style
	[104] = 123,	-- 105: - Crimson Oath
	[105] = 124		-- 106: - Silver Rose
