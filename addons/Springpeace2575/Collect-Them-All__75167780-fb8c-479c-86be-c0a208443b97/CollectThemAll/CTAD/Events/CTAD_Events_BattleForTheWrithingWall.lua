CollectThemAllData_Events_BattleForTheWrithingWall = {
    name = "Battle for the Writhing Wall",
    source = "Events",
    collection = {
        ...
        [COLLECTIBLE_CATEGORY_TYPE_MOUNT] = {
            { name = "Coldharbour Death Hound", achievement = "Savior of Solstice" },
            { name = "Wormwrithe Bear-Lizard" },
        },
        [COLLECTIBLE_CATEGORY_TYPE_VANITY_PET] = {
            { name = "Wormwrithe Haj Mota Hatchling", info = "Consume 25 Writhing Haj Mota Scales" },
            { name = "Coldharbour Dremnaken Runt" },
        },
        [COLLECTIBLE_CATEGORY_TYPE_MEMENTO] = {
            { name = "Writhing Wall Remnant", achievement = "Barrier Buster" },
        },
        ...
        [COLLECTIBLE_CATEGORY_TYPE_ABILITY_FX_OVERRIDE] = {
            { name = "Caltrops, Bone", achievement = "Skill Stylist: Caltrops" },
        },
