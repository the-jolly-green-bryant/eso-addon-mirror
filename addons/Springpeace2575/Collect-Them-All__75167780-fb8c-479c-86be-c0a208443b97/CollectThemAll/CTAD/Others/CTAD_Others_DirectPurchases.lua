CollectThemAllData_Others_DirectPurchases = {
    ...
    collection = {
        ...
        [COLLECTIBLE_CATEGORY_TYPE_HOUSE] = {
            { name = "Seabloom Villa", no = 111, info = "Housing Starter Pack" },
        },
        ...
        [COLLECTIBLE_CATEGORY_TYPE_COSTUME] = {
            { name = "Pellitine Anniversary Drape", info = "10-Year Anniversary Pack" },
        },
