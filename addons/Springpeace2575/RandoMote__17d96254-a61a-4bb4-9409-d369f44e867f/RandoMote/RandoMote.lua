-----------------------------------------------------------
-- Author: SpringPeace2575 | Version: 1.6.3
...
RandoMote = RandoMote or {}
local RM = RandoMote
local RMEmotes = RandoMoteEmotes
local RMPlayer = RandoMotePlayer
local RMSettings = RandoMoteSettings

RM.name             = "RandoMote"
RM.displayName      = "RandoMote"
RM.savedVarsName    = "RandoMoteSavedVars"
RM.savedVarsVersion = 1
RM.version          = "1.6.3"
RM.settingsPanelId  = "RandoMotePanel"
