CollectThemAllData_Vendors_WarResearchers = {
    name = "War Researchers",
    source = "Vendors",
    collection = {
        ...
        [COLLECTIBLE_CATEGORY_TYPE_OUTFIT_STYLE] = {
            { name = "Cumberland Cavalier", armorOnly = true },
            { name = "Highborn Gallant", armorOnly = true },
            { name = "Thane of Falkreath", armorOnly = true },

            { name = "Akaviri", motif = 18},
        },
        [COLLECTIBLE_CATEGORY_TYPE_PLAYER_FX_OVERRIDE] = {},
        [COLLECTIBLE_CATEGORY_TYPE_ABILITY_FX_OVERRIDE] = {
            { name = "Revealing Flare, Blazing Orange" },
        },
        ...
        [COLLECTIBLE_CATEGORY_TYPE_BODY_MARKING] = {
            { name = "Covenant Blue Body Paint" },
            { name = "Dominion Gold Body Paint" },
            { name = "Pact Red Body Paint" },
        },
        [COLLECTIBLE_CATEGORY_TYPE_HEAD_MARKING] = {
            { name = "Covenant Blue Face Paint" },
            { name = "Dominion Gold Face Paint" },
            { name = "Pact Red Face Paint" },
        },
