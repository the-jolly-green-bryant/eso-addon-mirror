CollectThemAllData_Vendors_BattlegroundSuppliesMerchants = {
    name = "Battleground Supplies Merchants",
    source = "Vendors",
    collection = {
        ...
        [COLLECTIBLE_CATEGORY_TYPE_EMOTE] = {
            { name = "Chaos Ball Boom" },
            { name = "Chaos Ball Victory Dance" },
            { name = "Scorching Chaos Ball" },
        },
        [COLLECTIBLE_CATEGORY_TYPE_OUTFIT_STYLE] = {
            { name = "Militant Ordinator", motif = 49 },
        },
