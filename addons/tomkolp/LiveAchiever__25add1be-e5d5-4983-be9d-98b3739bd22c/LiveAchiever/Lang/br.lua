...
LiveAchiever.Lang.br = {
    -- HUD
    HUD_Title = "Conquistas Rastreadas",
    ...
    Chat_Track_Btn = "[Rastrear]",
    Chat_Progress_InProgress = "Progresso: Em andamento",
    
    -- Status Messages
    Msg_Track_Stop = "Rastreamento parado.",
    Msg_Track_Start = "Rastreamento iniciado.",
    ...
    Settings_Time_Tooltip = "Por quanto tempo o progresso deve ser somado (ex: +5). O contador desaparecerá após esse tempo.",
    Settings_Section_Manage = "Gerenciamento",
    Settings_Hide_Combat_Label = "Ocultar em combate",
    Settings_Hide_Combat_Tooltip = "Ocultar automaticamente a janela de rastreamento ao entrar em combate.",
    ...
    Settings_Clear_List = "Lista de Rastreamento",
    ...
    -- Context Menu
    Menu_Track = "Rastrear (LiveAchiever)",
    Menu_StopTrack = "Parar de rastrear (LiveAchiever)",
    
    -- Navigation / Gamepad
    Nav_Tracked = "|c00FF00[RASTREADO]|r",
    ...
    Menu_Btn_Press = "Pressionar Analógico Direito",
