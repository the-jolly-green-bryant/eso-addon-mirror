...
function HMR_SHA.bin(msg)
	return hex_to_binary(HMR_SHA.hex(msg))
end
...
function HMR_SHA.hmacHex(key, text)
	...
	return HMR_SHA.hex(key_xord_with_0x5c .. HMR_SHA.bin(key_xord_with_0x36 .. text))
end

function HMR_SHA.hmacBin(key, text)
	return hex_to_binary(HMR_SHA.hmacHex(key, text))
end

HardModeReminders.sha = HMR_SHA
