...
ZO_CreateStringId("SI_BINDING_NAME_HMR_STOP", GetString(HMR_KEYBIND_STOP))
ZO_CreateStringId("SI_BINDING_NAME_HMR_SETTINGS", GetString(HMR_KEYBIND_SETTINGS))
ZO_CreateStringId("SI_BINDING_NAME_HMR_TEST", GetString(HMR_KEYBIND_TEST))
