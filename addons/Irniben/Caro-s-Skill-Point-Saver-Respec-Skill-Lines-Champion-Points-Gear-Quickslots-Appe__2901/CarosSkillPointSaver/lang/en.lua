...
local L = {}
	...
	L.SI_BINDING_NAME_CSPS_CPHK1 = "Hotkey 1"
	L.SI_BINDING_NAME_CSPS_CPHK2 = "Hotkey 2"
	L.SI_BINDING_NAME_CSPS_CPHK3 = "Hotkey 3"
	L.SI_BINDING_NAME_CSPS_CPHK4 = "Hotkey 4"
	L.SI_BINDING_NAME_CSPS_CPHK5 = "Hotkey 5"
	L.SI_BINDING_NAME_CSPS_CPHK6 = "Hotkey 6"
	L.SI_BINDING_NAME_CSPS_CPHK7 = "Hotkey 7"
	L.SI_BINDING_NAME_CSPS_CPHK8 = "Hotkey 8"
	L.SI_BINDING_NAME_CSPS_CPHK9 = "Hotkey 9"
	L.SI_BINDING_NAME_CSPS_CPHK10 = "Hotkey 10"
	L.SI_BINDING_NAME_CSPS_CPHK11 = "Hotkey 11"
	L.SI_BINDING_NAME_CSPS_CPHK12 = "Hotkey 12"
	L.SI_BINDING_NAME_CSPS_CPHK13 = "Hotkey 13"
	L.SI_BINDING_NAME_CSPS_CPHK14 = "Hotkey 14"
	L.SI_BINDING_NAME_CSPS_CPHK15 = "Hotkey 15"
	L.SI_BINDING_NAME_CSPS_CPHK16 = "Hotkey 16"
	L.SI_BINDING_NAME_CSPS_CPHK17 = "Hotkey 17"
	L.SI_BINDING_NAME_CSPS_CPHK18 = "Hotkey 18"
	L.SI_BINDING_NAME_CSPS_CPHK19 = "Hotkey 19"
	L.SI_BINDING_NAME_CSPS_CPHK20 = "Hotkey 20"
	...
	L.CSPS_LAM_DeveloperOptionsTT = "Activates hidden menu entries to show internal data etc."
	
	-- new with 6.0.1
	L.CSPS_ApplySkillsWithoutRespec = "Additional skills only (no respec)"
	L.CSPS_CraftingList = "Items to craft/reconstruct (click to activate)"
	L.CSPS_WaitingForEnchant = "Item finished, waiting for enchantment to be crafted."
	L.CSPS_AddToCraftlist = "Add to crafting list"
	L.CSPS_ReconLevel = "Warning! Reconstructed items will always have the level of the character you reconstruct them with! This item will be reconstructed at level %s (|t28:28:esoui/art/champion/champion_icon_32.dds|t %s)!"
	L.CSPS_ShowCraftlist = "Show craft list"
	L.CSPS_LAM_UpgradeAnyway = "Always upgrade reconstructed items"
	L.CSPS_LAM_UpgradeAnywayTT = "If activated reconstructed items will be upgraded even if the character you're on hasn't leveled the needed passives and the cost will be higher than necessary. You can always put reconstructed items in the bank and let another character upgrade them."
	L.CSPS_LAM_CheckWW = "Wizard's Wardrobe Auto-Respec"
	L.CSPS_LAM_CheckWWAuto = "Activate for automatic load"
	L.CSPS_LAM_CheckWWPassives = "Auto-apply class line passives"
	L.CSPS_LAM_CheckWWTT = "If activated each time you load a build in Wizard's Wardrobe CSPS will check if your char needs respeccing and activate the correct morphs and subclasses."
	L.CSPS_LAM_CheckWWAutoTT = "CSPS will only respec for builds manually loaded. Activate this function to also respec builds automatically loaded by Wizard's Wardrobe."
	L.CSPS_LAM_CheckWWPassivesTT = "When activated CSPS will apply all class line passives for class lines that are new in a build."
	L.CSPS_WW_ADJUST = "WW setup contains skills not active in your current build. CSPS is trying to do a respec."
	L.CSPS_LLC_NEEDED = "LibLazyCrafting is needed to craft or reconstruct items from within CSPS. Please install LibLazyCrafting or log onto a character where the lib is activated."
	
	-- new with 6.1.3
	L.CSPS_RESET_SKILLS = "Reset skills before import"
	L.CSPS_RMB_MENU = "|t26:26:esoui/art/miscellaneous/icon_rmb.dds|t: Menu"
	L.CSPS_GEAR_CustomTT = "This item has been edited manually or is imported from an external source. It is not linked to a specific item in your inventory. CSPS will look for an item that fits all or most of the selected parameters (like set, trait, enchantment, etc)."
	L.CSPS_GEAR_NotUnique = "The item originally linked to this build could not be found but another item could fit instead."
	L.CSPS_GEAR_NotUniqueWorn = "The item you're wearing is fitting but not the item originally linked to the build. The original item is in your inventory/bank."
	L.CSPS_GEAR_NotAllParametersWorn = "The item you're wearing is fitting some but not all parameters. A better item was found in your inventory/bank."
	L.CSPS_GEAR_NotAllParameters = "The item found in your inventory/bank is not fitting all the parameters."
	L.CSPS_GEAR_ItemNotFound = "Item not found: %s"
	L.CSPS_GEAR_EquipSimilar = "Equip similar item (%s)"
	L.CSPS_GEAR_WithdrawSimilar = "Withdraw similar item (%s)"
	
	--6.1.4
	L.CSPS_LoadingGroup = "Loading group %s%s"
	L.CSPS_AccountWide = " (account wide)"
	L.CSPS_IgnoreEmptyOutfitSlotsTT = "Per default CSPS saves empty outfit slots and clears them when applied. Activate this function to read them as 'no data' and not change anything. This can still be edited manually for every slot."
	
	-- 6.1.5
	L.CSPS_StandardProfileFirst = "Standard profile always on top"
	L.CSPS_StandardProfileFirstTT = "Sort the standard profile at the top of the list"
	L.CSPS_LAM_SortProfiles = "Sort build profiles"
	L.CSPS_LAM_NewestFirst = "Newer first"
	L.CSPS_LAM_OldestFirst = "Older first"
	L.CSPS_SkillLocked = "Skill not yet unlocked"
	L.CSPS_GrimmoireLocked = "Grimmoire unknown"
	L.CSPS_ScriptLocked = "Focus/Signature/Affix script unknown"
	L.CSPS_RankLocked = "Rank not unlocked"
