	...
	local optionsData = {
		...
		},
		{
			...
			controls =
			{
				...
				{
					type    = "checkbox",
					tooltip = "Deadlands DLC",
					name    = GetString(DAS_MENU_CB_DEADL),
					getFunc = function() return DAS.GetActiveIn(1282) end,
					setFunc = function(value) DAS.SetActiveIn(1282, value) end
				},
				{
					type    = "checkbox",
				...
				{
					type    = "checkbox",
					tooltip = "Solstice DLC",
					name    = GetString(DAS_MENU_CB_SOLST),
					getFunc = function() return DAS.GetActiveIn(1502) end,
					setFunc = function(value) DAS.SetActiveIn(1502, value) end
				},
