...
local strings  = {
	...
	-- Solstice
	-- Delve dailies : NPC = Morlia
	DAS_QUEST_SOL_BOSS		= "Morlia",					 -- 323051
	DAS_SOL_GAULM           = "Gaulm's Lair",       	 -- 7264
	DAS_SOL_GUARD           = "Guardians Gone Bad", 	 -- 7265
	DAS_SOL_TIDE            = "Tidewash Stranded",       -- 7266
	-- World Boss dailies : NPC = Lector Volonaro
	DAS_QUEST_SOL_EXPL		= "Lector Volonaro",		 -- 323052
	DAS_SOL_CANDL           = "Candleflies for the Dead",-- 7263
	DAS_SOL_SANGU           = "Sanguine's Solace",       -- 7262
	DAS_SOL_SAVE            = "Save the Ruins!",  		 -- 7261
