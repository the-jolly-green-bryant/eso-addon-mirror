...
local strings =
{
    ...
    -- Categories
    FANCYAB_CAT_FBVISUAL = "[ |cffdf80Видимость передней панели|r ]",
    ...
    FANCYAB_APPLY_ACTIVE_ALPHA_NAME = "Применять прозрачность активной панели",
    FANCYAB_APPLY_ACTIVE_ALPHA_TT = "Позволяет переопределять прозрачность активной панели. Обратите внимание: это конфликтует с тем, как базовая игра показывает, что целевые способности можно применить.",

    FANCYAB_APPLY_ACTIVE_DESAT_NAME = "Применять обесцвечивание активной панели",
    FANCYAB_APPLY_ACTIVE_DESAT_TT = "Позволяет переопределять насыщенность/уровень серого активной панели. Обратите внимание: это конфликтует с тем, как базовая игра показывает, что целевые способности можно применить.",

    FANCYAB_ALPHA_USABLE_NAME = "Прозрачность доступных способностей",
    FANCYAB_ALPHA_USABLE_TT = "Непрозрачность значка, когда способность можно использовать.\n100 соответствует игре по умолчанию.",
    ...
    FANCYAB_TINT_INACTIVE_NAME = "Оттенок неактивной панели",
    FANCYAB_TINT_INACTIVE_TT = "Цветовой оттенок иконок неактивной (задней) панели.\nБелый сохраняет исходный оттенок.",

    FANCYAB_ALPHA_UNUSABLE_NAME = "Прозрачность недоступных способностей",
    FANCYAB_ALPHA_UNUSABLE_TT = "Непрозрачность значка, когда способность нельзя использовать.\n57 соответствует игре по умолчанию.",

    FANCYAB_DESAT_USABLE_NAME = "Обесцвечивание доступных способностей",
    FANCYAB_DESAT_USABLE_TT = "Уровень серого, когда способность можно использовать.\n0 соответствует игре по умолчанию.",

    FANCYAB_DESAT_UNUSABLE_NAME = "Обесцвечивание недоступных способностей",
    FANCYAB_DESAT_UNUSABLE_TT = "Уровень серого, когда способность нельзя использовать.\n100 соответствует игре по умолчанию для перезарядки.",

    FANCYAB_APPLY_ACTIVE_TINT_NAME = "Применять оттенок иконки активной панели",
    FANCYAB_APPLY_ACTIVE_TINT_TT = "Позволяет переопределять цветовой оттенок иконки. В игре для многих недоступных способностей используется тёмно-серый оттенок (не обесцвечивание).",
    FANCYAB_TINT_USABLE_NAME = "Оттенок доступных способностей",
    FANCYAB_TINT_USABLE_TT = "Цвет иконки, когда способность можно использовать.\nБелый соответствует игре по умолчанию.",
    FANCYAB_TINT_UNUSABLE_NAME = "Оттенок недоступных способностей",
    FANCYAB_TINT_UNUSABLE_TT = "Цвет иконки, когда способность нельзя использовать.\nТёмно-серый (30 %) соответствует игре для нехватки ресурсов.",
    ...
    FANCYAB_OVERLAY_BG_INACTIVE_NAME = "Прозрачность фона кнопки (неактивная панель)",
    FANCYAB_BUTTON_BACKDROP_ALPHA_TT = "Непрозрачность фона за значком способности.\nБольшее значение = более непрозрачно.\nМеньшее значение = более прозрачно.",
    FANCYAB_FRAME_BORDER_ALPHA_TT = "Непрозрачность рамки кнопки.\nПрименяется только при включённых пользовательских рамках.\nБольшее значение = более непрозрачно.\nМеньшее значение = более прозрачно.",
