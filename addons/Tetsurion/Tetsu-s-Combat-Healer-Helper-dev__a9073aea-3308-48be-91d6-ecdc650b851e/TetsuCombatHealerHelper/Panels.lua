...
local function PairLabel(id, ob)
    local L = T.L or {}
    local map = {
        courage = L.PAIR_COURAGE or "Courage",
        slayer = L.PAIR_SLAYER or "Slayer",
        force = L.PAIR_FORCE or "Force",
        berserk = L.PAIR_BERSERK or "Berserk",
        resolve = L.PAIR_RESOLVE or "Resolve",
        vitality = L.PAIR_VITALITY or "Vitality",
        wdspd = L.PAIR_WDSPD or "Sorc/Brut",
        crit = L.PAIR_CRIT or "Prop/Sav",
        recover = L.PAIR_RECOVER or "Int/End",
        heroism = L.PAIR_HEROISM or "Heroism",
        breach = L.PAIR_BREACH or "Breach",
        fracture = L.PAIR_FRACTURE or "Fracture",
        vulnerability = L.PAIR_VULN or "Vuln",
        brittle = L.PAIR_BRITTLE or "Brittle",
        cowardice = L.PAIR_COWARD or "Cowardice",
        maim = L.PAIR_MAIM or "Maim",
        defile = L.PAIR_DEFILE or "Defile",
        offbalance = L.PAIR_OB or "Off-Bal",
    }
    return map[id] or id
end
