...
if IsFrench() then
    ...
    CombatFPSBooster.L.FILTER_APPLY     = "Combat FPS Booster : application du set donjon, rechargement de l'IU."
    CombatFPSBooster.L.FILTER_RESTORE   = "Combat FPS Booster : restauration du set monde, rechargement de l'IU."
