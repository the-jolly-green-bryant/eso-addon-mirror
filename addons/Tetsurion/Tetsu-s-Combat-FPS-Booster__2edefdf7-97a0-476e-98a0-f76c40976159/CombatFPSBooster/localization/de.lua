...
if IsGerman() then
    ...
    CombatFPSBooster.L.FILTER_APPLY     = "Combat FPS Booster: Dungeon-Addon-Set wird angewendet, UI wird neu geladen."
    CombatFPSBooster.L.FILTER_RESTORE   = "Combat FPS Booster: Welt-Addon-Set wird wiederhergestellt, UI wird neu geladen."
