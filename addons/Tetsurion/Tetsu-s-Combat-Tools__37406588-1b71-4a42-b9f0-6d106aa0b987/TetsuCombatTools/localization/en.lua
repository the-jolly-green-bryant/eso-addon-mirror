...
TetsuCombatTools.L = {
    ...
    CONS_END_SOUND_TT = "One built-in sound for both food and potion end. Changing the entry plays it.",
    CONS_END_SOUND_VOL = "End sound volume",
    CONS_END_SOUND_VOL_TT = "How many times the cue is stacked (0 = mute, 5 = loudest). Same as combat-status volume.",
    ...
    STATUS_SOUND_VOL = "Sound volume",
    STATUS_SOUND_VOL_TT = "How many times the cue is stacked (0 = mute, 5 = loudest). Same as Crux Tracker.",
    STATUS_PREVIEW = "Preview",
    STATUS_PREVIEW_TT = "Shows the in-combat look for 8 seconds, even over this menu. Plays the start sound if sound is on.",
    STATUS_PREVIEW_BTN = "Show 8s",
}
