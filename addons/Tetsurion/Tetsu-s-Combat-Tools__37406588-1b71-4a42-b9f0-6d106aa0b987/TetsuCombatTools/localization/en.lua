...
TetsuCombatTools.L = {
    ...
    TIMER_X = "Offset X",
    TIMER_X_TT = "0 = screen center. Negative left, positive right.",
    TIMER_Y = "Offset Y",
    TIMER_Y_TT = "0 = reticle. Default -280 is above the reticle. Negative up, positive down.",
    TIMER_SCALE = "Scale %",
    TIMER_SCALE_TT = "Size of the clock.",
