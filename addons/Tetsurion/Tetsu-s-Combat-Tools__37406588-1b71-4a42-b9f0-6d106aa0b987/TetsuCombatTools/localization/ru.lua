...
TetsuCombatTools.L = {
    ...
    CONS_SCALE = "Масштаб %",
    CONS_SCALE_TT = "Размер обоих слотов.",
    ...
    TIMER_X = "Сдвиг X",
    TIMER_X_TT = "0 = центр экрана. Минус влево, плюс вправо.",
    TIMER_Y = "Сдвиг Y",
    TIMER_Y_TT = "0 = прицел. По умолчанию -280 выше прицела. Минус вверх, плюс вниз.",
    TIMER_SCALE = "Масштаб %",
    TIMER_SCALE_TT = "Размер часов.",
