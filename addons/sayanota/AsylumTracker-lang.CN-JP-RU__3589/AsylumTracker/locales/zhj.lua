...
local locale_strings = {
     ...
     ["AST_NOTIF_BLAST"] = "亵渎爆轰: ", -- Referring to Llothis' Cone attack. (Cone would probably be a better word to translate than blast)
     ["AST_NOTIF_JUMP"] = "传送打击: ",
     ["AST_NOTIF_BOLTS"] = "高压闪电: ", -- Referring to Llothis' Oppressive bolts attack
