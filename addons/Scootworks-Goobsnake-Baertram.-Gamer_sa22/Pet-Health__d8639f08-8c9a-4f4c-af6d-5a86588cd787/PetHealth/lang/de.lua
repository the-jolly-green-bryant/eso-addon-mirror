...
SafeAddString(SI_PET_HEALTH_LAM_EXCLUDED_ZONEIDS, "Ausgenommene Zonen IDs")
SafeAddString(SI_PET_HEALTH_LAM_EXCLUDED_ZONEIDS_TT, "Diese ZonenIds werden die Begleiter weiterhin anzeigen (z.B. in der Veteranen Maelstrom Arena)")