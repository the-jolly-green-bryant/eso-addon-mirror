...
SkillBarPresets_Globals_AddonInfo = {
    Name = "SkillBarPresets",
    DisplayName = "Skill Bar PRESETS",
    Description = "Save and load presets for skill bar. For player and companion. |c0091ffSpecial thanks for authors of |r |cff8800\"Swap Skills Continued\"|r: HulkSmashWarrior/Garkin/NathanaelTheOne/Ayantir/Calia1120 |c0091ffand|r Irniben|c0091ff for import/export idea|r",
    Author = "@Combat|c6aff00Healer|r",
    Version = "1.4",
    SavedVariables = "SkillBarPresetsStorage"
}

SkillBarPresets_EsoIconTextures = {
    ...
    '/esoui/art/antiquities/digging_crystal_full.dds',
}