local libName, libVersion = "MM10Data", 100
local lib = {}
lib.libName = libName
lib.defaults = {}

local function Initialize()
  lib.oldSavedVariables = ZO_SavedVars:NewAccountWide("MM10DataSavedVariables", 1, nil, {})
  lib.savedVariables = ZO_SavedVars:NewAccountWide("MM10DataSavedVariables", 1, nil, {}, nil, 'MasterMerchant')
