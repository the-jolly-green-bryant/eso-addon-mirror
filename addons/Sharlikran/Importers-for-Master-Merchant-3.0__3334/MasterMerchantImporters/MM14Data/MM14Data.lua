local libName, libVersion = "MM14Data", 100
local lib = {}
lib.libName = libName
lib.defaults = {}

local function Initialize()
  lib.oldSavedVariables = ZO_SavedVars:NewAccountWide("MM14DataSavedVariables", 1, nil, {})
  lib.savedVariables = ZO_SavedVars:NewAccountWide("MM14DataSavedVariables", 1, nil, {}, nil, 'MasterMerchant')
