...
local localization = {
    ...
    SETTINGS_CLICKABLE_LABEL = "Anklicken der Vampz Map Pins, legt den Wegpunkt fest",
    ...
    CLICK_HANDLER_NAME = "Wegpunkt zur Vampirfutterstelle setzen",
    PIN_FILTER_NAME = "Vampirfutterstelle",
}
