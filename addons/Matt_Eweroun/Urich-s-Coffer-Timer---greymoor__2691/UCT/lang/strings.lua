local strings = {
	...
	UCT_MSG_CMD_OPTION_10 =	"    /uct ss - To show the elapsed time since your last %s completion.",
	UCT_MSG_CMD_OPTION_11 =	"    /uct all - To show the elapsed time since your last completion of all trials.",
