...
ZO_CreateStringId("SI_TF_SETTING_COLOROPTIONS_TOOLTIP2", "Set role with role_dps, role_tank, or role_healer.")
ZO_CreateStringId("SI_TF_SETTING_COLORRESET", "Remove")
ZO_CreateStringId("SI_TF_SETTING_COLORRESET_TOOLTIP", "Remove the player or role.")
ZO_CreateStringId("SI_TF_SETTING_JRULES", "Based on player name or role")
ZO_CreateStringId("SI_TF_SETTING_JRULES_PSEUDOADD", "1. Add player name or role:")
ZO_CreateStringId("SI_TF_SETTING_JRULES_PSEUDOADD_TOOLTIP", "Add players name or role to the list to modify.")
...
ZO_CreateStringId("SI_TF_SETTING_JRULES_PSEUDOCHOICE", "2. Select a player or role")
ZO_CreateStringId("SI_TF_SETTING_JRULES_PSEUDOCHOICE_TOOLTIP", "Select the player's name or role you're looking for.")
