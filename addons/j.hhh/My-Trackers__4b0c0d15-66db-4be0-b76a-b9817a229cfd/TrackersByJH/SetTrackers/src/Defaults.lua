...
function JHSetTrackers.Defaults:Generate()
...
-- Account-wide
function JHSetTrackers.Defaults.Get()
  return defaults
end

-- Per-character
function JHSetTrackers.Defaults.GetCharacter()
  return {
    ["artifact"]    = artifacts,
...
function JHSetTrackers.Defaults.GetDefaultResourceOption(v)
...
function JHSetTrackers.Defaults.GetDefaultStackVariables(key)
