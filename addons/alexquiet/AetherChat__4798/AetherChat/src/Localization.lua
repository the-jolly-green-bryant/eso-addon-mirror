...
local STRINGS = {
    fr = {
        ...
        -- Resolution & Scaling
        SET_SCALE_HEADER      = "Affichage, Échelle & Résolution Écran",
        SET_SCALE_MODE        = "Adaptation à la Résolution",
        SET_SCALE_MODE_TT     = "Adapte automatiquement ou force l'échelle de l'interface selon la résolution de votre écran.",
        SET_SCALE_AUTO        = "Auto (Détection de l'écran)",
        SET_SCALE_720         = "720p (Écrans portables / HD)",
        SET_SCALE_1080        = "1080p (Full HD)",
        SET_SCALE_1440        = "1440p (2K QHD)",
        SET_SCALE_2160        = "2160p (4K UHD)",
        SET_SCALE_SLIDER      = "Échelle Manuelle de la Fenêtre",
        SET_SCALE_SLIDER_TT   = "Ajustez finement le niveau de zoom de la fenêtre AetherChat de 60% à 150%.",
    ...
    en = {
        ...
        -- Resolution & Scaling
        SET_SCALE_HEADER      = "Display, Scaling & Screen Resolution",
        SET_SCALE_MODE        = "Resolution Adaptation",
        SET_SCALE_MODE_TT     = "Automatically adapts or forces the interface scale according to your screen resolution.",
        SET_SCALE_AUTO        = "Auto (Screen Detection)",
        SET_SCALE_720         = "720p (Laptops / HD)",
        SET_SCALE_1080        = "1080p (Full HD)",
        SET_SCALE_1440        = "1440p (2K QHD)",
        SET_SCALE_2160        = "2160p (4K UHD)",
        SET_SCALE_SLIDER      = "Manual Window Scale",
        SET_SCALE_SLIDER_TT   = "Fine-tune the zoom level of the AetherChat window from 60% to 150%.",
