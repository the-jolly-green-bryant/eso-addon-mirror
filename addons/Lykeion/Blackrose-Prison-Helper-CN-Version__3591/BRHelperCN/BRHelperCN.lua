...
local bossWaveText = {}
-- Tames-the-Beast
bossWaveText[111315] = "巨魔"
bossWaveText[111329] = "蜥蜴"
bossWaveText[111332] = "龟龟"
-- Lady Minara
bossWaveText[114213] = "注入者"
bossWaveText[114223] = "大骷髅"
bossWaveText[114230] = "大骷髅 + 注入者"
bossWaveText[114236] = "大骷髅 + |cFF00002x|r 注入者"

function BR.Initialize()

	-- Retrieve savedVariables
	BR.savedVariables = ZO_SavedVars:NewAccountWide("BRHelperCNSavedVariables", BR.varVersion, nil, BR.defaultSettings)
...
local function NotifyNewWave()
	...
	if s == 1 then
		...
		if r == 4 and w == 2 then
			msg[dps] = "不管大剑哥, 干碎 2x 法师"

			msg[heal] = "|cFF00FF2x|r |cFFFF00法师 [北+南]|r"
			arr[heal] = {0.57945477962494, 0.79787236452103}

			msg[tank] = "|cFF00FF2x|r |cFFFF00法师 [北+南]|r"
			arr[tank] = {0.57413566112518, 0.87965422868729}
		end
		if r == 4 and w == 3 then msg[all] = "|c00FF00最后一波!|r" end

	-- STAGE 2
	elseif s == 2 then

		if r == 1 and w == 2 then msg[all] = "|cFF00FF2x|r |cFF0000鳄鱼!|r" end
		if r == 1 and w == 3 then
			msg[all] = "|cFFFF00弓手 [北]|r"
			arr[all] = {0.33743351697922, 0.70545214414597}
		end

		if r == 2 and w == 2 then msg[all] = "|cFF0000龟龟 + 鳄鱼!|r" end
		if r == 2 and w == 3 then
			msg[heal] = "|cFFFF00弓手 [北]|r"
			arr[heal] = {0.33743351697922, 0.70545214414597}

			msg[all] = "弓手 [北] + 蜘蛛"
		end

		if r == 3 and w == 1 then msg[all] = "巨魔, 2 蜘蛛, 2 birds" end
		if r == 3 and w == 2 then msg[all] = "|cFF00FF2x|r |cFF0000鳄鱼 + 巨魔!|r" end
		if r == 3 and w == 3 then
			msg[heal] = "|cFFFF00弓手 [东]|r"
			arr[heal] = {0.3916223347187, 0.734375}

			msg[all] = "巨魔 + 弓手 [东]"
		end

		if r == 4 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000鳄鱼!|r" end
		if r == 4 and w == 2 then
			msg[heal] = "|cFF00FF2x|r |cFFFF00弓手 [东+西]|r"
			arr[heal] = {0.390625, 0.75797873735428}

			arr[tank] = {0.30684840679169, 0.7516622543335}

			msg[all] = "|c00FF002x 弓手, 然后蜥蜴 (最后一波!)|r"
		end

		if r == 5 and w == 1 then msg[all] = "60% 龟龟, 40% 蜥蜴" end

	-- STAGE 3
	elseif s == 3 then

		if r == 1 and w == 2 then msg[all] = "|cFF00FF3x|r |cFF0000注入者!|r" end
		if r == 1 and w == 3 then msg[all] = "|cFF0000石像鬼|r + |cFF00FF2x|r |cFF0000注入者!|r" end
		
		if r == 2 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000注入者!|r" end
		if r == 2 and w == 3 then msg[all] = "|cFF0000石像鬼!|r" end

		if r == 3 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000注入者|r + 2x Cold 法师" end
		if r == 3 and w == 2 then msg[all] = "|cFF0000石像鬼!|r" end
		if r == 3 and w == 3 then msg[all] = "|cFF0000注入者|r [N]" end
	...
	elseif s == 4 then
		...
		if r == 1 and w == 1 then
			msg[all] = "|cFFFF00大剑哥 [北]|r"
			arr[all] = {0.67619681358337, 0.22639627754688}
		end
		if r == 1 and w == 2 then
			msg[all] = "|cFF0000鳄鱼 + 3x 法师|r"
		...
		if r == 3 and w == 2 then msg[all] = "|cFF0000龟龟|r + 蜘蛛" end
		if r == 3 and w == 3 then msg[all] = "|cFF0000Boss + 2x 鳄鱼!|r" end

		if r == 4 and w == 2 then msg[all] = "|cFF0000石像鬼 + 2x 注入者!|r" end
		if r == 4 and w == 3 then
			arr[heal] = {0.64128988981247, 0.28125}
			msg[all] = "|cFF0000Boss + 2x 法师!|r"
			BR.StartBatSwarmCountdown(18000)
		end

		if r == 5 and w == 3 then
			msg[tank] = "|cFF0000米纳拉夫人|r"
			BR.StartBatSwarmCountdown(18000)
		end
	...
	elseif s == 5 then
		...
		if r == 1 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end
		if r == 1 and w == 2 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end
		
		if r == 2 and w == 3 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end
		
		if r == 3 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end

		if r == 4 and w == 1 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end
		if r == 4 and w == 3 then msg[all] = "|cFF00FF2x|r |cFF0000法师!|r" end
	...
	if BR.savedVariables.enableChatMessages then
		d(string.format("层数: %s. 轮数: %s. 波数: %s.", s, r, w))
	end
...
function BR.Announcement(_, title, _)
	...
	if title == 'Final Round' or title == 'Letzte Runde' or title == 'Dernière manche' or title == 'Последний раунд' or title == '最終ラウンド' or title == '最终回合' then
		currentRound = 5
		currentWave = 0
	else
...
function BR.TakingAim(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN and targetType == COMBAT_UNIT_TYPE_PLAYER then
		...
		BR.ShowReticle(string.format('狙击: %s', FormatTakingAimList()))
...
function BR.TakingAimTimer()
	...
	if not text or text == "" then
		...
		BR.ShowReticle(string.format('狙击: %s', text))
	end
...
function BR.HeavyAttack(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN then
		...
		local color = "FFFF00"
		if string.find(sourceName, '石像鬼') then color = "FF0000"
		elseif string.find(sourceName, '米纳拉') then color = "FFFF00"
		elseif string.find(sourceName, '巨像') then color = "00FFFF"
		elseif string.find(sourceName, '犯') then color = "FFFF00"
		elseif string.find(sourceName, '德拉基') then color = "FFFF00" end
...
function BR.HeavyAttackTimer()
	...
	if not text or text == "" then
		...
		BR.ShowReticle(string.format('重击: %s', text))
	end
...
function BR.MeteorTick()
	...
	if meteorCount < 0 then
		...
		BR.ShowWin1(string.format('流星: |c%s%0.1f|r', color, meteorCount / 1000))
	end
...
function BR.BugBomb(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN then
		...
		BR.ShowWin1(zo_strformat('虫群: |cFFFFFF<<1>>|r', targetName == "" and "?" or targetName))
		PlaySound(SOUNDS.CHAMPION_POINTS_COMMITTED)
...
function BR.BatSwarmTick()
	...
	elseif nextBatSwarm - t <= 10000 then
		...
		BR.ShowWin2(string.format('蝠群: |c%s%d|r', color, math.max(0, (nextBatSwarm - t) / 1000)), 0.8)
	end
...
function BR.ChillSpear(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_EFFECT_GAINED and targetType == COMBAT_UNIT_TYPE_PLAYER and hitValue == 1 then
		...
		EVENT_MANAGER:UnregisterForUpdate("BRChillSpearTimer")
		BRHelper.ShowReticle('|cFF0000闪避 / 格挡|r')
...
function BR.ChillSpearTick()
	...
	if chillSpearCount < 0 then
		...
		BR.ShowReticle(string.format('冰冷尖矛: |cFF8800%0.1f|r', chillSpearCount / 1000))
	end
...
function BR.HauntingSpectre(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN and targetType == COMBAT_UNIT_TYPE_PLAYER then
		...
		BRHelper.ShowWin1('徘徊幽影 - |cFFFF00Interrupt!|r')
		zo_callLater(function() BR.HideWin1() end , 2000)
		PlaySound(SOUNDS.DUEL_START)
...
function BR.Void(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN then
		...
		BRHelper.ShowWin1(string.format('虚无: %s', FormatVoidList()))
		PlaySound(SOUNDS.DUEL_START)
...
function BR.VoidTimer()
	...
	if not text or text == "" then
		...
		BRHelper.ShowWin1(string.format('虚无: %s', text))
	end
...
function BR.BarrageOfStone(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN and targetType == COMBAT_UNIT_TYPE_PLAYER and hitValue == 1000 then
		...
		BR.ShowReticle(string.format('巨石: %s', FormatBarrageOfStoneList()))
		PlaySound(SOUNDS.CHAMPION_POINTS_COMMITTED)
...
function BR.BarrageOfStoneTimer()
	...
	if not text or text == "" then
		...
		BR.ShowReticle(string.format('巨石: %s', text))
	end
...
function BR.SpiritScreamTick()
	...
	if spiritScreamCount <= 0 then
		...
		BR.ShowWin2(string.format('爆炸: |c%s%0.1f|r', color, spiritScreamCount / 1000))
	end
...
function BR.RumblingSmash(eventCode, result, isError, abilityName, abilityGraphic, abilityActionSlotType, sourceName, sourceType, targetName, targetType, hitValue, powerType, damageType, log, sourceUnitId, targetUnitId, abilityId)
	...
	if result == ACTION_RESULT_BEGIN and hitValue == 2000 then
		...
		BR.ShowWin1(zo_strformat('跃向 |cFFFFFF<<1>>|r', targetName == "" and "?" or targetName))
