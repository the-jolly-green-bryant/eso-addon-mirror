...
local optionsTable = {
    ...
    },
    {
        ...
        type = "description", text = "A counter beside the indicator shows how many distinct mobs you are taking damage from. Not Tank counts only mobs attacking you. Tank Mode widens it to mobs attacking any groupmate, giving you a count of what you may not have under your control -- best-effort, since the client only receives some of the combat events happening to your groupmates.",
    },
    {
