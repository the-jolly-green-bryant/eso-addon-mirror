SousChef.Strings = {
	...
	de = {
		...
		-- Menu items
		MENU_MAIN_CHAR = "Haupt Koch Character",
		MENU_MAIN_CHAR_TOOLTIP = "Wähle den Charakter welcher die Rezepte verwaltet, und wessen Rezept Wissen die Markierungen an den Rezepten ausmachen soll",
		...
		MENU_RECIPE_TOOLTIP_HEADER = "Rezept Tooltips",
		...
		MENU_AUTO_JUNK = "Auto-Trödel Zutaten nicht auf Einkaufsliste",
		MENU_AUTO_JUNK_TOOLTIP = "Setzt gelootete Zutaten, welche sich nicht auf der Einkufsliste befinden, automatisch als Trödel.",
		MENU_AUTO_JUNK_WARNING = "ACHTUNG: Auto-Trödel der Zutaten sollte mit Vorsicht eingesetzt werden!",
		...
		MENU_DELETE_CHAR = "L\195\182sche Charakter",
		MENU_DELETE_CHAR_TOOLTIP = "Wähle einen Charakter aus welche aus den Sous Chef's Daten gelöscht werden soll, dann drücke den \"\L195\182sche Charakter\" Knopf.",
		MENU_DELETE_CHAR_BUTTON = "L\195\182sche Charater",
		...
		TOOLTIP_UNKNOWN = "!!! UNBEKANNT !!!",
		TOOLTIP_USED_IN = "Verwendet in:",
		TOOLTIP_CREATES = "Erstellt Level <<1>> <<t:2>>", -- where <<1>> is the level and <<2>> is the result name
		TOOLTIP_INGREDIENT_TYPES = {
			"Gew\195\188rz ",
