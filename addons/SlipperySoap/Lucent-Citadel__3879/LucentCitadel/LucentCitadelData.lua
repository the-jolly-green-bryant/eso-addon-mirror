...
LC.data    = {
  ...
  -- Orphic
  orphic_thunder_thrall = 214383, -- LC.data.orphic_thunder_thrall Xoryn jump
  orphic_thunder_thrall_initial_cd = 8.0, -- LC.data.orphic_thunder_thrall initial jump cooldown
  orphic_thunder_thrall_cd = 25.5, -- LC.data.orphic_thunder_thrall jump cooldown

  -- Credit: gangstah1x (NA) and Elm's Markers
  orphic_clock_pos_v1 = {
    -- fourth coordinate is the digit, each one appearing twice (in and out)
    [1] = {149287,22869,90537,1},
    [2] = {147496,22869,89769,2},
    [3] = {146724,22869,87953,3},
    [4] = {147509,22869,86176,4},
    [5] = {149337,22868,85394,5},
    [6] = {151099,22869,86223,6},
    [7] = {151916,22868,87948,7},
    [8] = {151177,22864,89698,8},
  },
  -- version 2
  orphic_clock_pos_v2 = {
    -- fourth coordinate is the digit, each one appearing twice (in and out)
    [1] = {149163,22868,85371,1},
    [2] = {150892,22865,86036,2},
    [3] = {151913,22868,87801,3},
    [4] = {151297,22863,89587,4},
    [5] = {149433,22868,90570,5},
    [6] = {147586,22864,89867,6},
    [7] = {146650,22868,87983,7},
    [8] = {147400,22864,86295,8},
  },
  ...
  orphic_clock_pos = {
    -- fourth coordinate is the digit, each one appearing twice (in and out)
    [1] = {149163,22868,85371,1},
    [2] = {150947,22865,86054,2},
    [3] = {151898,22868,87790,3},
    [4] = {151261,22863,89670,4},
    [5] = {149433,22868,90570,5},
    [6] = {147613,22864,89905,6},
    [7] = {146644,22867,88107,7},
    [8] = {147362,22864,86307,8},
  },

  orphic_clock_cardinal_pos = {
    -- fourth coordinate is the digit, each one appearing twice (in and out)
    [1] = {149509,22868,85378,"N"},
    [2] = {151282,22863,86345,"NE"},
    [3] = {151901,22868,88121,"E"},
    [4] = {150928,22863,89999,"SE"},
    [5] = {149081,22868,90601,"S"},
    [6] = {147338,22865,89635,"SW"},
    [7] = {146649,22867,87723,"W"},
    [8] = {147651,22863,86004,"NW"},
  },
  ...
  orphic_new_mirror_spawns = {213921}, -- LC.data.orphic_new_mirror_spawns
  ...
  cardinalDirections = {
    ...
    [8] = "W",
    [9] = "SW",
    }, -- LC.data.cardinalDirections

  orphicNumbersToCardinalDirections = {
    [1] = "N",
    [2] = "NE",
    [3] = "E",
    [4] = "SE",
    ...
    [7] = "W",
    [8] = "SW",
    }, -- LC.data.orphicNumbersToCardinalDirections

  orphicEliteAdds = {
		    ["Ruinach"]			= TARGET_MARKER_TYPE_ONE,
		    ["Crystal Hollow Sentinel"]		= TARGET_MARKER_TYPE_TWO,
            --["Xoryn"]		= TARGET_MARKER_TYPE_FIVE,
	    }, -- LC.data.orphicEliteAdds
  ...
  xorynName = "Xoryn", -- LC.data.xorynName
  xorynMarker = TARGET_MARKER_TYPE_EIGHT, -- eight is skull?

  -- Baron
  -- Aligning with Wondernuts's orientation
  baron_spot_pos = {
    -- fourth coordinate is the digit, each one appearing twice (in and out)
    [1] = {124254,33497,129221,1},
    [2] = {124074,33497,128701,2},
    [3] = {124306,33497,128196,3},
    [4] = {124694,33497,127773,4},
    [5] = {125247,33497,127771,5},
    [6] = {125627,33497,128206,6},
    [7] = {125825,33497,128717,7},
    [8] = {125635,33497,129237,8},
  }, -- LC.data.baron_spot_pos

  -- Simple Arrow
  simpleArrowDefaultSettings = {
        showArrow = true,
	    arrowColor = {1, 0, 1, 1},
	    arrowScale = 1.5,
  },
  ...
  orphic_color_change = 213913, -- LC.data.orphic_color_change 11s channel
  orphic_xoryn_heavy_shock = 222071, -- LC.data.orphic_xoryn_heavy_shock 

  -- Xoryn
  -- Tempest Assault is the name of the damage from the mirror mechanic. On a 30s cooldown.
  -- Credits to Tuggles2019 (NA) for helping me figure this out.
  xoryn_tempest_assault = 215184,
  xoryn_tempest_assault_cooldown = 30, -- LC.data.xoryn_tempest_assault_cooldown 30s
  xoryn_overloaded_current = 214745, -- LC.data.xoryn_overloaded_current

  arcane_knot = 213477, -- LC.data.arcane_knot
  arcane_knot_cooldown = 45, -- LC.data.arcane_knot_cooldown 45s

  fluctuating_start = 214570, -- LC.data.fluctuating_start
  ...
  zilyessetName = string.lower("Zilyesset"),
  cavotName = string.lower("Cavot Agnan"),
  orphicName = string.lower("Orphic Shattered Shard"),
  baronName = string.lower("Baron Rize"),
  xorynName = string.lower("Xoryn"),

  --default_color = { 1, 0.7, 0, 0.5 },
  dodgeDuration = GetAbilityDuration(28549),
  maxDuration = 4000,
  holdBlock = "Hold Block!",
  lucentCitadelId = 1478, -- Zone ID for Lucent Citadel
