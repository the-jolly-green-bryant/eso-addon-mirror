local lib = {}
LibSimpleArrowSlip = lib
-- This is @SlipperySoap's fork of andy.s's LibSimpleArrow
...
local function GetTexturePath()
	return LC.name.."/texture/arrow2.dds"
end
...
function lib.CreateTexture()
	...
	ARROW = WINDOW_MANAGER:CreateControl("LibSimpleArrowSlipTexture", RETICLE.control, CT_TEXTURE)
...
function lib.SetTargetXY(targX, targY)
	targetX = targX
	targetY = targY
end
...
function lib.ShowArrow()
	...
	EVENT_MANAGER:UnregisterForUpdate("LibSimpleArrowSlipUpdate")
	EVENT_MANAGER:RegisterForUpdate(
        "LibSimpleArrowSlipUpdate", 
        REFRESH_TIME, 
        function()
