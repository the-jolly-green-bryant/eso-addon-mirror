...
WritCreater.strings["welcomeMessage"] = "Merci d'avoir installé Dolgubon's Lazy Writ Crafter! Allez s'il vous plait vérifier les réglages pour customiser le comportement de l'addon"
...
WritCreater.optionStrings["donate"] = "Faire un don"
WritCreater.optionStrings["donateTooltip"] = "Faire un don à Dolgubon sur Paypal"
