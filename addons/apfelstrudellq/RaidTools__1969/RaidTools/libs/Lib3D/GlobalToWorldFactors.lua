...
if lib.factorsLoaded then return end

lib.factorsLoaded = true

DEFAULT_GLOBAL_TO_WORLD_FACTOR = 4000 / 0.16
...
--]]
	[888] = DEFAULT_GLOBAL_TO_WORLD_FACTOR * 3500 / 3220, --"Craglorn",
--[[
	[889] = "Molavar",
	[890] = "Rkundzelft",
	[891] = "Serpent's Nest",
