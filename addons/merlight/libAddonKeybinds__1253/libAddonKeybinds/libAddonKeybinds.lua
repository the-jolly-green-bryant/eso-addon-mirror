...
--]========================================================================]
--Already loaded before? Abort
if libAddonKeybinds ~= nil then return end

local myNAME, myVERSION = "libAddonKeybinds", 5
local LAK = {
    name = myNAME,
    version = myVERSION,
}
...
local function onLoad(eventCode, addonName)
    ...
    hookKeybindingListCallbacks(CATEGORY_DATA_TYPE, "libAddonKeybinds.SetupCategoryHeader", "libAddonKeybinds.HideCategoryHeader")
    hookKeybindingListCallbacks(KEYBIND_DATA_TYPE, "libAddonKeybinds.SetupKeybindRow", "libAddonKeybinds.HideKeybindRow")
