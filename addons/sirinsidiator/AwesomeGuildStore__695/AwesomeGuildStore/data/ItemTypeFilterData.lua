...
local DRINK_TYPE_FILTER = {
    ...
    values = {
        ...
        },
        {
            ...
            icon = "AwesomeGuildStore/images/buttons/tea_%s.dds",
        },
        {
...
local FOOD_TYPE_FILTER = {
    ...
    values = {
        ...
        },
        {
            ...
            icon = "AwesomeGuildStore/images/buttons/fruit_dish_%s.dds",
        },
        {
        ...
        },
        {
            ...
            icon = "AwesomeGuildStore/images/buttons/entremet_%s.dds",
        },
        {
        ...
        },
        {
            ...
            icon = "AwesomeGuildStore/images/buttons/unique_dish_%s.dds",
        },
    }
}
...
local CONSUMABLE_TROPHY_TYPE_FILTER = {
    ...
    values = {
        ...
        {
            id = SPECIALIZED_ITEMTYPE_CONTAINER_STACKABLE,
            label = zo_strformat(SI_TOOLTIP_ITEM_NAME, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_CONTAINER_STACKABLE)),
            icon = "EsoUI/Art/Inventory/inventory_tabIcon_container_%s.dds",
        },
        {
