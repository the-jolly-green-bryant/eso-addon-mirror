...
local SPECIAL_PARENT_MAP_ID = { -- Some maps zoom out to the zone map instead of the expected parent map
    ...
    [2501] = 2514, -- "Skingrad Outlaws Refuge" switches to "West Weald" instead of "Skingrad"
}
