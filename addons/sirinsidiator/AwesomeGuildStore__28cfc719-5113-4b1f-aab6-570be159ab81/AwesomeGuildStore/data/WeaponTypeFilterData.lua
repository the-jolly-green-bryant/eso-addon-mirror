...
local COMPANION_WEAPON_TYPE_FILTER = {
    id = FILTER_ID.COMPANION_WEAPON_TYPE_FILTER,
    type = TRADING_HOUSE_FILTER_TYPE_WEAPON,
    unpack = UnpackWeaponType,
    label = label,
    enabled = {
    ...
    values = {
        {
            id = WEAPONTYPE_AXE,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_ONE_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_AXE)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_1h_Axe_%s.dds",
        },
        {
            id = WEAPONTYPE_HAMMER,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_ONE_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_HAMMER)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_1h_Mace_%s.dds",
        },
        {
            id = WEAPONTYPE_SWORD,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_ONE_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_SWORD)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_1h_Sword_%s.dds",
        },
        {
            id = WEAPONTYPE_DAGGER,
        ...
        {
            id = WEAPONTYPE_TWO_HANDED_AXE,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_TWO_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_TWO_HANDED_AXE)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_2h_Axe_%s.dds",
        },
        {
            id = WEAPONTYPE_TWO_HANDED_HAMMER,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_TWO_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_TWO_HANDED_HAMMER)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_2h_Mace_%s.dds",
        },
        {
            id = WEAPONTYPE_TWO_HANDED_SWORD,
            label = string.format("%s %s", GetString("SI_EQUIPTYPE", EQUIP_TYPE_TWO_HAND), GetString("SI_WEAPONTYPE", WEAPONTYPE_TWO_HANDED_SWORD)),
            icon = "EsoUI/Art/TradingHouse/Tradinghouse_Weapons_2h_Sword_%s.dds",
        },
        {
            id = WEAPONTYPE_BOW,
            label = GetString("SI_WEAPONTYPE", WEAPONTYPE_BOW),
            icon = "EsoUI/Art/Inventory/Inventory_TabIcon_Bow_%s.dds",
        },
        {
            id = WEAPONTYPE_FIRE_STAFF,
            label = GetString("SI_WEAPONTYPE", WEAPONTYPE_FIRE_STAFF),
...
AGS.data.COMPANION_WEAPON_TYPE_FILTER = COMPANION_WEAPON_TYPE_FILTER
