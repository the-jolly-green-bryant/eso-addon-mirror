...
local function alternateListener(eventCode,  channelType, fromName, text, isCustomerService, fromDisplayName)
	if false then -- Easter egg removed
...
WritCreater.strings["withdrawItem"]					= function(amount, link, remaining) return "Baas Writ Crafter pobrał "..amount.." "..link..". (W banku: "..remaining..")" end
WritCreater.strings['fullBag']						= "Nie masz wolnych miejsc w plecaku. Opróżnij swój plecak."
WritCreater.strings['masterWritSave']				= "Baas Writ Crafter uchronił cię przed przypadkowym zaakceptowaniem Mistrzowskiego zlecenia! Przejdź do menu ustawień, aby wyłączyć tę opcję."
WritCreater.strings['missingLibraries']				= "Baas Writ Crafter wymaga następujących samodzielnych bibliotek. Prosimy o pobranie, zainstalowanie lub włączenie tych bibliotek: "
...
WritCreater.strings['welcomeMessage']				= "Dziękujemy za zainstalowanie Baas Writ Crafter! Sprawdź ustawienia, aby dostosować zachowanie dodatku"
...
WritCreater.optionStrings["skinOptions"]               = {"Domyślny", "Serowy", "Koza", "Fabulous"}
