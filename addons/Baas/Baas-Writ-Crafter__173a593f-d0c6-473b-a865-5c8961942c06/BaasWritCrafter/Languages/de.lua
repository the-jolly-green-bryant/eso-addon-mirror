...
WritCreater.strings["missingLibraries"]							= "Baas Writ Crafter benötigt die folgenden Standalone-Libraries. Bitte installiere oder aktiviere diese Libraries: "
WritCreater.strings['fullBag']									= "Du hast keinen Platz mehr im Inventar. Bitte leere dein Inventar."
WritCreater.strings['masterWritSave']							= "Baas Writ Crafter hat verhindert, dass du versehentlich einen Meisterschrieb annimmst. Gehe in die Erweiterungseinstellungen, um diese Option zu deaktivieren."
WritCreater.strings['missingLibraries']							= "Baas Writ Crafter requires the following standalone libraries. Please download, install or turn on these libraries: "
...
WritCreater.strings["withdrawItem"]								= function(amount, link, remaining) return "Baas Writ Crafter entnahm "..amount.." "..link..". (Noch "..remaining.." in der Bank)" end -- in Bank for German
...
WritCreater.strings["welcomeMessage"] 							= "Danke, dass Ihr Baas Writ Crafter installiert habt. Bitte ruft die Einstellungen auf, um das Addon auf Eure Vorlieben anzupassen"
