...
WritCreater.strings["withdrawItem"]				    = function(amount, link, remaining) return "Baas Writ Crafter retiró "..amount.." "..link..". ("..remaining.." en el banco)" end
WritCreater.strings['fullBag']                      = "No tienes espacio en el inventario. Por favor, vacíe su inventario."
WritCreater.strings['masterWritSave']               = "¡Baas Writ Crafter te ha salvado de aceptar accidentalmente un encargo maestro! Ve al menú de configuración para deshabilitar esta opción."
WritCreater.strings['missingLibraries']             = "Baas Writ Crafter requiere las siguientes librarías independientes. Por favor descargue, instale o active estas librarías: "
