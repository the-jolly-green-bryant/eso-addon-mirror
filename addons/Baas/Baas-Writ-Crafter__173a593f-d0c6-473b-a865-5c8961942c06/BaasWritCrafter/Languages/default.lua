...
WritCreater.strings["withdrawItem"]					= function(amount, link, remaining) return "Baas Writ Crafter retrieved "..amount.." "..link..". ("..remaining.." in bank)" end -- in Bank for German
WritCreater.strings['fullBag']						= "You have no open bag spaces. Please empty your bag."
WritCreater.strings['masterWritSave']				= "Baas Writ Crafter has saved you from accidentally accepting a master writ! Go to the settings menu to disable this option."
...
WritCreater.strings['welcomeMessage']				= "Thanks for installing Baas Writ Crafter! Please check out the settings to customize the behaviour of the addon"
