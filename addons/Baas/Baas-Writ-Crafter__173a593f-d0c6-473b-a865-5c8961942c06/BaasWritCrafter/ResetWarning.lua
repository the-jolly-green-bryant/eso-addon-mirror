...
local function windowWarning(msgText)
	BaasLazyWritResetWarnerBackdropOutput:SetText(msgText)
	BaasLazyWritResetWarner:SetHidden(false)
	BaasLazyWritResetWarnerBackdropClose:SetText("Close")
	BaasLazyWritResetWarnerBackdropClose:ClearAnchors()
	BaasLazyWritResetWarnerBackdropClose:SetAnchor(BOTTOM,BaasLazyWritResetWarnerBackdrop, BOTTOM, 0, -15 )
	BaasLazyWritResetWarnerBackdropButton2:SetHidden(true)
end
...
function WritCreater.showSettingsChoice(question)
	BaasLazyWritResetWarnerBackdropOutput:SetText(question)
	BaasLazyWritResetWarner:SetHidden(false)
	-- BaasLazyWritResetWarnerBackdropClose:SetText("On")
	-- BaasLazyWritResetWarnerBackdropButton2:SetText("Off")
	-- BaasLazyWritResetWarnerBackdropClose:ClearAnchors()
	-- BaasLazyWritResetWarnerBackdropClose:SetAnchor(BOTTOM,BaasLazyWritResetWarnerBackdrop, BOTTOM, -100, -15 )
	-- BaasLazyWritResetWarnerBackdropButton2:SetHidden(false)
	needsReset = true
end
