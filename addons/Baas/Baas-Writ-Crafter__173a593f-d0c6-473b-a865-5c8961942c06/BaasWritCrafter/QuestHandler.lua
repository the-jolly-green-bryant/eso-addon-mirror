...
EVENT_MANAGER:RegisterForEvent("BaasWritCrafterGoldListener", EVENT_QUEST_COMPLETE_DIALOG, QuestCompleteDialogGoldListener)
EVENT_MANAGER:RegisterForEvent("BaasWritCrafterGoldListener", EVENT_QUEST_COMPLETE, QuestConfirmCompleteGoldListener)
...
--EVENT_MANAGER:RegisterForEvent("BaasWritCrafterMasterWrit", EVENT_QUEST_OFFERED, handleMasterWritQuestOffered)
