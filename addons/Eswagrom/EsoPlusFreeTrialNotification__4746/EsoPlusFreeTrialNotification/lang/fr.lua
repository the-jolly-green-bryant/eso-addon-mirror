...
local strings = {
    ...
    ["STRING_ESOPLUSFREETRIALNOTIFICATION_UNAVA"] = "|cFF0000indisponible|r",
...
["STRING_ESOPLUSFREETRIALNOTIFICATION_ADDON_NAME_INFORMATION"] ="|cFF6347Le tableau est maintenant ci-dessous:|r",
["STRING_ESOPLUSFREETRIALNOTIFICATION_ADDON_NAME_INFORMATION_A"] ="|c9999FFLors de l'affichage d'un grand nombre d'enregistrements (2000 par défaut), le tableau peut s'ouvrir avec un délai d'une seconde, c'est normal.|r |cFFFFC5Ouvrez le tableau:|r",

["STRING_ESOPLUSFREETRIALNOTIFICATION_GENERAL_INFORMATION__ALLRECORDS"] = "|ccdfff3Tous les enregistrements|r",
