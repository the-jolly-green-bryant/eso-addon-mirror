...
local strings = {
    ...
    ["STRING_ESOPLUSFREETRIALNOTIFICATION_UNAVA"] = "no disponible",
    ...
    ["STRING_ESOPLUSFREETRIALNOTIFICATION_INFORMATION_ESO_PLUS_A"] = "|c9999FF/esoplus|r |cFF6347¡escribe en el chat para verificar manualmente!|r Este addon guarda registros sobre la obtención de la prueba gratuita, así que siempre sabrás exactamente cuándo se activó o faltó.",
