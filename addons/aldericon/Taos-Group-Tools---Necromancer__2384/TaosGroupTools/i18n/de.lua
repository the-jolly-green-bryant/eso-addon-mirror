...
local strings = {
	...
	TGT_DESCRIPTIONS_NHEAL =             "Hain Ultimates der Necromancer Klasse",
	TGT_DESCRIPTIONS_NTANK =             "Tank Ultimates der Necromancer Klasse",
	TGT_DESCRIPTIONS_NDPS =              "DPS Ultimates der Necromancer Klasse",
