...
local function CreateUltimateGroups()
	...
	local necroDPS = {}
    necroDPS.GroupName = "NDPS"
    necroDPS.GroupDescription = GetString(TGT_DESCRIPTIONS_NDPS)
    necroDPS.GroupAbilityPing = 28
    necroDPS.GroupAbilityId = 122174

	local necroTank = {}
    necroTank.GroupName = "NTANK"
    necroTank.GroupDescription = GetString(TGT_DESCRIPTIONS_NTANK)
    necroTank.GroupAbilityPing = 29
    necroTank.GroupAbilityId = 118279
	
    local necroHealing = {}
    necroHealing.GroupName = "NHEAL"
    necroHealing.GroupDescription = GetString(TGT_DESCRIPTIONS_NHEAL)
    necroHealing.GroupAbilityPing = 21
    necroHealing.GroupAbilityId = 115410
    ...
    { 
		...
		necroDPS, necroTank, necroHealing,
