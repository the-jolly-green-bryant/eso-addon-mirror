...
L("CATEGORY_USED", "Show number of widgets in use")
L("CATEGORY_USED_TT", "This number will only update after a UI reload.")
...
L("HIDE_FOUND", "Hide leads previously found")
...
L("NIGHT_MARKET_HIDE", "Only show in the <<1>>")
L("NIGHT_MARKET_ACTIVE", "Active")
L("NIGHT_MARKET_INACTIVE", "Inactive")
L("NIGHT_MARKET_PORT", "Travel to the <<1>>")
...
L("SOUL_GEMS_CROWN", "Include Crown Soul Gems")
L("SOUND", "Sound")
...
L("TOGGLE", "Toggle <<1>>")
L("TOMES_SEASONAL_PROGRESS", "Tamriel Tomes Seasonal")
L("TOMES_SEASONAL_PROGRESS_BEST", "Tamriel Tomes Seasonal Best Progress")
L("TOMES_SEASONAL_TIME_REMAINING", "Tamriel Tomes Season Time Remaining")
L("TOMES_WEEKLY_PROGRESS", "Tamriel Tomes Weekly")
L("TOMES_WEEKLY_PROGRESS_BEST", "Tamriel Tomes Best Weekly Progress")
L("TOMES_WEEKLY_TIME_REMAINING", "Tamriel Tomes Weekly Time Remaining")
