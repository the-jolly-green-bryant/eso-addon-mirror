...
L("CATEGORY_USE", "Utiliser les catégories de widgets")
L("CATEGORY_USED", "Afficher le nombre de widgets utilisés")
L("CATEGORY_USED_TT", "Ce nombre ne sera mis à jour qu'après un rechargement de l'interface utilisateur.")
...
L("DAILY_QUEST_COUNT", "Nombre de quêtes journalières")
...
L("ENLIGHTENED", "Montant éclairé")
L("EQUIPPED_POISON", "Poison équipé")
L("EXPERIMENTAL", "Expérimental")
L("EXPERIMENTAL_DESC", "Ce widget est en cours de développement, n'hésitez pas à soumettre vos commentaires.")
L("EXPORT", "Exporter")
...
L("FONT_STYLE", "Style de police")
L("FOOD_BUFF", "Buff de nourriture/boisson")
L("FPS", "IPS")
...
L("GOLDEN_PURSUITS_HIDE_DEFAULT", "Masquer le tracker par défaut")
L("GREEN", "Verte")
...
L("HIDE_FOUND", "Masquer les leads précédemment trouvés")
...
L("HIGHEST", "Score le plus élevé")
L("HORIZONTAL", "Horizontale")
L("HOURS", "Heures")
L("ICONGAP", "Espace entre l'icône et le texte")
L("IMPORT", "Importer")
...
L("INFINITE_ARCHIVE_PORT", "Voyager vers l'Archive Infinie")
L("INFINITE_ARCHIVE_PROGRESS", "Progression de l'Archive Infinie")
L("INFINITE_ARCHIVE_SCORE", "Score de l'Archive Infinie")
L("INFINITE_ARCHIVE_SHOW", "Afficher uniquement dans l'Archive Infinie")
L("INVERT", "Inverser la logique d'avertissement/de danger")
L(
    "INVERT_TOOLTIP",
    "Modifiez la logique de façon à ce que les valeurs supérieures à celles saisies déclenchent le changement de couleur. Le comportement par défaut se déclenche sur des valeurs inférieures."
)
L("INVERT_HIDE", "Inverser la logique")
...
L("NIGHT_MARKET_HIDE", "Afficher uniquement dans le <<1>>")
L("NIGHT_MARKET_ACTIVE", "Active")
L("NIGHT_MARKET_INACTIVE", "Inactive")
L("NIGHT_MARKET_PORT", "Voyager vers le <<1>>")
...
L("PVP_NEVER", "Ne s'affiche pas en JcJ")
...
L("RESTRICT_TOOLTIP", "Restreindre l'infobulle aux objets d'inventaire")
L("RIGHT", "À droite")
...
L("SHORTEN_WORLDNAME", "Supprimer 'Megaserver'")
L("SHOW_BACKDROP", "Afficher le fond")
L("SHOW_CLASS_ICON", "Afficher l'icône de classe")
L("SHOW_EVERYWHERE", "Afficher partout")
L("SHOW_FOUND", "Afficher trouvé")
...
L("SOUL_GEMS_CROWN", "Inclure les gemmes d'âme de couronne")
L("SOUND", "Son")
...
L("TIER_POINTS", "Niveau <<1>>, Points <<2>>")
...
L("TIMER_FORMAT_TEXT_MINUTES_SECONDS", "<<1>>m <<2>>s")
L("TIMER_FORMAT_TEXT_WITH_SECONDS", "<<1>>j <<2>>h <<3>>m <<4>>s")
L("TIMER_FORMAT_TEXT_WITH_SECONDS_NO_DAYS", "<<1>>h <<2>>m <<3>>s")
L("TOGGLE", "Basculer <<1>>")
L("TOMES_SEASONAL_PROGRESS", "Tamriel Tomes – Saisonnier")
L("TOMES_SEASONAL_PROGRESS_BEST", "Tamriel Tomes – Meilleure progression saisonnière")
L("TOMES_SEASONAL_TIME_REMAINING", "Tamriel Tomes – Temps de saison restant")
L("TOMES_WEEKLY_PROGRESS", "Tamriel Tomes – Hebdomadaire")
L("TOMES_WEEKLY_PROGRESS_BEST", "Tamriel Tomes – Meilleure progression hebdomadaire")
L("TOMES_WEEKLY_TIME_REMAINING", "Tamriel Tomes – Temps hebdomadaire restant")
...
L("VAMPIRE_STAGE_NUMERIC", "Afficher uniquement le numéro de stage")
