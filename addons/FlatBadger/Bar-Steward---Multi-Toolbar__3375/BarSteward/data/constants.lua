...
BarSteward = {
    ...
    W_GUILD_FRIENDS = 51,
    W_TOMES_SEASONAL_TIME = 52,
    W_WEEKLY_TOMES_TIME = 53,
...
BS.RecipeTypes = {
    ...
    nonFood = {
        { type = SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING,  name = SI_SPECIALIZEDITEMTYPE172 },
        { type = SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING,       name = SI_SPECIALIZEDITEMTYPE173 },
        { type = SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING,   name = SI_SPECIALIZEDITEMTYPE174 },
        { type = SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING,        name = SI_SPECIALIZEDITEMTYPE175 },
        { type = SPECIALIZED_ITEMTYPE_RECIPE_PROVISIONING_DESIGN_FURNISHING,    name = SI_SPECIALIZEDITEMTYPE176 },
        { type = SPECIALIZED_ITEMTYPE_RECIPE_WOODWORKING_BLUEPRINT_FURNISHING,  name = SI_SPECIALIZEDITEMTYPE177 },
