...
function Menu:Register()
    ...
    panel:AddSetting({
        ...
        label = "All Live Stats",
    })

    panel:AddSetting({
        type = settingsLibrary.ST_CHECKBOX,
        label = "Enable All Live Stats",
        tooltip = "Show live raid time, vitality, and current score while a scored trial is in progress.",
    ...
    panel:AddSetting({
        ...
        tooltip = "Move All Live Stats from the far left edge to the far right edge of the screen.",
        min = 0,
        max = 100,
        step = 1,
        format = "%.0f",
    ...
    panel:AddSetting({
        ...
        tooltip = "Move All Live Stats from the top edge to the bottom edge of the screen.",
        min = 0,
        max = 100,
        step = 1,
        format = "%.0f",
    ...
    panel:AddSetting({
        type = settingsLibrary.ST_SLIDER,
        label = "Live Stats Scale",
        tooltip = "Adjust the size of All Live Stats.",
        min = 0.75,
        max = 1.50,
        step = 0.05,
        format = "%.2f",
    ...
    panel:AddSetting({
        ...
        buttonText = "Restore",
        tooltip = "Restore All Live Stats to its default position and size.",
