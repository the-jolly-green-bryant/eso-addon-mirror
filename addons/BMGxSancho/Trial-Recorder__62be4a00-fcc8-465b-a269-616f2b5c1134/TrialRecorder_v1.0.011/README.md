...
- Recent clear history with character, date, clear type, time, and score
...
Beginning with v1.0.011, every newly recorded clear stores the remaining raid vitality and displays it in the trial window. Existing records are not backfilled and show `Not recorded`.


## Active Timer

The optional Active Timer displays ESO's native live raid duration and can be positioned and scaled from the addon settings.
