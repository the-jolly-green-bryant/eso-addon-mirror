...
function Settings:RegisterPanel()
    ...
    panel:AddSettings({
        ...
        { type = LHAS.ST_CHECKBOX, label = "Show Personal Assignments window", tooltip = "Show or hide the personal responsibility window for Trial Lead and Support roles.", getFunction=function() return SRC.saved.personalAssignmentsEnabled ~= false end, setFunction=function(v) SRC.saved.personalAssignmentsEnabled=v; Settings:ApplyDisplayMode(); if not v and SRC.Display and SRC.Display.personal then SRC.Display.personal:SetHidden(true) end end },
