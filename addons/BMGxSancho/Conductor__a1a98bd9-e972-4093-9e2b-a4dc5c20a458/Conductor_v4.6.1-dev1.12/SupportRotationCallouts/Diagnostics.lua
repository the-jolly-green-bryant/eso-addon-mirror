...
function Diagnostics:GetNetworkSummaryLines()
    ...
    lines[#lines + 1] = string.format("Discovery channel: %s", info.discoveryReady and "ready" or "unavailable")
    if info.discoveryError and info.discoveryError ~= "" then lines[#lines + 1] = "Discovery error: " .. tostring(info.discoveryError) end
