...
AM.ICONS = {
    ...
    { id = 308, name = 'Lady Pepe', pack = "meme_legends", texture = "AboveMe/assets/meme_legends_expansion_atlas.dds", left = 0.008000, right = 0.492000, top = 0.016000, bottom = 0.984000 },
    { id = 309, name = 'Giga Staci', pack = "meme_legends", texture = "AboveMe/assets/meme_legends_expansion_atlas.dds", left = 0.508000, right = 0.992000, top = 0.016000, bottom = 0.984000 },
    { id = 310, name = 'UWU FROG', pack = "meme_legends", texture = "AboveMe/assets/meme_legends_expansion2_atlas.dds", left = 0.008000, right = 0.492000, top = 0.016000, bottom = 0.984000 },
    { id = 311, name = 'Plotting Pepe', pack = "meme_legends", texture = "AboveMe/assets/meme_legends_expansion2_atlas.dds", left = 0.508000, right = 0.992000, top = 0.016000, bottom = 0.984000 },
