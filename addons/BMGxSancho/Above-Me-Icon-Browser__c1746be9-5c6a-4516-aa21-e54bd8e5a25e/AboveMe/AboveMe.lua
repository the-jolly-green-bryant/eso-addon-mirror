...
local AM = AboveMe
AM.name="AboveMe"
AM.version="0.7.5-dev1"
local CURRENT_SETTINGS_VERSION=9
local defaults={settingsVersion=CURRENT_SETTINGS_VERSION,enabled=true,iconId=101,selectedCategory="classic",showOwnIcon=true,showGroupIcons=true,combatOnly=false,size=48,opacity=1,maxDistance=55,distanceScaling=false,fadeWithDistance=false,updateRate=75,favorites={},recentIcons={},randomFavoriteOnLogin=false}
...
function AM:MigrateSavedVariables()
    ...
    -- Placement is now fixed to the native-style overhead position. Keep old
    -- fields harmless for migration, but they no longer influence rendering.
