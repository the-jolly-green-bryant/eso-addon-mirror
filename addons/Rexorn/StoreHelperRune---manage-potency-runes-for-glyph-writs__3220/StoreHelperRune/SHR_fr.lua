...
,SHR_purchased_msg      = "SHR: acheté %u %s"								-- ie purchased 5 Jora
,SHR_buy_reduced_msg    = "SHR: réduction de l'achat de %s de %u à %u - vérifier l'or"
,SHR_load_not_accepted  = "SHR: StoreHelper n'a pas chargé les fonctions SHR"
,SHR_add_for_store_desc = "acheter des runes de puissance utilisées dans les brefs de base en cas de besoin"	-- SH will show this when adding SHRune

,SHR_OptMenu_header_name = "Store Helper Rune Possibilités"
,SHR_OptMenu_description = "Conservez un nombre minimum de runes de puissance pour les commandes de base.\nCompte uniquement le sac d'artisanat, la banque et l'inventaire actuel des personnages."
,SHR_OptMenu_chk_UseToon_name	  = "Utiliser les paramètres de caractères"
,SHR_OptMenu_chk_UseToon_tooltip  = "utiliser les paramètres de ce personnage au lieu des paramètres par défaut du compte"

,SHR_OptMenu_box_genRune_tooltip  = "min pour garder en stock: 0-50 (utiliser la boîte pour >50)"


-- these are only used for display purposes
,SHR_OptMenu_craft_block_description = "Runes additives nécessaires pour créer des glyphes pour les brefs"
,SHR_opt_Jora	= "Jora"
,SHR_opt_Jera	= "Jera"
,SHR_opt_Odra	= "Odra"
,SHR_opt_Edora	= "Edora"
...
,SHR_OptMenu_handin_description = "Runes soustractives nécessaires pour remettre les brefs"
,SHR_opt_Jode	= "Jode"
,SHR_opt_Ode	= "Ode"
,SHR_opt_Jayde	= "Jayde"
