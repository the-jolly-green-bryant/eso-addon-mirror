...
,SHR_purchased_msg      = "SHR: purchased %u %s"								-- ie purchased 5 Jora
,SHR_buy_reduced_msg    = "SHR: reducing %s purchase from %u to %u - check gold"
,SHR_load_not_accepted  = "SHR: StoreHelper did not load SHR functions"
,SHR_add_for_store_desc = "buy potency runes used in basic writs when needed"	-- SH will show this when adding SHRune

,SHR_OptMenu_header_name = "Store Helper Rune Options"
,SHR_OptMenu_description = "Keep a minimum number of potency runes for basic writs.\nCounts craftbag, bank, & current toon inventory only."
,SHR_OptMenu_chk_UseToon_name	  = "Use Toon Settings"
,SHR_OptMenu_chk_UseToon_tooltip  = "use settings for this toon instead of account defaults"

,SHR_OptMenu_box_genRune_tooltip  = "min to keep in stock: 0-50 (use box for >50)"


-- these are only used for display purposes
,SHR_OptMenu_craft_block_description = "Additive Runes needed to craft glyphs for writs"
,SHR_opt_Jora	= "Jora"
,SHR_opt_Jera	= "Jera"
,SHR_opt_Odra	= "Odra"
,SHR_opt_Edora	= "Edora"
...
,SHR_OptMenu_handin_description = "Subtractive Runes needed to hand in with writs"
,SHR_opt_Jode	= "Jode"
,SHR_opt_Ode	= "Ode"
,SHR_opt_Jayde	= "Jayde"
