-- Guard: This file patches TamrielTradeCentre (TTC). If TTC is not installed/enabled
-- or loads after this addon, TamrielTradeCentre can be nil and the addon would crash.
if type(TamrielTradeCentre) ~= "table" then return end
