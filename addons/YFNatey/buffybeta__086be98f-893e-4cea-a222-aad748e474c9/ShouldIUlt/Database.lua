...
ShouldIUlt.buffTypeMap = {
    ...
    -- Turning Tide (tracked separately by TurningTide.lua, but registered here
    -- so IsTrackedBuff and FindBuffNameInDatabase work correctly)
    turningTide = {
        setting = "trackTurningTide",
        major = nil,
        minor = "Turning Tide"
    },
}
...
function ShouldIUlt:GetBuffIcon(buffName, suppressFallback)
    local iconMap = {
        ...
        ["Turning Tide"] = "/esoui/art/icons/ability_weapon_001.dds",
    }
