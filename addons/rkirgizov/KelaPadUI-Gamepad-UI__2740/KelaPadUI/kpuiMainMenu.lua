...
KELAPADUI_CATEGORY_SETTINGS = 22
	...
	[MENU_MAIN_ENTRIES.KELAPADUI] =
	{
		...
		subMenu = 
		{
			[KELAPADUI_ENTRIES.RESEARCHING] =
            {
				...
				isVisibleCallback = function()
                    return KelaGetSetting_Bool(SETTING_TYPE_KELA, KELA_SETTING_PANEL_RESEARCHES_ENABLED)
                end,
            },
			[KELAPADUI_ENTRIES.SETS] =
            {
				...
				isVisibleCallback = function()
                    return KelaGetSetting_Bool(SETTING_TYPE_KELA, KELA_SETTING_PANEL_SETS_ENABLED)
                end,
            },
			[KELAPADUI_ENTRIES.UNDAUNTED] = 
            {
				...
				isVisibleCallback = function()
                    return KelaGetSetting_Bool(SETTING_TYPE_KELA, KELA_SETTING_PANEL_UPU)
                end,
            },
			[KELAPADUI_ENTRIES.SETTINGS] =
            {
				prePadding = 150,
                scene = "kela_options_root",
...
CATEGORY_TO_ENTRY_DATA =
{
    ...
    [KELAPADUI_CATEGORY_SETTINGS]      	= MENU_ENTRY_DATA[MENU_MAIN_ENTRIES.KELAPADUI].subMenu[KELAPADUI_ENTRIES.SETTINGS],
