...
-- New Need Translations
	...
	PCHAT_MENTIONS_DING_NAME = "Sonido?",
	PCHAT_MENTIONS_DING_TOOLTIP = "Si desea o no reproducir un sonido cuando se menciona su nombre.",
	PCHAT_MENTIONS_DING_SOUND_NAME = "Sonido: ",
