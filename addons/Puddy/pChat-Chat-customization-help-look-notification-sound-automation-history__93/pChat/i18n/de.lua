...
SafeAddString(PCHAT_MENTIONS_DING_NAME ,  "\'Klang\' abspielen?", 1)
SafeAddString(PCHAT_MENTIONS_DING_TOOLTIP ,  "Soll ein Klang ertönen, wenn eine Erwähnung vorliegt?", 1)
SafeAddString(PCHAT_MENTIONS_DING_SOUND_NAME, "Klang: ", 1)
SafeAddString(PCHAT_MENTIONS_DING_SOUND_NAME_TOOLTIP, "Wähle den Klang aus, welcher abgespielt werden soll", 1)
SafeAddString(PCHAT_MENTIONS_APPLYNAME_NAME ,  "Charakter Namen berücksichtigen?", 1)
...
SafeAddString(PCHAT_MENTIONS_WHOLEWORD_NAME ,  "Charakter Name nur als ganzes Wort", 1)
SafeAddString(PCHAT_MENTIONS_WHOLEWORD_TOOLTIP ,  "Charakter Namen werden nur als ganze Wörter geprüft, und nicht jeder Charakternamen Bestandteil (durch Leerzeichen getrennt) einzeln.\nWenn du einen kurzen Charakternamen Bestandteil verwendest, z.B. \'der\' in \'Baertram der Bärenfreund\', dann sollte diese Option dir helfen, dass nicht zuviele Benachrichtigungen erscheinen.", 1)
