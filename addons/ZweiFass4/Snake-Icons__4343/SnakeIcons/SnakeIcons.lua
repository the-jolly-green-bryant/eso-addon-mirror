...
local SnakeIcons_SV = nil

local function GetIconsResolution()
	if SnakeIcons_SV and SnakeIcons_SV.resolutionChoice and SnakeIcons_SV.resolutionChoice ~= "Flat" then
		return tostring(SnakeIcons_SV.resolutionChoice)
	end
	return nil
end
...
local function GetAddOnIconsPath()
	...
	if res == nil then
		return "/SnakeIcons/icons/"
	end
	return "/SnakeIcons/icons/" .. res .. "/"
end
...
local ADDON_ICONS = {
	...
	"ability_arcanist_002_a_alt.dds",
	"ability_arcanist_002_alt.dds",
	"ability_arcanist_002_b.dds",
	"ability_arcanist_002_b_alt.dds",
	...
	"ability_grimoire_1handed_frostpng.dds",
	...
	"ability_skeevatonabsorb.dds",
	"ability_skeevatonbarrier.dds",
	"ability_skeevatonbomb.dds",
	"ability_skeevatonenergize.dds",
	"ability_skeevatonjolt.dds",
	"ability_skeevatonrebuild.dds",
	"ability_skeevatonrestore.dds",
	"ability_skeevatonschock.dds",
	"ability_skeevatonshockfield.dds",
	"ability_skeevatontrap.dds",
	"ability_skeevatonweld.dds",
	...
	"ability_u26_vampire_06b.dds",
	"ability_u27_behemothbitterboom.dds",
	"ability_u27_behemothbonecrusher.dds",
	"ability_u27_behemothmutilate.dds",
	"ability_u27_behemothrallyingroar1.dds",
	"ability_u27_behemothrallyingroar2.dds",
	"ability_u27_behemothrampage.dds",
	"ability_u27_behemothswipe.dds",
	"ability_u27_behemothtremor.dds",
	"ability_u27_behemothviciousgnaw.dds",
	"ability_u27_bestialannihilation1.dds",
	"ability_u27_bestialannihilation2.dds",
...
local function InitializeSettings()
	SnakeIcons_SV = ZO_SavedVars:NewAccountWide("SnakeIcons_SavedVariables", SAVEDVARS_VERSION, nil, DEFAULTS)
	...
	local panelData = {
		type = "panel",
		name = "Snake Icons",
		displayName = "|cffaa00Snake|r Icons",
		author = "|ce6202dZweiFass4|r",
		version = tostring(GetAddOnVersion and GetAddOnVersion(ADDON_NAME) or ""),
		registerForRefresh = true,
		registerForDefaults = true,
	}

	LAM2:RegisterAddonPanel("SnakeIcons_Panel", panelData)

	local optionsData = {
		{
			type = "dropdown",
			name = "Icon pack resolution",
			tooltip = "Select which resolution folder Snake icons should use.",
			choices = { "64", "128", "256" },
			getFunc = function() return tostring(SnakeIcons_SV.resolutionChoice) end,
			setFunc = function(value) SnakeIcons_SV.resolutionChoice = value end,
	...
	LAM2:RegisterOptionControls("SnakeIcons_Panel", optionsData)
end
...
local function InitializeIcons()
    if AbilityIconsFramework and AbilityIconsFramework.AddCustomIconPack then
        ...
        d("SnakeIcons: AbilityIconsFramework not found or incompatible!")
    end
end
