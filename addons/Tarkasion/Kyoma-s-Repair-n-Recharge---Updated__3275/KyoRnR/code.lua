local Addon = {}
Addon.Name = "KyoRnR"
Addon.DisplayName = "|cFF5FF5Kyoma's|r RnR"
Addon.Author = "|cFF5FF5Kyoma|r, Tarkasion"
Addon.Version = "1.3"
...
function Addon:Initialize()
	...
	self.Settings = ZO_SavedVars:New("KyoRnRGlobal", 1, nil, self.Defaults)
	...
	SLASH_COMMANDS["/rnr"] = Addon.RepairRecharge
