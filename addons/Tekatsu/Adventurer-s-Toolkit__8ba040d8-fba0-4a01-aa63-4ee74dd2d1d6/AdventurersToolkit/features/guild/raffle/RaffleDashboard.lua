...
-- Prefer extracted module implementations while keeping fallback locals.
DEMO_MEMBERS = NWT.RaffleConstants_DEMO_MEMBERS or DEMO_MEMBERS
DEMO_RANKS = NWT.RaffleConstants_DEMO_RANKS or DEMO_RANKS

IsGuildEnabled = NWT.RaffleData_IsGuildEnabled or IsGuildEnabled
GetDefaultRaffleSettings = NWT.RaffleData_GetDefaultSettings or GetDefaultRaffleSettings
GetRaffleGuildSettings = NWT.RaffleData_GetGuildSettings or GetRaffleGuildSettings
IsRaffleGuildFavorite = NWT.RaffleData_IsGuildFavorite or IsRaffleGuildFavorite
ToggleRaffleGuildFavorite = NWT.RaffleData_ToggleGuildFavorite or ToggleRaffleGuildFavorite
GetDemoRankBonus = NWT.RaffleData_GetDemoRankBonus or GetDemoRankBonus
GetDemoActivityBonuses = NWT.RaffleData_GetDemoActivityBonuses or GetDemoActivityBonuses
IsDoubleTicketDeposit = NWT.RaffleData_IsDoubleTicketDeposit or IsDoubleTicketDeposit
CalculateTicketsFromDeposit = NWT.RaffleData_CalculateTicketsFromDeposit or CalculateTicketsFromDeposit
GetRankBonus = NWT.RaffleData_GetRankBonus or GetRankBonus
IsMemberExcluded = NWT.RaffleData_IsMemberExcluded or IsMemberExcluded
GetActivityBonusTickets = NWT.RaffleData_GetActivityBonusTickets or GetActivityBonusTickets
RecordWinner = NWT.RaffleData_RecordWinner or RecordWinner
CalculatePrizeDistribution = NWT.RaffleData_CalculatePrizeDistribution or CalculatePrizeDistribution
UpdateJackpot = NWT.RaffleData_UpdateJackpot or UpdateJackpot
GetCurrentTraderFlipStart = NWT.RaffleData_GetCurrentTraderFlipStart or GetCurrentTraderFlipStart
GetRafflePeriodPresets = NWT.RaffleData_GetPeriodPresets or GetRafflePeriodPresets
FormatRafflePeriod = NWT.RaffleData_FormatPeriod or FormatRafflePeriod
GetRafflePeriodTimes = NWT.RaffleData_GetPeriodTimes or GetRafflePeriodTimes
ParseDepositType = NWT.RaffleData_ParseDepositType or ParseDepositType
...
function NWT.BuildRaffleEntries(guildId)
    if NWT.RaffleCommands_BuildEntries then
        return NWT.RaffleCommands_BuildEntries(guildId)
    end
    local rf = NWT.Raffle
    local gs
    if guildId == 0 then
...
function NWT.RaffleSwitchPanel(dir)
    if NWT.RaffleCommands_SwitchPanelCore then
        return NWT.RaffleCommands_SwitchPanelCore(dir)
    end
    local rf = NWT.Raffle
...
function NWT.RaffleScrollGuild(dir)
    if NWT.RaffleCommands_ScrollGuildCore then
        return NWT.RaffleCommands_ScrollGuildCore(dir)
    end
    local rf = NWT.Raffle
...
function NWT.RaffleScrollEntries(dir)
    if NWT.RaffleCommands_ScrollEntriesCore then
        return NWT.RaffleCommands_ScrollEntriesCore(dir)
    end
    local rf = NWT.Raffle
...
function NWT.RaffleSelectGuild()
    if NWT.RaffleCommands_SelectGuildCore then
        return NWT.RaffleCommands_SelectGuildCore()
    end
    local rf = NWT.Raffle
...
function NWT.RaffleFavoriteSelectedGuild()
    if NWT.RaffleCommands_FavoriteSelectedGuildCore then
        return NWT.RaffleCommands_FavoriteSelectedGuildCore()
    end
    local rf = NWT.Raffle
...
function NWT.RaffleShowPicker()
    if NWT.RaffleCommands_ShowPickerCore then
        return NWT.RaffleCommands_ShowPickerCore()
    end
    local rf = NWT.Raffle
...
function NWT.UpdateRafflePickerDialog()
    if NWT.RaffleCommands_UpdatePickerDialogCore then
        return NWT.RaffleCommands_UpdatePickerDialogCore()
    end
    local rf = NWT.Raffle
...
function NWT.RaffleAdjustWinnerCount(dir)
    if NWT.RaffleCommands_AdjustWinnerCountCore then
        return NWT.RaffleCommands_AdjustWinnerCountCore(dir)
    end
    local rf = NWT.Raffle
...
function NWT.RaffleRunPicker()
    if NWT.RaffleCommands_RunPickerCore then
        return NWT.RaffleCommands_RunPickerCore()
    end
    local rf = NWT.Raffle
    local guildId = GetGuildId(rf.viewingGuildIndex)
    local gs
...
function NWT.ShowRaffleWinnerDialog()
    if NWT.RaffleCommands_ShowWinnerDialogCore then
        return NWT.RaffleCommands_ShowWinnerDialogCore()
    end
    local rf = NWT.Raffle
...
function NWT.CloseRaffleWinnerDialog()
    if NWT.RaffleCommands_CloseWinnerDialogCore then
        return NWT.RaffleCommands_CloseWinnerDialogCore()
    end
...
function NWT.RaffleReroll()
    if NWT.RaffleCommands_RerollCore then
        return NWT.RaffleCommands_RerollCore()
    end
...
function NWT.ShowParticipantDetails()
    if NWT.RaffleCommands_ShowParticipantDetailsCore then
        return NWT.RaffleCommands_ShowParticipantDetailsCore()
    end
    local rf = NWT.Raffle
...
function NWT.CloseParticipantDetails()
    if NWT.RaffleCommands_CloseParticipantDetailsCore then
        return NWT.RaffleCommands_CloseParticipantDetailsCore()
    end
...
function NWT.RaffleShowSettings()
    if NWT.RaffleCommands_ShowSettingsCore then
        return NWT.RaffleCommands_ShowSettingsCore()
    end
    local rf = NWT.Raffle
...
function NWT.RaffleSettingsChangeTab(dir)
    if NWT.RaffleCommands_SettingsChangeTabCore then
        return NWT.RaffleCommands_SettingsChangeTabCore(dir)
    end
    local rf = NWT.Raffle
...
function NWT.RaffleCycleSettingsOption(dir)
    if NWT.RaffleCommands_CycleSettingsOptionCore then
        return NWT.RaffleCommands_CycleSettingsOptionCore(dir)
    end
    local rf = NWT.Raffle
    if not rf.settingsMenuOpen then return end
...
function NWT.RaffleChangeSettingValue(direction)
    if NWT.RaffleCommands_ChangeSettingValueCore then
        return NWT.RaffleCommands_ChangeSettingValueCore(direction)
    end
    local rf = NWT.Raffle
    if not rf.settingsMenuOpen then return end
...
function NWT.RaffleToggleSetting(gs, settingId, tabId)
    if NWT.RaffleCommands_ToggleSettingCore then
        return NWT.RaffleCommands_ToggleSettingCore(gs, settingId, tabId)
    end
...
function NWT.RaffleCycleSetting(gs, settingId, tabId, options)
    if NWT.RaffleCommands_CycleSettingCore then
        return NWT.RaffleCommands_CycleSettingCore(gs, settingId, tabId, options)
    end
...
function NWT.RaffleIncrementSetting(gs, settingId, tabId, direction)
    if NWT.RaffleCommands_IncrementSettingCore then
        return NWT.RaffleCommands_IncrementSettingCore(gs, settingId, tabId, direction)
    end
...
function NWT.RaffleDoAction(gs, actionId, tabId)
    if NWT.RaffleCommands_DoActionCore then
        return NWT.RaffleCommands_DoActionCore(gs, actionId, tabId)
    end
...
function NWT.RaffleEditPackPrice(gs, packIndex)
    if NWT.RaffleCommands_EditPackPriceCore then
        return NWT.RaffleCommands_EditPackPriceCore(gs, packIndex)
    end
...
function NWT.RaffleEditPackTickets(gs, packIndex)
    if NWT.RaffleCommands_EditPackTicketsCore then
        return NWT.RaffleCommands_EditPackTicketsCore(gs, packIndex)
    end
    local pack = gs.ticketPacks and gs.ticketPacks[packIndex]
    if not pack then return end
...
function NWT.RaffleEditPackSuffix(gs, packIndex)
    if NWT.RaffleCommands_EditPackSuffixCore then
        return NWT.RaffleCommands_EditPackSuffixCore(gs, packIndex)
    end
    local pack = gs.ticketPacks and gs.ticketPacks[packIndex]
    if not pack then return end
...
function NWT.RaffleEditRankFree(gs, rankIndex)
    if NWT.RaffleCommands_EditRankFreeCore then
        return NWT.RaffleCommands_EditRankFreeCore(gs, rankIndex)
    end
    if not gs.rankBonuses then gs.rankBonuses = { enabled = false, ranks = {} } end
...
function NWT.RaffleEditRankMult(gs, rankIndex, direction)
    if NWT.RaffleCommands_EditRankMultCore then
        return NWT.RaffleCommands_EditRankMultCore(gs, rankIndex, direction)
    end
    if not gs.rankBonuses then gs.rankBonuses = { enabled = false, ranks = {} } end
    if not gs.rankBonuses.ranks then gs.rankBonuses.ranks = {} end
    if not gs.rankBonuses.ranks[rankIndex] then
...
function NWT.RaffleEditRankWeekly(gs, rankIndex)
    if NWT.RaffleCommands_EditRankWeeklyCore then
        return NWT.RaffleCommands_EditRankWeeklyCore(gs, rankIndex)
    end
    if not gs.rankBonuses then gs.rankBonuses = { enabled = false, ranks = {} } end
    if not gs.rankBonuses.ranks then gs.rankBonuses.ranks = {} end
    if not gs.rankBonuses.ranks[rankIndex] then
...
function NWT.RaffleToggleRankExempt(gs, rankIndex)
    if NWT.RaffleCommands_ToggleRankExemptCore then
        return NWT.RaffleCommands_ToggleRankExemptCore(gs, rankIndex)
    end
...
function NWT.CloseRaffleSettingsDialog()
    if NWT.RaffleCommands_CloseSettingsCore then
        return NWT.RaffleCommands_CloseSettingsCore()
    end
    local rf = NWT.Raffle
...
-- Route entry building to extracted commands module.
if NWT.RaffleCommands_BuildEntries then
    NWT.BuildRaffleEntries = NWT.RaffleCommands_BuildEntries
end
