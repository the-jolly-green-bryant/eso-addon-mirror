...
number				offsetY	The vertical offset relative to the point position.
	...
	CoordsAndHeadingUI_Label:SetColor(CoordsAndHeading.SavedVars.r,CoordsAndHeading.SavedVars.g,CoordsAndHeading.SavedVars.b) -- sets the font coloe to black or white
	CoordsAndHeadingUI_Label:SetScale(CoordsAndHeading.SavedVars.uiScale) -- Scales the Whole UI
...
function CoordsAndHeading.Slash(text)
	...
	elseif text == "fontwhite" then
		CoordsAndHeading.SavedVars.r = 255
		CoordsAndHeading.SavedVars.g = 255
		CoordsAndHeading.SavedVars.b = 255
		CoordsAndHeadingUI_Label:SetColor(255,255,255) -- sets font color to white
	elseif text == "fontblack" then
		CoordsAndHeading.SavedVars.r = 0
		CoordsAndHeading.SavedVars.g = 0
		CoordsAndHeading.SavedVars.b = 0
		CoordsAndHeadingUI_Label:SetColor(0,0,0) -- sets font color to black
	elseif text == "uibig" then
		CoordsAndHeading.SavedVars.uiScale = 1.1
		CoordsAndHeadingUI_Label:SetScale(1.1)
	elseif text == "uibigger" then
		CoordsAndHeading.SavedVars.uiScale = 1.2
		CoordsAndHeadingUI_Label:SetScale(1.2)
	elseif text == "uihuge" then
		CoordsAndHeading.SavedVars.uiScale = 1.3
		CoordsAndHeadingUI_Label:SetScale(1.3)
	elseif text == "uismall" then
		CoordsAndHeading.SavedVars.uiScale = 1
		CoordsAndHeadingUI_Label:SetScale(1)
	elseif text == "uismaller" then
		CoordsAndHeading.SavedVars.uiScale = 0.8
		CoordsAndHeadingUI_Label:SetScale(0.8)
	elseif text == "uitiny" then
		CoordsAndHeading.SavedVars.uiScale = 0.6
		CoordsAndHeadingUI_Label:SetScale(0.6)
	...
	elseif text == "unlock" then
		...
		d("available args: transparent | nottransparent | Lock | Unlock | fontwhite | fontblack | uibig | uibigger | uihuge | uismall | uismaller | uitiny")
	end
end
